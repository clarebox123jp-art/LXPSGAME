...
//  最後更新:2026-06-03  / 目前主程式版本:v3.13.28(線上實際版本)
//
//  ★ 維護注意事項(老師請務必看):
...
window.GAME_CHANGELOG = [
  ...
  // ════════════════════════════════════════════════════════════════════
  // v3.13.49(2026-06-05)— 🔄 自動更新到最新版 + 🧹 帳號整理會先預告
  // ════════════════════════════════════════════════════════════════════
  {
    ver: 'v3.13.49',
    date: '2026-06-05',
    brief: [
      ...
      '🧹【帳號整理會先預告】如果你的帳號裡有「來源不明」的英雄(通常是共用平板上從別人帳號跑進來的):',
      '   ・管理員整理移除前,你下次登入會先收到「通知」,看到原因和會被移除的英雄清單',
      '   ・你可以勾選「保留 1 隻」最喜歡的(保留的那隻不補償)',
      '   ・其他被移除的英雄,系統會自動把你花在它們身上的投入「補償」給你',
      '💎【至寶不再受影響】管理員整理英雄時,你裝在那隻英雄身上的至寶會自動卸下並保留,不會跟著不見',
    ]
  },
