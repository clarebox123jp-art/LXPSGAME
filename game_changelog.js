...
//  最後更新:2026-06-02  / 目前主程式版本:v3.13.26(線上實際版本)
//
//  ★ 維護注意事項(老師請務必看):
...
window.GAME_CHANGELOG = [
  ...
  // ════════════════════════════════════════════════════════════════════
  // v3.13.26(2026-06-02)— 🤖 鬥技場 AI 公平性:答題獎勵
  // ════════════════════════════════════════════════════════════════════
  {
    ver: 'v3.13.26',
    date: '2026-06-02',
    brief: [
      '🤖【鬥技場 AI 答題獎勵】',
      '   ・之前 AI 因為沒辦法操作答題介面,玩家答對拿獎勵 AI 卻什麼都沒有,太不公平',
      '   ・現在每回合玩家被觸發答題的同時,AI 必定獲得 1 個答題獎勵(視同 100% 答對)',
      '   ・AI 會根據場上局勢智能挑選最適合的獎勵自動使用',
      '',
      '🧠【AI 智能挑選邏輯(優先序)】',
      '   1. 有隊友倒下 → 奇蹟復活',
      '   2. 有隊友 HP<30% → 緊急救援(補滿血)',
      '   3. 全隊不利狀態多 → 淨化光芒',
      '   4. 全隊平均 HP<50% → 貓空茶香(全體回 50%)',
      '   5. 能量不足 → 能量爆發(補滿)',
      '   6. 玩家身上有利狀態多 → 破滅吹拂(清玩家 buff)',
      '   7. 玩家平均 HP 高 → 焰尾橫掃(全敵 20% HP)',
      '   8. 有玩家 HP<50% → 竹筍突刺(集火單體)',
      '   9. 有玩家沒被控 → 靜止封印',
      '  10. 都不符合 → 隨機絕對防禦 或 焰尾橫掃',
      '',
      '⚖【公平性說明】',
      '   ・玩家答錯仍維持懲罰流程(HP 最少英雄被打)',
      '   ・玩家答對拿獎勵 vs 玩家答錯沒獎勵 — 這就是答題的價值',
      '   ・AI 獎勵不受玩家答對與否影響,固定每回合都拿(對沖 AI 不能答題的劣勢)',
      '',
      '💡 戰鬥畫面會顯示「🤖 對手獲得獎勵:XXX」提示,讓玩家知道 AI 拿了什麼'
    ]
  },

  // ════════════════════════════════════════════════════════════════════
  // v3.13.25(2026-06-02)— ⚔ 鬥技場 6 大修正(老師裁示)
  // ════════════════════════════════════════════════════════════════════
  {
    ver: 'v3.13.25',
    date: '2026-06-02',
    brief: [
      '⚔【鬥技場敵方陣容修正】',
      '   ・之前敵方會出現小怪/菁英/BOSS(小惡魔、二口女等),這次嚴格過濾',
      '   ・現在鬥技場敵方只會是「玩家可操作的英雄」',
      '   ・日本三妖怪英雄版(大天狗、酒吞童子、玉藻前)保留,其他怪物全擋',
      '',
      '🎵【鬥技場專屬 BGM(新音樂)】',
      '   ・主頁/選英雄/元素/技能替換頁:新版「鬥技場頁面 BGM」「鬥技場首頁 BGM」2 首輪播',
      '   ・戰鬥畫面:新版「鬥技場戰鬥 BGM 01/02/03」3 首輪播',
      '   ・鬥技場戰鬥音樂跟冒險模式戰鬥音樂完全區隔',
      '',
      '📝【鬥技場答題時機修正】',
      '   ・之前第 1 回合直接讓玩家行動,沒先答題',
      '   ・現在每回合開始(含第 1 回合)都會先出題,答完才能操作角色',
      '',
      '🐱【鬥技場移除九尾空貓怪對話】',
      '   ・之前答題後畫面上方會冒出九尾空貓怪台詞(不合理,鬥技場沒這隻 BOSS)',
      '   ・現在鬥技場答題不顯示任何 BOSS 反應對話',
      '',
      '🏫【鬥技場結算畫面簡化 + 改回到學校】',
      '   ・移除「再戰一次」「重新選角」「協助填寫問卷」3 個按鈕',
      '   ・「🏠 回到首頁」改成「🏫 回到學校」',
      '   ・結束鬥技場改回到關卡選擇頁(學校),不再切到主選單',
      '',
      '🧹【結束鬥技場後清乾淨,不影響冒險】',
      '   ・大幅擴張清除清單:選角暫存、答題狀態、所有 watchdog、各種 overlay',
      '   ・絕不動冒險模式的英雄、預設陣容、雲端存檔、英雄投資等級',
      '   ・確保打完鬥技場回學校後,冒險關卡的英雄和陣容完全沒被動到'
    ]
  },
