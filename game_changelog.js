...
window.GAME_CHANGELOG = [
  ...
  // ════════════════════════════════════════════════════════════════════
  // v3.10.16(2026-05-26)— 暗魔將·血 S1「血劍·防」重新平衡
  // ════════════════════════════════════════════════════════════════════
  {
    ver: 'v3.10.16',
    date: '2026-05-26',
    brief: [
      '🩸 暗魔將·血 S1「血劍·防」三大調整',
      '   ・能量消耗:6 → 5(更易頻繁使用)',
      '   ・減傷加成:Lv0=70%,每升 1 級 +2%(Lv10 MAX 達 88%)',
      '   ・取消舊版 Lv5(+1 回合)、Lv10(-1 能量)兩個方級進階,改為純減傷成長',
      '   ・護壁持續時間固定 1 回合,不隨等級增加',
      '📖 圖鑑技能升級面板同步更新:',
      '   ・標籤從「免疫回合+能量」改為「減傷%」',
      '   ・每級顯示「友方全體減傷 X% / 1 回合」(X = 70~88)'
    ]
  },

  // ════════════════════════════════════════════════════════════════════
  // v3.10.15(2026-05-26)— 籃球隊員爆發強化 + 英雄誌精簡 + 技能說明視窗加寬
  // ════════════════════════════════════════════════════════════════════
  {
    ver: 'v3.10.15',
    date: '2026-05-26',
    brief: [
      ...
      '   ・新增「必中」+ 維持「無視有利狀態」',
      '   ・加速全隊 50% 共 2 回合(維持)',
      '📖 5 隻學生設計英雄的英雄誌大幅精簡(原本長達 300 字、卡片被填滿不好看)',
      '   ・鳳凰、操偶師、菇女、小丑、美人魚‧角角',
      '   ・統一保留「人物背景一句 + 兩個技能/天賦/爆發亮點 + 結尾名言」風格',
      '   ・字數從 230-310 字降到 86-99 字,跟其他學生英雄(火柴人、青炎龍王)一致',
      '   ・詳細技能機制改去技能 ? 按鈕看,英雄誌只講重點',
      '🪟 技能 ? 按鈕展開的詳細說明視窗加寬(580px → 820px)',
      '   ・原本太窄,文字擠成 8-9 行,長技能說明會超出畫面看不到後面',
      '   ・小螢幕仍走 92vw 不會破版'
    ]
  },
