...
//  最後更新:2026-06-13  / 目前主程式版本:v3.14.23(體驗修正)
//
//  ★ 維護注意事項(老師請務必看):
...
window.GAME_CHANGELOG = [
  // ════════════════════════════════════════════════════════════════════
  // v3.14.23(2026-06-13)— 🛠️ 體驗修正:今日不再顯示 + 戰後升級畫面更快
  // ════════════════════════════════════════════════════════════════════
  {
    ver: 'v3.14.23',
    date: '2026-06-13',
  ...
  // ════════════════════════════════════════════════════════════════════
  // (★ v3.14.10~23 修剪:v3.14.2「強力免疫擋狐妖魅惑+日本BOSS必得SSR碎片」、v3.14.1「遊戲開啟速度大改善」、v3.14.0「三項修正(通知關閉/挑戰券進場/黑暗球卡死)」、v3.13.99「iPad 安裝版登入修正」、v3.13.98「世界BOSS傷害上限修正」、v3.13.97「連線與效能優化」、v3.13.96「近期活動改版」、v3.13.95「靈魂碎片系統」、v3.13.87「我的豚豚登場」、v3.13.86「單人卡死自救再強化」、v3.13.85「能力翻倍爆發修正」、v3.13.84「極限還原膠囊」、v3.13.83「UR 篩選+極限膠囊」已移除以維持 20 則上限)
];
