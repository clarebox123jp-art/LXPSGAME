...
//  最後更新:2026-07-24  / 目前主程式版本:v4.91.0(主角技能繼承系統:主角覺醒後可繼承 R/SR 英雄的技能與極限爆發·管理員測試)
...
window.GAME_CHANGELOG = [
  // v4.91.0 — 主線劇情戰鬥修正(畫面全黑/音樂錯誤/戰場背景/首章教學文案·管理員測試)
  {
    ver: 'v4.91.0',
    date: '2026-07-24',
    adminOnly: true,   /* ★ 主線劇情測試期內容·僅管理員可見(正式開放時另發玩家版公告) */
    brief: [
      '🖥【進戰鬥整片深藍看不到根治】主線劇情的戰鬥一進去就被深藍色蓋住、什麼都看不到,卻又點得到東西(甚至會誤點進別的畫面聽到別的音樂),最後只能關掉遊戲——這個問題已經修好了。原因是劇情用來銜接場景的黑底沒有在進戰鬥時收起來,現在進戰鬥會把所有劇情圖層一起收好,打完再自動放回來。',
