...
//  最後更新:2026-07-20  / 目前主程式版本:v4.64.0(👤 自訂角色大改版:頭身新素材+頭飾眼鏡嘴飾+位置微調)
...
window.GAME_CHANGELOG = [
  // v4.64.0 — 自訂角色系統大改版(頭身新切法素材+頭飾/眼鏡/嘴飾+GM上鎖通道·管理員測試)
  {
    ...
    items: [
      ...
      '★ v4.64.0【配件】頭飾 10/眼鏡 10/嘴部飾品 9(prop 定位引擎:AVATAR_HEAD_GEO 實測幾何自動對位四體型);選單十項定版;全部件 XY 微調 ±100(cfg.pos)',
