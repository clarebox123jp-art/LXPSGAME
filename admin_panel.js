...
async function _showAdminStatsPanelImpl(){
    ...
    <div class="_admin-stats-card" style="background:linear-gradient(135deg,rgba(20,30,50,0.98),rgba(10,15,30,0.99));
      ...
      <div id="_admin-globalreward-section" style="background:rgba(45,35,55,0.5);border:2px solid rgba(210,150,240,0.6);border-radius:10px;padding:16px;margin-bottom:22px;">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(230px,1fr));gap:8px 16px;background:rgba(0,0,0,0.28);border:1px solid rgba(210,150,240,0.3);border-radius:8px;padding:12px;margin-bottom:12px;">
          ...
          <label style="display:flex;align-items:center;gap:6px;font-size:14px;color:#fff;cursor:pointer;">
            <input type="checkbox" id="_gr-item-urpick" style="width:17px;height:17px;cursor:pointer;">👑 UR 自選召喚卷 ×
            <input type="number" id="_gr-qty-urpick" value="1" min="1" max="99" style="width:50px;padding:3px 5px;background:rgba(0,0,0,0.5);border:1px solid rgba(210,150,240,0.4);color:#fff;border-radius:5px;font-family:inherit;">
          </label>
          <label style="display:flex;align-items:center;gap:6px;font-size:14px;color:#fff;cursor:pointer;">
      ...
      <div id="_admin-classreward-section" style="background:rgba(30,45,30,0.5);border:2px solid rgba(140,220,120,0.6);border-radius:10px;padding:16px;margin-bottom:22px;">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(230px,1fr));gap:8px 16px;background:rgba(0,0,0,0.28);border:1px solid rgba(140,220,120,0.3);border-radius:8px;padding:12px;margin-bottom:12px;">
          <label style="display:flex;align-items:center;gap:7px;font-size:14px;color:#fff;cursor:pointer;">
            <input type="checkbox" id="_cr-item-clair" style="width:17px;height:17px;cursor:pointer;">🌟 UR 藝天使．克雷爾
          </label>
          <label style="display:flex;align-items:center;gap:7px;font-size:14px;color:#fff;cursor:pointer;">
          ...
          <label style="display:flex;align-items:center;gap:6px;font-size:14px;color:#fff;cursor:pointer;">
            <input type="checkbox" id="_cr-item-urpick" style="width:17px;height:17px;cursor:pointer;">👑 UR 自選召喚卷 ×
            <input type="number" id="_cr-qty-urpick" value="1" min="1" max="99" style="width:50px;padding:3px 5px;background:rgba(0,0,0,0.5);border:1px solid rgba(140,220,120,0.4);color:#fff;border-radius:5px;font-family:inherit;">
          </label>
          <label style="display:flex;align-items:center;gap:6px;font-size:14px;color:#fff;cursor:pointer;">
      ...
      <div id="_admin-redeem-section" style="background:rgba(40,35,55,0.55);border:2px solid rgba(190,150,255,0.6);border-radius:10px;padding:16px;margin-bottom:22px;">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(230px,1fr));gap:8px 16px;background:rgba(0,0,0,0.28);border:1px solid rgba(190,150,255,0.3);border-radius:8px;padding:12px;margin-bottom:12px;">
          ...
          <label style="display:flex;align-items:center;gap:6px;font-size:14px;color:#fff;cursor:pointer;">
            <input type="checkbox" id="_rc-item-urpick" style="width:17px;height:17px;cursor:pointer;">👑 UR 自選召喚卷 ×
            <input type="number" id="_rc-qty-urpick" value="1" min="1" max="99" style="width:50px;padding:3px 5px;background:rgba(0,0,0,0.5);border:1px solid rgba(190,150,255,0.4);color:#fff;border-radius:5px;font-family:inherit;">
          </label>
          <label style="display:flex;align-items:center;gap:6px;font-size:14px;color:#fff;cursor:pointer;">
      ...
      <div id="_admin-item-owner-section" style="background:rgba(40,30,55,0.5);border:2px solid rgba(180,140,255,0.55);border-radius:10px;padding:16px;margin-bottom:22px;">
        <div style="font-size:18px;font-weight:800;color:#c9a8ff;margin-bottom:8px;">🔍 英雄/至寶持有者審查</div>
        <div style="font-size:13px;color:#ccc;margin-bottom:12px;line-height:1.6;">
          勾選一個或多個<b style="color:#d9b8ff;">英雄/至寶</b>,按「🔍 查詢持有者」掃描全體玩家,列出<b style="color:#d9b8ff;">誰持有 + 怎麼來的(獲得來源)+ 何時取得(時間標記)</b>。<br>
          <b style="color:#ffaa66;">★ 來源「⚠ 未標記/查無紀錄」或「已被移除」者最可疑</b>(自動排在最前),協助判斷是否為不正常取得。<br>
          可直接對單一玩家的該英雄/至寶按 <b style="color:#ff8888;">🗑 刪除</b>(英雄走 admin_delete 三槽同寫不復活、至寶移出)或 <b style="color:#88dd99;">🎁 補償</b>(輸入知識幣/召喚水晶數量發放)。<br>
          <span style="color:#ff9999;font-size:12px;">⚠ 「查詢」會讀取所有玩家文件(資料量大、配額消耗大),請勿頻繁點擊。</span>
        </div>
        <div style="margin-bottom:10px;">
          <input id="_admin-itemown-search" type="text" placeholder="🔎 搜尋英雄/至寶名稱…(篩選下方勾選清單)" style="width:100%;box-sizing:border-box;padding:8px 12px;font-size:14px;background:rgba(0,0,0,0.45);border:1.5px solid rgba(180,140,255,0.4);border-radius:6px;color:#eee;font-family:inherit;">
        </div>
        <div id="_admin-itemown-picker" style="max-height:230px;overflow-y:auto;background:rgba(0,0,0,0.4);border:1px solid rgba(180,140,255,0.3);border-radius:6px;padding:8px;margin-bottom:12px;font-size:13px;line-height:2.0;">
          <div style="color:#888;padding:14px;text-align:center;">載入清單中…</div>
        </div>
        <div style="display:flex;gap:8px;flex-wrap:wrap;align-items:center;margin-bottom:12px;">
          <button id="_admin-itemown-query" style="padding:9px 18px;font-size:14px;font-weight:800;
            background:rgba(180,140,255,0.22);border:2px solid #b48cff;color:#e6d4ff;
            border-radius:6px;cursor:pointer;font-family:inherit;">
            🔍 查詢持有者
          </button>
          <button id="_admin-itemown-clear" style="padding:9px 14px;font-size:13px;font-weight:700;
            background:rgba(120,120,140,0.2);border:1.5px solid #888;color:#ccc;
            border-radius:6px;cursor:pointer;font-family:inherit;">
            清除勾選
          </button>
          <span id="_admin-itemown-count" style="font-size:12px;color:#aaa;"></span>
        </div>
        <div id="_admin-itemown-list" style="max-height:560px;overflow-y:auto;
          background:rgba(0,0,0,0.4);border:1px solid rgba(180,140,255,0.3);border-radius:6px;
          padding:8px;font-size:12px;color:#ccc;line-height:1.7;">
          <div style="color:#888;padding:14px;text-align:center;">勾選英雄/至寶後按「🔍 查詢持有者」</div>
        </div>
        <div id="_admin-itemown-result" style="margin-top:10px;font-size:13px;color:#c9a8ff;text-align:center;"></div>
      </div>

      <!-- ★ v3.16.85 — 過度補回稽查與回收(掃全體):一鍵找出舊救援沒審 uid 誤補的別位同學英雄/至寶 + 回收 -->
      <div id="_admin-overrestore-section" style="background:rgba(40,20,22,0.5);border:2px solid rgba(255,120,120,0.55);border-radius:10px;padding:16px;margin-bottom:22px;">
        <div style="font-size:18px;font-weight:800;color:#7fb0ff;margin-bottom:8px;">🔵 過度補回 → 派發學生自我審核(掃全體)</div>
        <div style="font-size:13px;color:#ccc;margin-bottom:12px;line-height:1.6;">
          一鍵掃描所有玩家,找出「<b style="color:#ffb0b0;">帳本有別位同學 uid 的真實解鎖紀錄、但本帳號自己沒紀錄、也沒按過「這是我的」</b>」的英雄/至寶 ── 也就是先前「<b>沒審 uid 的舊救援『確認救援並補回』</b>」誤補進來的、<b style="color:#ffb0b0;">疑似別人</b>的角色/至寶。<br>
          <b style="color:#9fc8ff;">★ 新機制(把判斷權交給學生本人):</b>按鈕改為<b style="color:#bfe0ff;">「📨 通知學生自審」</b>──<b style="color:#9fe0b0;">GM 不直接刪除任何一隻</b>,而是把這份清單(名稱+等級)派發給該學生。學生<b>下次登入</b>會跳出「自我審核視窗」,逐一勾選:<br>
          　<b style="color:#9effb0;">✅ 是我的</b> → 寫 <code>player_confirmed</code> 綁定 UID <b>永久保留</b>,三槽不再過問、以後不會再被列為可疑;<br>
          　<b style="color:#ffae8a;">🗑 不是我的</b> → <b>可逆移除</b>(走 <code>audit_error_recovered</code> 標記·GM 後台「🛟 審查誤刪英雄批次救回」可還原)+ 已練(Lv&gt;1)英雄<b style="color:#9fe0b0;">自動補償</b>(每等級 500 幣 + 每隻 2 水晶上限 20·依<b>派發當下記錄的等級</b>算)。<br>
          <b style="color:#ffcf8a;">★ 防刷:</b>清單只有 GM 能寫(<code>pendingAdminNotifications</code> create 限管理員·學生偽造不了),補償依 GM 記錄等級 → 改本機等級也沒用。<br>
          <b style="color:#88dd99;">★ 不會碰</b>初始 8 隻、自己有解鎖紀錄、或學生已確認過的英雄。<br>
          <b style="color:#cdd9ff;">🔍 逐項審查(GM 備用):</b>若你自己很確定,每位玩家列右側「🔍 逐項審查」仍可開彈窗,GM 直接「🗑 刪除」或「🛟 救回」(不經學生)。
          <span style="color:#aaa;font-size:12px;display:block;margin-top:4px;">
            快篩來源:<code>players/{uid}</code> 的 <code>_heroUnlockHistory</code> / <code>_treasureUnlockHistory</code> / <code>unlockedHeroes</code> / <code>heroLevels</code>(一次讀全部·便宜)。派發走 <code>_fbAdminQueueOverRestoreReview</code>;學生端套用走 <code>_lxpsConfirmOwnHero</code>/<code>_fbStudentDisownHeroes</code>/<code>_fbStudentDisownTreasures</code>/<code>_fbCompensatePlayer</code>。沿用既有 <code>pendingAdminNotifications</code> 規則,免新增 firestore 規則。
          </span>
        </div>
        <div style="display:flex;gap:8px;flex-wrap:wrap;align-items:center;margin-bottom:12px;">
          <button id="_admin-orr-scan" style="padding:9px 18px;font-size:14px;font-weight:800;
            background:rgba(255,120,120,0.2);border:2px solid #ff7a7a;color:#ffc0c0;
            border-radius:6px;cursor:pointer;font-family:inherit;">
            🔍 掃描全體玩家
          </button>
          <button id="_admin-orr-reclaimall" style="padding:9px 18px;font-size:14px;font-weight:800;
            background:rgba(90,140,200,0.2);border:2px solid #4a78c8;color:#cfe0ff;
            border-radius:6px;cursor:pointer;font-family:inherit;display:none;">
            📨 全部通知學生自審
          </button>
          <span id="_admin-orr-count" style="font-size:12px;color:#aaa;"></span>
        </div>
        <div id="_admin-orr-list" style="max-height:520px;overflow-y:auto;
          background:rgba(0,0,0,0.4);border:1px solid rgba(255,120,120,0.3);border-radius:6px;
          padding:8px;font-size:12px;color:#ccc;line-height:1.7;">
          <div style="color:#888;padding:14px;text-align:center;">尚未掃描,按「🔍 掃描全體玩家」開始</div>
        </div>
        <div id="_admin-orr-result" style="margin-top:10px;font-size:13px;color:#ff9a9a;text-align:center;"></div>

        <!-- ★ v3.16.92 — 6/24~6/25 救援「查無紀錄過度補償」掃全體 + GM 直接收回(子區塊) -->
        <div style="margin-top:18px;padding-top:14px;border-top:2px dashed rgba(255,170,90,0.5);">
          <div style="font-size:16px;font-weight:800;color:#ffb86b;margin-bottom:6px;">🩹 6/24~6/25 救援「查無紀錄過度補償」→ GM 直接收回</div>
          <div style="font-size:12.5px;color:#ccc;margin-bottom:10px;line-height:1.6;">
            找出 6/24、6/25 的舊救援<b style="color:#ffd0a0;">自動補進、但帳本「完全查無解鎖紀錄」</b>的英雄(<b style="color:#ffd0a0;">Lv1、沒練、沒投資、沒裝至寶</b>)。<br>
            <b style="color:#9fe0b0;">★ 已練/已投資/裝至寶的英雄</b>會被 <code>legacy_grandfather</code> 補蓋 UID 歸屬學生 → <b style="color:#9fe0b0;">不在此清單、絕不誤收</b>。<br>
            <b style="color:#ffae8a;">收回 = GM 直接移除</b>(掃描後可逐位審查再收);因為都是 Lv1 沒培養的,所以<b>不補償</b>、會寄「更正通知」給學生。<br>
            <b style="color:#cdd9ff;">★ 安全:</b>每位收回前對<b>最新雲端 doc 再判一次</b>,只收回「仍然查無紀錄」者(玩家掃描後若已練該英雄就不會被收)。
          </div>
          <div style="display:flex;gap:8px;flex-wrap:wrap;align-items:center;margin-bottom:10px;">
            <button id="_admin-nrc-scan" style="padding:9px 18px;font-size:14px;font-weight:800;background:rgba(255,170,90,0.2);border:2px solid #ffaa5a;color:#ffd8b0;border-radius:6px;cursor:pointer;font-family:inherit;">🔍 掃描查無紀錄過度補償</button>
            <button id="_admin-nrc-reclaimall" style="padding:9px 18px;font-size:14px;font-weight:800;background:rgba(220,90,90,0.25);border:2px solid #d85a5a;color:#ffd0d0;border-radius:6px;cursor:pointer;font-family:inherit;display:none;">🗑 全部一鍵收回</button>
            <span id="_admin-nrc-count" style="font-size:12px;color:#aaa;"></span>
          </div>
          <div id="_admin-nrc-list" style="max-height:420px;overflow-y:auto;background:rgba(0,0,0,0.4);border:1px solid rgba(255,170,90,0.3);border-radius:6px;padding:8px;font-size:12px;color:#ccc;line-height:1.7;">
            <div style="color:#888;padding:14px;text-align:center;">尚未掃描,按「🔍 掃描查無紀錄過度補償」開始</div>
          </div>
          <div id="_admin-nrc-result" style="margin-top:10px;font-size:13px;color:#ffb86b;text-align:center;"></div>
        </div>
      </div>
      ...
      <div id="_admin-rescue-req-section" style="background:rgba(18,40,34,0.5);border:2px solid rgba(120,200,170,0.55);border-radius:10px;padding:16px;margin-bottom:14px;">
        ...
        <div style="display:flex;gap:8px;margin-bottom:10px;flex-wrap:wrap;align-items:center;">
          ...
          <label style="font-size:12px;color:#aaa;display:flex;align-items:center;gap:4px;">
            <input type="checkbox" id="_admin-rescuereq-onlypending" style="accent-color:#88bbff;">
            僅顯示「待處理」(取消勾選＝顯示全部救援記錄)
          </label>
      ...
      <div id="_admin-activity-section" style="background:rgba(20,30,50,0.5);border:2px solid rgba(140,180,255,0.6);border-radius:10px;padding:16px;margin-bottom:14px;">
        ...
        <div style="display:flex;gap:10px;flex-wrap:wrap;align-items:center;margin-bottom:10px;">
          ...
          <button id="_admin-activity-overrestore" style="padding:9px 20px;font-size:13px;font-weight:800;
                  background:linear-gradient(135deg,#c0392b,#922b21);color:#fff;border:none;border-radius:8px;cursor:pointer;
                  box-shadow:0 3px 10px rgba(220,90,90,0.5);" title="稽查此帳號有沒有被舊救援『沒審 uid』誤補別人的英雄/至寶 → 一鍵回收+補償(已練者)+發道歉通知;用上方輸入框的 email / uid / 學號(lsps...)">
            🔍 過度補回稽查與回收
          </button>
        </div>
  ...
  (function _renderAdminSidebar(){
    ...
    const SIDEBAR_ITEMS = [
      ...
      { sec: '_admin-overrestore-section',       label: '🔴 過度補回稽查與回收',  hint: '一鍵掃全體玩家,找出「舊救援沒審 uid 誤補的別位同學英雄/至寶」(帳本有別人 uid 真實紀錄但本帳號無紀錄/未自確認),逐位或全部回收(回收前先用權威三槽重判·只回收三槽確認者→不誤刪·已練英雄補償知識幣+召喚水晶·寄道歉登入彈窗)' },
    ...
    const SIDEBAR_GROUPS = [
      ...
      { label:'🧹 帳號汙染處理',   secs:['_admin-pollution-cluster-section','_admin-laundering-section','_admin-deleted-hero-section','_admin-overrestore-section','_admin-item-owner-section'] },
  ...
  (function _initRescueReqSection(){
    ...
    async function _analyze(uid, detailEl, actionsEl, claims, handled){
      claims = claims || {};
      handled = handled || {};
      detailEl.innerHTML = '<span style="color:#aaa;">核對中(讀雲端帳本反推)...</span>';
      actionsEl.innerHTML = '';
      // ★ v3.16.78 — 逐項處理:已處理項顯示 ✅ 徽章不再出鈕;未處理才出鈕。
      //   讓 GM 在同一筆申請內逐項完成英雄/至寶,且重整也看得到哪些已審查、哪些待確認。
      function _appendActionOrDone(key, label, btnEls){
        var _h = handled[key];
        if(_h){
          var _bd = document.createElement('div');
          var _t = '';
          try{ if(_h.at){ var _d = new Date(_h.at); var _p = function(n){ return (n < 10 ? '0' : '') + n; }; _t = ' · ' + _d.getFullYear() + '/' + (_d.getMonth() + 1) + '/' + _d.getDate() + ' ' + _p(_d.getHours()) + ':' + _p(_d.getMinutes()); } }catch(_e){}
          _bd.innerHTML = '<span style="display:inline-block;margin:3px 0;padding:4px 12px;background:rgba(80,200,140,0.18);border:1.5px solid #4caf6a;border-radius:6px;color:#9fe8c0;font-size:12px;font-weight:800;">✅ ' + _esc(label) + ' 已審查完畢' + _t + (_h.note ? (' · ' + _esc(_h.note)) : '') + '</span>';
          actionsEl.appendChild(_bd);
        } else {
          for(var _i = 0; _i < btnEls.length; _i++) actionsEl.appendChild(btnEls[_i]);
        }
      }
      try{
        ...
        var _grandChips = (diff.grandfatheredHeroes||[]).map(function(n){
          return '<span style="display:inline-block;margin:2px 3px;padding:2px 8px;background:rgba(80,220,160,0.14);border:1px solid rgba(80,220,160,0.45);border-radius:10px;color:#aef0cf;font-size:11px;">✅ ' + _esc(n) + '</span>';
        }).join('');
        var willHtml = '';
        if(rr && rr.hasChanges){
        ...
        var _noRecHtml = (diff.extraNoRecordCount||0)
          ...
          : '';
        // ★ v3.16.84(老師裁示)— 沒有 UID 紀錄但練過/裝至寶/投資過的舊英雄 → 已歸屬玩家(玩家登入自動補蓋 UID),供 GM 知悉,不補回不移除
        var _grandHtml = (diff.grandfatheredCount||0)
          ? ('<div style="margin-top:8px;padding:8px;background:rgba(20,50,38,0.6);border:1px solid rgba(80,220,160,0.4);border-radius:6px;font-size:12px;color:#aef0cf;"><b>✅ 已歸屬本帳號的舊英雄 ' + (diff.grandfatheredCount||0) + ' 隻(練過/裝至寶/投資過·無需處理):</b><br>' + _grandChips + '<div style="margin-top:4px;color:#88c8a8;font-size:11px;line-height:1.5;">這些雖無 UID 解鎖紀錄,但有培養證據 → 視為學生的,玩家下次登入會自動補蓋 UID 永久歸屬,不再被當污染。</div></div>')
          : '';
        var _crossChips = (diff.crossAccountHeroes||[]).map(function(n){
          return '<span style="display:inline-block;margin:2px 3px;padding:2px 8px;background:rgba(255,90,90,0.16);border:1px solid rgba(255,90,90,0.5);border-radius:10px;color:#ffc0c0;font-size:11px;">🚫 ' + _esc(n) + '</span>';
        }).join('');
        // ★ v3.16.84(老師裁示)— 有「別位同學 uid 的真實解鎖紀錄」但本帳號無紀錄 → 舊救援沒審 uid 誤補的別人英雄,導引去「過度補回稽查與回收」處理
        var _crossHtml = (diff.crossAccountCount||0)
          ? ('<div style="margin-top:8px;padding:8px;background:rgba(60,20,20,0.6);border:1px solid rgba(255,90,90,0.45);border-radius:6px;font-size:12px;color:#ffc0c0;"><b>⚠ 偵測到疑似「過度補回的別人英雄」' + (diff.crossAccountCount||0) + ' 隻(有別位同學 uid 的解鎖紀錄·本帳號自己無紀錄):</b><br>' + _crossChips + '<div style="margin-top:4px;color:#e0a0a0;font-size:11px;line-height:1.5;">這是先前「沒審 uid 的救援」誤補進來的別人角色。請到「📜 玩家活動記錄查詢」用本帳號 uid →「🔍 過度補回稽查與回收」一鍵回收+補償(已練者)+發道歉通知。</div></div>')
          : '';
        detailEl.innerHTML = '<div style="margin-bottom:6px;color:#cfe0ff;font-weight:700;font-size:12px;">📋 學生勾選 vs 雲端帳本核對:</div>' + cmpHtml + willHtml + _noRecHtml + _grandHtml + _crossHtml;
        ...
        if(_lostArr.length){
          ...
          btnRestore.onclick = function(){ _restoreLost(uid, _lostArr, detailEl, actionsEl, claims, handled); };
          _appendActionOrDone('lostHeroes', '🔓 遺失英雄復原', [btnRestore]);
        }
        ...
        if(_disownArr.length){
          ...
          btnDisown.onclick = function(){ _disownRemove(uid, _disownArr, detailEl, actionsEl, claims, handled); };
          _appendActionOrDone('disownHeroes', '🗑 污染英雄刪除', [btnDisown]);
        }
        ...
        if(_disownTreArr.length){
          ...
          btnDisownTre.onclick = function(){ _disownRemoveTre(uid, _disownTreArr, detailEl, actionsEl, claims, handled); };
          _appendActionOrDone('disownTreasures', '🗑 污染至寶刪除', [btnDisownTre]);
        }
        ...
        if(_lostTreArr.length){
          ...
          btnRestoreTre.onclick = function(){ _restoreLostTre(uid, _lostTreArr, detailEl, actionsEl, claims, handled); };
          _appendActionOrDone('lostTreasures', '🔓 遺失至寶補回', [btnRestoreTre]);
        }
        ...
        if(_contested.length){
          ...
          btnAppr.onclick = function(){ _approveAudit(uid, _contested, detailEl, actionsEl, claims, handled); };
          ...
          btnRejA.onclick = function(){ _rejectAudit(uid, _contested, detailEl, actionsEl, claims, handled); };
          _appendActionOrDone('auditHeroes', '🔺 英雄審查', [btnAppr, btnRejA]);
        }
        ...
        if(_contestedT.length){
          ...
          btnApprT.onclick = function(){ _approveAuditTreasures(uid, _contestedT, detailEl, actionsEl, claims, handled); };
          ...
          btnRejAT.onclick = function(){ _rejectAuditTreasures(uid, _contestedT, detailEl, actionsEl, claims, handled); };
          _appendActionOrDone('auditTreasures', '🔺 至寶審查', [btnApprT, btnRejAT]);
        }
    ...
    async function _restoreLost(uid, names, detailEl, actionsEl, claims, handled){
      names = names || [];
      ...
      try{
        ...
        if(typeof window._fbMarkRescueItemHandled === 'function') await window._fbMarkRescueItemHandled(uid, 'lostHeroes', '已永久復原 ' + _cnt + ' 隻');
        ...
        handled = handled || {}; handled.lostHeroes = { at: Date.now(), note: '已永久復原 ' + _cnt + ' 隻' };
        _analyze(uid, detailEl, actionsEl, claims, handled);
      }catch(e){
    ...
    async function _disownRemove(uid, names, detailEl, actionsEl, claims, handled){
      names = names || [];
      if(!names.length) return;
      ...
      try{
        ...
        if(typeof window._fbMarkRescueItemHandled === 'function') await window._fbMarkRescueItemHandled(uid, 'disownHeroes', '已刪除污染英雄 ' + _cnt + ' 隻');
        ...
        handled = handled || {}; handled.disownHeroes = { at: Date.now(), note: '已刪除 ' + _cnt + ' 隻' };
        _analyze(uid, detailEl, actionsEl, claims, handled);
      }catch(e){
    ...
    async function _approveAudit(uid, names, detailEl, actionsEl, claims, handled){
      names = names || [];
      if(!names.length) return;
      ...
      try{
        ...
        if(typeof window._fbMarkRescueItemHandled === 'function') await window._fbMarkRescueItemHandled(uid, 'auditHeroes', '審查通過·解鎖 ' + names.length + ' 隻');
        ...
        handled = handled || {}; handled.auditHeroes = { at: Date.now(), note: '通過·解鎖 ' + names.length + ' 隻' };
        _analyze(uid, detailEl, actionsEl, claims, handled);
      }catch(e){
    ...
    async function _rejectAudit(uid, names, detailEl, actionsEl, claims, handled){
      names = names || [];
      if(!names.length) return;
      ...
      try{
        ...
        if(typeof window._fbMarkRescueItemHandled === 'function') await window._fbMarkRescueItemHandled(uid, 'auditHeroes', '審查不通過·轉灰 ' + names.length + ' 隻');
        try{ if(typeof window._fbAdminSendNotificationToPlayer === 'function') await window._fbAdminSendNotificationToPlayer(uid, { title:'GM已審查完畢', body:'GM已審查完畢，請重新整理，確認你的英雄圖鑑。', type:'audit_verify' }); }catch(_n){}
        handled = handled || {}; handled.auditHeroes = { at: Date.now(), note: '不通過·轉灰 ' + names.length + ' 隻' };
        _analyze(uid, detailEl, actionsEl, claims, handled);
      }catch(e){
    ...
    async function _approveAuditTreasures(uid, keys, detailEl, actionsEl, claims, handled){
      keys = keys || [];
      ...
      try{
        ...
        if(!ok) throw new Error('通過寫入失敗');
        if(typeof window._fbMarkRescueItemHandled === 'function') await window._fbMarkRescueItemHandled(uid, 'auditTreasures', '至寶審查通過·解鎖 ' + keys.length + ' 個');
        ...
        handled = handled || {}; handled.auditTreasures = { at: Date.now(), note: '通過·解鎖 ' + keys.length + ' 個' };
        _analyze(uid, detailEl, actionsEl, claims, handled);
      }catch(e){
    ...
    async function _rejectAuditTreasures(uid, keys, detailEl, actionsEl, claims, handled){
      keys = keys || [];
      if(!keys.length) return;
      ...
      try{
        ...
        if(!ok) throw new Error('不通過寫入失敗');
        if(typeof window._fbMarkRescueItemHandled === 'function') await window._fbMarkRescueItemHandled(uid, 'auditTreasures', '至寶審查不通過·轉灰 ' + keys.length + ' 個');
        try{ if(typeof window._fbAdminSendNotificationToPlayer === 'function') await window._fbAdminSendNotificationToPlayer(uid, { title:'GM已審查完畢', body:'GM已審查完畢，請重新整理，確認你的至寶圖鑑。', type:'audit_verify' }); }catch(_n){}
        handled = handled || {}; handled.auditTreasures = { at: Date.now(), note: '不通過·轉灰 ' + keys.length + ' 個' };
        _analyze(uid, detailEl, actionsEl, claims, handled);
      }catch(e){
    ...
    async function _disownRemoveTre(uid, keys, detailEl, actionsEl, claims, handled){
      keys = keys || [];
      if(!keys.length) return;
      ...
      try{
        ...
        if(typeof window._fbMarkRescueItemHandled === 'function') await window._fbMarkRescueItemHandled(uid, 'disownTreasures', '已刪除污染至寶 ' + keys.length + ' 個');
        ...
        handled = handled || {}; handled.disownTreasures = { at: Date.now(), note: '已刪除 ' + keys.length + ' 個' };
        _analyze(uid, detailEl, actionsEl, claims, handled);
      }catch(e){
    ...
    async function _restoreLostTre(uid, keys, detailEl, actionsEl, claims, handled){
      keys = keys || [];
      if(!keys.length) return;
      ...
      try{
        ...
        if(typeof window._fbMarkRescueItemHandled === 'function') await window._fbMarkRescueItemHandled(uid, 'lostTreasures', '已補回至寶 ' + _cnt + ' 個');
        ...
        handled = handled || {}; handled.lostTreasures = { at: Date.now(), note: '已補回 ' + _cnt + ' 個' };
        _analyze(uid, detailEl, actionsEl, claims, handled);
      }catch(e){
    ...
    function _render(reqs){
      ...
      abtns.forEach(function(b){
        b.onclick = function(){
          ...
          if(det && act) _analyze(uid, det, act, _r.claims || {}, _r._handledItems || {});
        };
      });
      ...
      _analyzeBtn.addEventListener('click', function(){
        ...
        _resolveUidLocal(_inputEl.value).then(function(uid){
          return window._fbRebuildAccountFromLedgers(uid).then(function(r){
            ...
            // ★ v3.16.84(老師裁示)— 沒 UID 紀錄但練過/裝至寶/投資過的舊英雄 → 已歸屬玩家(玩家登入自動補蓋 UID),供 GM 知悉
            var _grdh = (d.grandfatheredHeroes && d.grandfatheredHeroes.length) ? d.grandfatheredHeroes : null;
            if(_grdh){
              var _grdChips = _grdh.map(function(n){ return '<span style="display:inline-block;margin:2px 3px;padding:2px 8px;background:rgba(80,220,160,0.14);border:1px solid rgba(80,220,160,0.45);border-radius:10px;color:#aef0cf;">✅ ' + _esc(n) + '</span>'; }).join('');
              html += '<div style="margin-top:8px;padding:7px 9px;background:rgba(20,50,38,0.55);border:1px solid rgba(80,220,160,0.4);border-radius:6px;color:#aef0cf;font-size:12px;"><b>✅ 已歸屬本帳號的舊英雄 ' + _grdh.length + ' 隻(練過/裝至寶/投資過·無需處理):</b><div style="margin-top:4px;">' + _grdChips + '</div><div style="margin-top:4px;color:#88c8a8;font-size:11px;line-height:1.5;">無 UID 紀錄但有培養證據 → 視為學生的,玩家下次登入自動補蓋 UID 永久歸屬,不再被當污染。</div></div>';
            }
            if(r.hasChanges){
  ...
  (function _bindActivitySection(){
    ...
    const _overRestoreBtn = document.getElementById('_admin-activity-overrestore');
    ...
    // ★ v3.16.84 — 過度補回稽查與回收:讀查詢框 email/uid/學號 → 開稽查彈窗(列誤補的別人英雄/至寶 → 一鍵回收+補償+道歉)
    if(_overRestoreBtn) _overRestoreBtn.onclick = function(){
      let _qv = '';
      if(_queryInput){ _qv = String(_queryInput.value || '').trim(); }
      if(!_qv){ _setStatus('請先在上方輸入 email / uid / 學號(lsps...) 再做過度補回稽查', '#ffcc66'); return; }
      if(typeof window._fbShowOverRestoredAudit === 'function'){
        window._fbShowOverRestoredAudit(_qv);
      } else {
        alert('過度補回稽查尚未就緒,請確認 index.html 已更新到 v3.16.84 以上');
      }
    };
