...
async function _showAdminStatsPanelImpl(){
  ...
  (function _initGlobalRewardSection(){
    ...
    async function _send(){
      ...
      if(_chk('_gr-item-clair') || _chk('_gr-item-iliya') || _chk('_gr-item-odin')){
