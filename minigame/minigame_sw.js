 ...
 * ============================================================================ */
var MINI_VERSION = 'v1.58.0';   /* ★ v1.71.0(2026-09-10)：大對抗⇄小遊戲免重登(共用同一份 Firebase 登入狀態＋跨程式交接鑰匙＋小遊戲側共用裝置攔截器)＋PC/iPad/手機三平台版面稽核補丁。本檔僅版號同步(SHELL 改名讓舊快取失效)。 */   /* ★ v1.70.0(2026-09-10)：迷宮陷阱字重試補滿／起點小人物白色呼吸光暈／青炎龍王祭附加效果改版。本檔僅版號同步(SHELL 改名讓舊快取失效)。 */
