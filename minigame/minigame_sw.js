...
function cacheFirst(req, bucket){
  return caches.match(req).then(function(hit){
    ...
    return Promise.race([ fetch(req), timeoutAfter(15000) ]).then(function(res){
