...
var SHELL = 'lxps-mini-shell-v1.117.0';   /* ★ v1.117.0 — 隨 index v1.149.0／island_db v1.149.0 bump,讓所有裝置重抓新版 shell */   /* ★ v1.115.0 — 隨 index v1.146.0 bump,讓所有裝置重抓新版 shell */   /* ★ v1.113.0 — 隨 index v1.144.0 bump,讓所有裝置重抓新版 shell */   /* ★ v1.110.0 — 隨 index v1.141.0／island_db v1.31.0 bump,讓所有裝置重抓新版 shell */
