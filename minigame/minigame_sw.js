...
var SHELL = 'lxps-mini-shell-v1.122.0';   /* ★ v1.122.0 — 隨 index v1.154.0／island_db v1.154.0 bump,讓所有裝置重抓新版 shell */   /* ★ v1.121.0 — 隨 index v1.153.0／island_db v1.153.0 bump,讓所有裝置重抓新版 shell */   /* ★ v1.120.0 — 隨 index v1.152.0／island_db v1.152.0 bump,讓所有裝置重抓新版 shell */   /* ★ v1.119.0 — 隨 index v1.151.0／island_db v1.151.0 bump,讓所有裝置重抓新版 shell */   /* ★ v1.118.0 — 隨 index v1.150.0／island_db v1.150.0 bump,讓所有裝置重抓新版 shell */   /* ★ v1.117.0 — 隨 index v1.149.0／island_db v1.149.0 bump,讓所有裝置重抓新版 shell */   /* ★ v1.115.0 — 隨 index v1.146.0 bump,讓所有裝置重抓新版 shell */   /* ★ v1.113.0 — 隨 index v1.144.0 bump,讓所有裝置重抓新版 shell */   /* ★ v1.110.0 — 隨 index v1.141.0／island_db v1.31.0 bump,讓所有裝置重抓新版 shell */
