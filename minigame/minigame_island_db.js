...
(function(){
  ...
  D.PET_GEAR = [
    ...
    { id:'pg_featherring', n:'羽毛腳環', e:'🪶', tier:1, hand:true, sell:8,
      cost:{ feather:8, reed:6, fiber:3 }, eff:{ spdAdd:10, dodgeAddP:20 }, d:'速度 +10,被攻擊時迴避率 +20%',
    ...
    { id:'pg_honeyjar', n:'蜂蜜小陶罐',  e:'🍯', tier:2, hand:false, sell:25,
      cost:{ honey:5, stone:4, water:3, crystal:1 }, eff:{ regenP:10, gaugeAddP:25 }, d:'每回合開頭恢復自身 10% 最大體力,技能計量充能速度 +25%',
    ...
    { id:'pg_herbsachet', n:'草藥香包',  e:'🍀', tier:2, hand:false, sell:25,
      cost:{ herb:6, herb_essence:2, fiber:4 }, eff:{ cleanseOnce:1, ailResistP:40 }, d:'每場第一次被施加不利狀態時自動解除;不利狀態抗性 +40%',
    ...
    { id:'pg_magma',   n:'熔心勇氣徽章', e:'🌋', tier:3, hand:false, sell:200,
      ...
      eff:{ hpP:15, defAdd:10, gutsOnce:1, dmgHalfP:30 }, d:'最大體力 +15%,防禦 +10;每場第一次被擊倒時保留 1 體力;受到傷害時 30% 機率傷害減半',
  ...
  (function(){ var i; for(i = 0; i < D.PET_GEAR.length; i++){ D.IMG[D.PET_GEAR[i].id] = 'island_' + D.PET_GEAR[i].id + '.png'; } })();   /* 圖片選配(512×512 透明底),缺圖退 emoji */
