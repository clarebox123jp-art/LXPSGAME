...
;
  ...
  D.SK_NODES = [
    ...
    { id:'SK_LIFE_2', g:'life', n:'慢活節奏', e:'🐢', req:['SK_LIFE_1'], u:320, v:-62, d:'所有 QTE 指針變慢 12%;夜襲魔物爬行再慢 15%', eff:{ qteSlowP:12, defSlowP:15 } },
    { id:'SK_LIFE_3', g:'life', n:'伐木採石', e:'🪓', req:['SK_LIFE_1'], u:320, v:62, d:'砍樹/採石 產量各 +1;建造速度 +10%;夜襲補血次數上限 +1', eff:{ chopAdd:1, quarryAdd:1, buildFastP:10, defWoodAdd:1 }, sci:'順著木頭纖維的方向劈,比橫著砍省力很多。' },
    { id:'SK_LIFE_4', g:'life', n:'小心作業', e:'🧤', req:['SK_LIFE_2'], u:410, v:-62, d:'島上活動失誤受傷 −30%;夜襲被咬扣血 −30%', eff:{ hurtCutP:30, defBiteCutP:30 } },
    { id:'SK_LIFE_5', g:'life', n:'漁獵好手', e:'🎣', req:['SK_LIFE_3'], u:410, v:62, d:'捕魚產量 +1;採集作答時間 +8%;探索度增加 +10%', eff:{ fishAdd:1, actSecP:8, exploreP:10 } },
    ...
    { id:'SK_MED_BND_1',   g:'med', sub:'bnd', dep:1, n:'止血',     e:'🩹', req:['SK_CORE_HP'],     u:230, v:-90, d:'戰鬥中可止血:去除自己身上的流血/蜂螫；島上活動失誤受傷 −25%;夜襲被咬扣血再 −25%', eff:{ bleedCure:1, hurtCutP:25, defBiteCutP:25 } },
    ...
    { id:'SK_MED_CK_2',   g:'med', sub:'ck', dep:2, n:'保存食物',   e:'🫙', req:['SK_MED_CK_1'],   u:320, v:90, d:'25% 機率吃了料理卻不消耗那一份；餵動物也有 25% 不消耗飼料;建造/製作材料節省 10%', eff:{ dishSaveP:25, petFeedSaveP:25, costCutP:10 }, sci:'曬乾、煙燻、加鹽都能讓食物不容易壞——因為細菌沒有水就長不起來。' },
    ...
    { id:'SK_CMD_6', g:'cmd', cmd:'CMD_CALL',      n:'呼喚夥伴', e:'📣', req:['SK_CMD_3'],                u:440, v:0, d:'解鎖特殊指令「📣 呼喚夥伴」(戰鬥・⚡1)', eff:{}, sci:'夥伴聽到熟悉的呼喚聲會立刻放下戒心、全力照顧你,安心感能讓身體更快進入修復狀態。' },
