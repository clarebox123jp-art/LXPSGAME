...
;
  ...
  D.SK_NODES = [
    ...
    { id:'SK_BOW_L1', g:'bow', req:['SK_CORE_ATK'], u:85, v:0, n:'銳眼Ⅰ', e:'🎯', d:'暴擊率 +1%', eff:{ critC:1 } },
    { id:'SK_CLUB_L1', g:'club', req:['SK_CORE_ATK'], u:85, v:0, n:'怪力Ⅰ', e:'💪', d:'物理攻擊 +1%', eff:{ atkP:1 } },
    { id:'SK_HAMMER_L1', g:'hammer', req:['SK_CORE_ATK'], u:85, v:0, n:'壯健Ⅰ', e:'💗', d:'最大體力 +1%', eff:{ hpMaxP:1 } },
    { id:'SK_SPEAR_L1', g:'spear', req:['SK_CORE_ATK'], u:85, v:0, n:'堅守Ⅰ', e:'🛡', d:'防禦 +1%', eff:{ defP:1 } },
    { id:'SK_BOOMERANG_L1', g:'boomerang', req:['SK_CORE_ATK'], u:85, v:0, n:'靈動Ⅰ', e:'🌀', d:'行動速度 +1%', eff:{ spdP:1 } },
    { id:'SK_CORE_HP',   g:'core', n:'強健', e:'💪', req:[], pr:115, pa:22.5,   d:'最大體力 +10%;每日 ⚡AP +1;夜襲營火血量 +1', eff:{ hpMaxP:10, apAdd:1, defHpAdd:1 } },
    { id:'SK_MED_BND_L1', g:'med', req:['SK_CORE_HP'], u:115, v:-45, n:'藥效Ⅰ', e:'💚', d:'治療/解毒效果 +1%', eff:{ healP:1 } },
    { id:'SK_MED_CK_L1', g:'med', req:['SK_CORE_HP'], u:115, v:45, n:'飽足Ⅰ', e:'🍚', d:'最大體力 +1%', eff:{ hpMaxP:1 } },
    { id:'SK_CORE_LUCK', g:'core', n:'幸運', e:'🍀', req:[], pr:115, pa:67.5,   d:'稀有掉落率 +5%;野生動物馴養成功率 +10%、寵物親密度提升效率 +10%', eff:{ luckP:5, tameP:10, bondGainP:10 } },
    { id:'SK_MED_PHM_L1', g:'med', req:['SK_CORE_LUCK'], u:115, v:0, n:'強身Ⅰ', e:'🧿', d:'島上不良狀態發生機率再減免 +1%', eff:{ ailResP:1 } },
    { id:'SK_CMD_L1', g:'cmd', req:['SK_CORE_LUCK'], u:130, v:0, n:'警覺Ⅰ', e:'🥋', d:'閃避時額外減傷 +1%', eff:{ dodgeCutP:1 } },
    { id:'SK_CORE_SPD',  g:'core', n:'敏捷', e:'💨', req:[], pr:115, pa:-112.5, d:'行動速度 +5%;島上走路速度 +12%;探索度增加 +10%', eff:{ spdP:5, moveP:12, exploreP:10 } },
    { id:'SK_LIFE_L1', g:'life', req:['SK_CORE_SPD'], u:115, v:0, n:'健步Ⅰ', e:'👟', d:'島上走路速度 +1%', eff:{ moveP:1 } },
    /* ── 🏹 弓箭星域:🎯 專注層 ── */
    { id:'SK_BOW_1', g:'bow', wp:['bow'], n:'專注呼吸', e:'🎯', req:['SK_BOW_L1'], u:170, v:0, d:'命中時累積「🎯專注」1 層(上限 3):每層暴擊率 +4%、傷害 +3%;整回合落空專注就散掉', eff:{ focusOn:1 }, sci:'拉弓前先穩住呼吸,手才不會晃——專注靠的是身體放鬆,不是用力。' },
    { id:'SK_BOW_L2', g:'bow', req:['SK_BOW_1'], u:217.5, v:0, n:'銳眼Ⅱ', e:'🎯', d:'暴擊率 +1%', eff:{ critC:1 } },
    { id:'SK_BOW_2', g:'bow', wp:['bow'], n:'基本功', e:'🎯', req:['SK_BOW_L2'], u:265, v:0, d:'暴擊率 +5%、傷害 +5%', eff:{ critC:5, dmgP:5 } },
    { id:'SK_BOW_L3A', g:'bow', req:['SK_BOW_2'], u:312.5, v:-31, n:'銳眼Ⅲ', e:'🎯', d:'暴擊率 +1%', eff:{ critC:1 } },
    { id:'SK_BOW_L3B', g:'bow', req:['SK_BOW_2'], u:312.5, v:31, n:'銳眼Ⅲ', e:'🎯', d:'暴擊率 +1%', eff:{ critC:1 } },
    { id:'SK_BOW_F1A', g:'bow', wp:['bow'], grp:'bow_f', n:'屏息凝神', e:'🌬', req:['SK_BOW_L3A'], u:360, v:-62, d:'【分歧・二選一】專注上限 +2(最多 5 層),每層暴擊率再 +2%', eff:{ focusMax:2, focusCrit:2 } },
    { id:'SK_BOW_L4A', g:'bow', req:['SK_BOW_F1A'], u:407.5, v:-62, n:'銳眼Ⅳ', e:'🎯', d:'暴擊率 +1%', eff:{ critC:1 } },
    { id:'SK_BOW_F1B', g:'bow', wp:['bow'], grp:'bow_f', n:'快手連發', e:'⚡', req:['SK_BOW_L3B'], u:360, v:62, d:'【分歧・二選一】命中後 12% 機率不消耗這個回合;落空時專注只掉 1 層', eff:{ freeP:12, focusKeep:1 } },
    { id:'SK_BOW_L4B', g:'bow', req:['SK_BOW_F1B'], u:407.5, v:62, n:'銳眼Ⅳ', e:'🎯', d:'暴擊率 +1%', eff:{ critC:1 } },
    { id:'SK_BOW_F2A', g:'bow', wp:['bow'], n:'一擊必殺', e:'💥', req:['SK_BOW_L4A'], u:455, v:-62, d:'專注滿層時,下一箭命中必定暴擊、暴擊傷害再 +30%,射完專注歸零', eff:{ focusBurst:1 } },
    { id:'SK_BOW_F2B', g:'bow', wp:['bow'], n:'箭雨', e:'🌧', req:['SK_BOW_L4B'], u:455, v:62, d:'普通攻擊後 30% 機率多射一箭,打另一隻魔物(50% 傷害、必中)', eff:{ arrowP:30 } },
    ...
    { id:'SK_BOW_L5', g:'bow', req:['SK_BOW_KEY'], u:597.5, v:0, n:'銳眼Ⅴ', e:'🎯', d:'暴擊率 +1%', eff:{ critC:1 } },
    { id:'SK_BOW_M', g:'bow', wp:['bow'], mst:true, n:'鷹眼', e:'👑', req:['SK_BOW_L5'], mat:{ boss_batfeather:2 }, u:645, v:0, d:'【精通】絕招每場可以用 2 次;開戰就有 1 層專注。需要頭目素材 🪶蝠后之羽 ×2(洗點後再點不必重付)', eff:{ actAdd:1, focusStart:1 }, sci:'老鷹的眼睛能看清幾百公尺外的小動物,因為牠視網膜上的感光細胞特別密。' },
    /* ── 🪵 棍棒石斧星域:🪓 破甲層 ── */
    { id:'SK_CLUB_1', g:'club', wp:['club','stoneaxe'], n:'破甲打擊', e:'🪓', req:['SK_CLUB_L1'], u:170, v:0, d:'攻擊命中時,讓目標疊 1 層「🪓破甲」(上限 3):每層防禦 −6%;破甲留在那隻魔物身上,換目標也不會消失', eff:{ brkOn:1 }, sci:'一直敲同一個地方,硬殼上的小裂縫會越來越大——這就是「疲勞破壞」。' },
    { id:'SK_CLUB_L2', g:'club', req:['SK_CLUB_1'], u:217.5, v:0, n:'怪力Ⅱ', e:'💪', d:'物理攻擊 +1%', eff:{ atkP:1 } },
    { id:'SK_CLUB_2', g:'club', wp:['club','stoneaxe'], n:'基本功', e:'🎯', req:['SK_CLUB_L2'], u:265, v:0, d:'暴擊率 +5%、傷害 +5%', eff:{ critC:5, dmgP:5 } },
    { id:'SK_CLUB_L3A', g:'club', req:['SK_CLUB_2'], u:312.5, v:-31, n:'怪力Ⅲ', e:'💪', d:'物理攻擊 +1%', eff:{ atkP:1 } },
    { id:'SK_CLUB_L3B', g:'club', req:['SK_CLUB_2'], u:312.5, v:31, n:'怪力Ⅲ', e:'💪', d:'物理攻擊 +1%', eff:{ atkP:1 } },
    { id:'SK_CLUB_F1A', g:'club', wp:['club','stoneaxe'], grp:'club_f', n:'重劈', e:'🪨', req:['SK_CLUB_L3A'], u:360, v:-62, d:'【分歧・二選一】破甲上限 +2(最多 5 層),每層再 −2%(滿層防禦 −40%)', eff:{ brkMax:2, brkDef:2 } },
    { id:'SK_CLUB_L4A', g:'club', req:['SK_CLUB_F1A'], u:407.5, v:-62, n:'怪力Ⅳ', e:'💪', d:'物理攻擊 +1%', eff:{ atkP:1 } },
    { id:'SK_CLUB_F1B', g:'club', wp:['club','stoneaxe'], grp:'club_f', n:'趁亂追擊', e:'💫', req:['SK_CLUB_L3B'], u:360, v:62, d:'【分歧・二選一】對暈眩中的目標傷害 +25%,而且每次多疊 1 層破甲', eff:{ vsStunP:25, brkStun:1 } },
    { id:'SK_CLUB_L4B', g:'club', req:['SK_CLUB_F1B'], u:407.5, v:62, n:'怪力Ⅳ', e:'💪', d:'物理攻擊 +1%', eff:{ atkP:1 } },
    { id:'SK_CLUB_F2A', g:'club', wp:['club','stoneaxe'], n:'碎甲', e:'💢', req:['SK_CLUB_L4A'], u:455, v:-62, d:'目標破甲疊滿時,你的傷害 +30%', eff:{ brkFullP:30 } },
    { id:'SK_CLUB_F2B', g:'club', wp:['club','stoneaxe'], n:'反擊', e:'🛡', req:['SK_CLUB_L4B'], u:455, v:62, d:'被魔物打中時 15% 機率立刻反擊(50% 傷害),反擊也會疊破甲', eff:{ counterP:15, brkCounter:1 } },
    ...
    { id:'SK_CLUB_L5', g:'club', req:['SK_CLUB_KEY'], u:597.5, v:0, n:'怪力Ⅴ', e:'💪', d:'物理攻擊 +1%', eff:{ atkP:1 } },
    { id:'SK_CLUB_M', g:'club', wp:['club','stoneaxe'], mst:true, n:'裂岩者', e:'👑', req:['SK_CLUB_L5'], mat:{ boss_magmashell:2 }, u:645, v:0, d:'【精通】每隻魔物第一次被你打中就直接疊 2 層破甲;傷害 +8%。需要頭目素材 🟥熔甲殼片 ×2(洗點後再點不必重付)', eff:{ brkOpen:2, dmgP:8 }, sci:'岩石遇熱膨脹、遇冷收縮,反覆幾次就會裂開——這叫「熱脹冷縮造成的風化」。' },
    /* ── 🔨 錘星域:🔋 蓄力層 ── */
    { id:'SK_HAMMER_1', g:'hammer', wp:['hammer'], n:'蓄力架勢', e:'🔋', req:['SK_HAMMER_L1'], u:170, v:0, d:'按「🛡 防禦」時蓄 1 層「🔋蓄力」(上限 2):下一次攻擊或絕招每層傷害 +30%、擊暈機率 +8%,打出去就用掉', eff:{ chargeOn:1 }, sci:'把錘子舉高再落下,位能變成動能——舉得越高,打下去越重。' },
    { id:'SK_HAMMER_L2', g:'hammer', req:['SK_HAMMER_1'], u:217.5, v:0, n:'壯健Ⅱ', e:'💗', d:'最大體力 +1%', eff:{ hpMaxP:1 } },
    { id:'SK_HAMMER_2', g:'hammer', wp:['hammer'], n:'基本功', e:'🎯', req:['SK_HAMMER_L2'], u:265, v:0, d:'暴擊率 +5%、傷害 +5%', eff:{ critC:5, dmgP:5 } },
    { id:'SK_HAMMER_L3A', g:'hammer', req:['SK_HAMMER_2'], u:312.5, v:-31, n:'壯健Ⅲ', e:'💗', d:'最大體力 +1%', eff:{ hpMaxP:1 } },
    { id:'SK_HAMMER_L3B', g:'hammer', req:['SK_HAMMER_2'], u:312.5, v:31, n:'壯健Ⅲ', e:'💗', d:'最大體力 +1%', eff:{ hpMaxP:1 } },
    { id:'SK_HAMMER_F1A', g:'hammer', wp:['hammer'], grp:'hammer_f', n:'厚積薄發', e:'🏋', req:['SK_HAMMER_L3A'], u:360, v:-62, d:'【分歧・二選一】蓄力上限 +1(最多 3 層),每層傷害再 +10%', eff:{ chargeMax:1, chargeMul:10 } },
    { id:'SK_HAMMER_L4A', g:'hammer', req:['SK_HAMMER_F1A'], u:407.5, v:-62, n:'壯健Ⅳ', e:'💗', d:'最大體力 +1%', eff:{ hpMaxP:1 } },
    { id:'SK_HAMMER_F1B', g:'hammer', wp:['hammer'], grp:'hammer_f', n:'震盪', e:'😵', req:['SK_HAMMER_L3B'], u:360, v:62, d:'【分歧・二選一】擊暈機率 +12%;蓄力每層擊暈機率再 +6%', eff:{ stunAddP:12, chargeStun:6 }, sci:'重物撞擊會把能量變成震動傳出去。' },
    { id:'SK_HAMMER_L4B', g:'hammer', req:['SK_HAMMER_F1B'], u:407.5, v:62, n:'壯健Ⅳ', e:'💗', d:'最大體力 +1%', eff:{ hpMaxP:1 } },
    { id:'SK_HAMMER_F2A', g:'hammer', wp:['hammer'], n:'地鳴', e:'🌋', req:['SK_HAMMER_L4A'], u:455, v:-62, d:'蓄力滿層出手時,其他魔物也會受到 40% 傷害', eff:{ chargeSplash:40 } },
    { id:'SK_HAMMER_F2B', g:'hammer', wp:['hammer'], n:'硬扛', e:'🧱', req:['SK_HAMMER_L4B'], u:455, v:62, d:'每次受傷固定 −3;身上有蓄力時受傷再 −20%', eff:{ dmgCut:3, chargeGuard:20 } },
    ...
    { id:'SK_HAMMER_L5', g:'hammer', req:['SK_HAMMER_KEY'], u:597.5, v:0, n:'壯健Ⅴ', e:'💗', d:'最大體力 +1%', eff:{ hpMaxP:1 } },
    { id:'SK_HAMMER_M', g:'hammer', wp:['hammer'], mst:true, n:'山崩', e:'👑', req:['SK_HAMMER_L5'], mat:{ boss_lavaheart:1 }, u:645, v:0, d:'【精通】普通攻擊命中 25% 機率自動蓄 1 層;開戰就有 1 層蓄力。需要頭目素材 ❤️‍🔥巨像熔心 ×1(洗點後再點不必重付)', eff:{ chargeAutoP:25, chargeStart:1 }, sci:'山崩是因為坡上的土石重量大過摩擦力,一點點震動就讓整片滑下來。' },
    /* ── 🔱 長槍星域:🔱 架槍反擊 ── */
    { id:'SK_SPEAR_1', g:'spear', wp:['spear'], n:'架槍', e:'🔱', req:['SK_SPEAR_L1'], u:170, v:0, d:'按「🛡 防禦」時架起長槍:到你下一回合前,魔物普通攻擊打你,你一定反刺一下(50% 傷害)', eff:{ braceOn:1 }, sci:'長槍比對手的手臂長,先把槍尖對準對方,對方衝過來就等於自己撞上來。' },
    { id:'SK_SPEAR_L2', g:'spear', req:['SK_SPEAR_1'], u:217.5, v:0, n:'堅守Ⅱ', e:'🛡', d:'防禦 +1%', eff:{ defP:1 } },
    { id:'SK_SPEAR_2', g:'spear', wp:['spear'], n:'基本功', e:'🎯', req:['SK_SPEAR_L2'], u:265, v:0, d:'暴擊率 +5%、傷害 +5%', eff:{ critC:5, dmgP:5 } },
    { id:'SK_SPEAR_L3A', g:'spear', req:['SK_SPEAR_2'], u:312.5, v:-31, n:'堅守Ⅲ', e:'🛡', d:'防禦 +1%', eff:{ defP:1 } },
    { id:'SK_SPEAR_L3B', g:'spear', req:['SK_SPEAR_2'], u:312.5, v:31, n:'堅守Ⅲ', e:'🛡', d:'防禦 +1%', eff:{ defP:1 } },
    { id:'SK_SPEAR_F1A', g:'spear', wp:['spear'], grp:'spear_f', n:'以守代攻', e:'🛡', req:['SK_SPEAR_L3A'], u:360, v:-62, d:'【分歧・二選一】反刺傷害 +30%(變成 80%),而且反刺可以暴擊', eff:{ braceMul:30, braceCrit:1 } },
    { id:'SK_SPEAR_L4A', g:'spear', req:['SK_SPEAR_F1A'], u:407.5, v:-62, n:'堅守Ⅳ', e:'🛡', d:'防禦 +1%', eff:{ defP:1 } },
    { id:'SK_SPEAR_F1B', g:'spear', wp:['spear'], grp:'spear_f', n:'放血', e:'🩸', req:['SK_SPEAR_L3B'], u:360, v:62, d:'【分歧・二選一】普通攻擊與反刺命中時,讓目標流血 1 層(每回合 −2)', eff:{ bleedOn:1 } },
    { id:'SK_SPEAR_L4B', g:'spear', req:['SK_SPEAR_F1B'], u:407.5, v:62, n:'堅守Ⅳ', e:'🛡', d:'防禦 +1%', eff:{ defP:1 } },
    { id:'SK_SPEAR_F2A', g:'spear', wp:['spear'], n:'見招拆招', e:'👁', req:['SK_SPEAR_L4A'], u:455, v:-62, d:'完美閃避時也會順勢反刺(不必先架槍)', eff:{ braceDodge:1 } },
    { id:'SK_SPEAR_F2B', g:'spear', wp:['spear'], n:'先發制人', e:'🥇', req:['SK_SPEAR_L4B'], u:455, v:62, d:'每場戰鬥第一擊必定命中;對流血中的目標傷害 +15%', eff:{ firstHit:1, vsBleedP:15 } },
    ...
    { id:'SK_SPEAR_L5', g:'spear', req:['SK_SPEAR_KEY'], u:597.5, v:0, n:'堅守Ⅴ', e:'🛡', d:'防禦 +1%', eff:{ defP:1 } },
    { id:'SK_SPEAR_M', g:'spear', wp:['spear'], mst:true, n:'不動如山', e:'👑', req:['SK_SPEAR_L5'], mat:{ boss_thunderplume:2 }, u:645, v:0, d:'【精通】架槍時受到的傷害 −30%;架槍多撐 1 回合。需要頭目素材 ⚡雷鳴羽 ×2(洗點後再點不必重付)', eff:{ braceCut:30, braceKeep:1 }, sci:'重心越低、腳站越開,身體越不容易被推倒——所以架槍要蹲低。' },
    /* ── 🪃 迴力鏢星域:↪ 彈射 ── */
    { id:'SK_BOOMERANG_1', g:'boomerang', wp:['boomerang'], n:'迴旋彈射', e:'↪', req:['SK_BOOMERANG_L1'], u:170, v:0, d:'迴力鏢第二段彈到另一隻魔物的那一下,傷害 +20%', eff:{ bounceMul:20 }, sci:'迴力鏢彎曲的翼形讓它一邊旋轉一邊繞回來。' },
    { id:'SK_BOOMERANG_L2', g:'boomerang', req:['SK_BOOMERANG_1'], u:217.5, v:0, n:'靈動Ⅱ', e:'🌀', d:'行動速度 +1%', eff:{ spdP:1 } },
    { id:'SK_BOOMERANG_2', g:'boomerang', wp:['boomerang'], n:'基本功', e:'🎯', req:['SK_BOOMERANG_L2'], u:265, v:0, d:'暴擊率 +5%、傷害 +5%', eff:{ critC:5, dmgP:5 } },
    { id:'SK_BOOMERANG_L3A', g:'boomerang', req:['SK_BOOMERANG_2'], u:312.5, v:-31, n:'靈動Ⅲ', e:'🌀', d:'行動速度 +1%', eff:{ spdP:1 } },
    { id:'SK_BOOMERANG_L3B', g:'boomerang', req:['SK_BOOMERANG_2'], u:312.5, v:31, n:'靈動Ⅲ', e:'🌀', d:'行動速度 +1%', eff:{ spdP:1 } },
    { id:'SK_BOOMERANG_F1A', g:'boomerang', wp:['boomerang'], grp:'boomerang_f', n:'雙迴旋', e:'🌀', req:['SK_BOOMERANG_L3A'], u:360, v:-62, d:'【分歧・二選一】一回合多丟 1 段', eff:{ hitsAdd:1 } },
    { id:'SK_BOOMERANG_L4A', g:'boomerang', req:['SK_BOOMERANG_F1A'], u:407.5, v:-62, n:'靈動Ⅳ', e:'🌀', d:'行動速度 +1%', eff:{ spdP:1 } },
    { id:'SK_BOOMERANG_F1B', g:'boomerang', wp:['boomerang'], grp:'boomerang_f', n:'精準迴旋', e:'🎯', req:['SK_BOOMERANG_L3B'], u:360, v:62, d:'【分歧・二選一】彈射傷害再 +30%,並且優先彈向血量最少的魔物', eff:{ bounceMul:30, bounceSmart:1 } },
    { id:'SK_BOOMERANG_L4B', g:'boomerang', req:['SK_BOOMERANG_F1B'], u:407.5, v:62, n:'靈動Ⅳ', e:'🌀', d:'行動速度 +1%', eff:{ spdP:1 } },
    { id:'SK_BOOMERANG_F2A', g:'boomerang', wp:['boomerang'], n:'追打', e:'💫', req:['SK_BOOMERANG_L4A'], u:455, v:-62, d:'對暈眩中的目標傷害 +20%;彈射命中 15% 機率把目標打暈', eff:{ vsStunP:20, bounceStunP:15 } },
    { id:'SK_BOOMERANG_F2B', g:'boomerang', wp:['boomerang'], n:'回收', e:'♻', req:['SK_BOOMERANG_L4B'], u:455, v:62, d:'命中後 25% 機率多賺 1 點武器熟練;彈射打倒魔物時回復 15% 體力', eff:{ xpBackP:25, bounceKillHeal:15 } },   /* ★ v1.288.0 老師「迴力鏢的『回收』打倒敵人恢復自己體力改成 15%」— 6→15(原本 6% 在中後期一場打下來幾乎感覺不到,而且這一節點的對照組「追打」是純傷害加成,回復量太低會讓分歧變成沒得選) */
    ...
    { id:'SK_BOOMERANG_L5', g:'boomerang', req:['SK_BOOMERANG_KEY'], u:597.5, v:0, n:'靈動Ⅴ', e:'🌀', d:'行動速度 +1%', eff:{ spdP:1 } },
    { id:'SK_BOOMERANG_M', g:'boomerang', wp:['boomerang'], mst:true, n:'旋風', e:'👑', req:['SK_BOOMERANG_L5'], mat:{ boss_shadowgem:2 }, u:645, v:0, d:'【精通】第三段也會彈射(打第三隻魔物,沒有就打第二隻)。需要頭目素材 🔮深淵影晶 ×2(洗點後再點不必重付)', eff:{ bounceAdd:1 }, sci:'旋轉的東西會比較穩——陀螺、腳踏車輪子都是靠這個原理不倒。' },
    /* ── 🧺 中央・生活技藝星域(B5:原本散在各武器星域的生活效果全部搬到這裡,不必再為了砍樹去點某把武器) ── */
    { id:'SK_LIFE_1', g:'life', n:'巧手', e:'🖐', req:['SK_LIFE_L1'], u:230, v:0, d:'所有 QTE 甜蜜點 +8%(島上活動與戰鬥攻擊都算)', eff:{ sweetP:8 } },
    { id:'SK_LIFE_L2', g:'life', req:['SK_LIFE_1'], u:275, v:-31, n:'健步Ⅱ', e:'👟', d:'島上走路速度 +1%', eff:{ moveP:1 } },
    { id:'SK_LIFE_L3', g:'life', req:['SK_LIFE_1'], u:275, v:31, n:'健步Ⅱ', e:'👟', d:'島上走路速度 +1%', eff:{ moveP:1 } },
    { id:'SK_LIFE_2', g:'life', n:'慢活節奏', e:'🐢', req:['SK_LIFE_L2'], u:320, v:-62, d:'所有 QTE 指針變慢 12%;夜襲魔物爬行再慢 15%', eff:{ qteSlowP:12, defSlowP:15 } },
    { id:'SK_LIFE_L4', g:'life', req:['SK_LIFE_2'], u:365, v:-62, n:'健步Ⅲ', e:'👟', d:'島上走路速度 +1%', eff:{ moveP:1 } },
    { id:'SK_LIFE_3', g:'life', n:'伐木採石', e:'🪓', req:['SK_LIFE_L3'], u:320, v:62, d:'砍樹/採石 產量各 +1;建造速度 +10%;夜襲補血次數上限 +1', eff:{ chopAdd:1, quarryAdd:1, buildFastP:10, defWoodAdd:1 }, sci:'順著木頭纖維的方向劈,比橫著砍省力很多。' },
    { id:'SK_LIFE_L5', g:'life', req:['SK_LIFE_3'], u:365, v:62, n:'健步Ⅲ', e:'👟', d:'島上走路速度 +1%', eff:{ moveP:1 } },
    { id:'SK_LIFE_4', g:'life', n:'小心作業', e:'🧤', req:['SK_LIFE_L4'], u:410, v:-62, d:'島上活動失誤受傷 −30%;夜襲被咬扣血 −30%', eff:{ hurtCutP:30, defBiteCutP:30 } },
    { id:'SK_LIFE_5', g:'life', n:'漁獵好手', e:'🎣', req:['SK_LIFE_L5'], u:410, v:62, d:'捕魚產量 +1;採集作答時間 +8%;探索度增加 +10%', eff:{ fishAdd:1, actSecP:8, exploreP:10 } },
    { id:'SK_LIFE_6', g:'life', key:true, n:'匠心', e:'🌟', req:['SK_LIFE_4','SK_LIFE_5'], u:500, v:0, d:'★建造/製作品質 ★ +1;QTE 甜蜜點再 +5%、指針再慢 10%;建造速度再 +15%、材料節省 15%', eff:{ craftStar:1, sweetP:5, qteSlowP:10, buildFastP:15, costCutP:15 }, sci:'熟能生巧:重複練習會讓大腦把動作變成「自動化」,不用想也做得準。' },
    { id:'SK_MED_BND_1',   g:'med', sub:'bnd', dep:1, n:'止血',     e:'🩹', req:['SK_MED_BND_L1'],     u:230, v:-90, d:'戰鬥中可止血:去除自己身上的流血/蜂螫；島上活動失誤受傷 −25%;夜襲被咬扣血再 −25%', eff:{ bleedCure:1, hurtCutP:25, defBiteCutP:25 } },
    { id:'SK_MED_BND_L2', g:'med', req:['SK_MED_BND_1'], u:275, v:-90, n:'藥效Ⅱ', e:'💚', d:'治療/解毒效果 +1%', eff:{ healP:1 } },
    { id:'SK_MED_BND_2',   g:'med', sub:'bnd', dep:2, n:'緊急包紮', e:'🧻', req:['SK_MED_BND_L2'],   u:320, v:-90, d:'每場戰鬥 1 次:立刻回復 30% 體力(不用藥草)', eff:{ bandageP:30, bandageN:1 } },
    { id:'SK_MED_BND_L3', g:'med', req:['SK_MED_BND_2'], u:365, v:-90, n:'藥效Ⅲ', e:'💚', d:'治療/解毒效果 +1%', eff:{ healP:1 } },
    { id:'SK_MED_BND_3',   g:'med', sub:'bnd', dep:3, n:'為隊友包紮', e:'🤝', req:['SK_MED_BND_L3'], u:410, v:-90, d:'緊急包紮改成治療「全隊」(主角+所有沒倒下的隊友);可用次數 +1、回復量 +10%', eff:{ bandageN:1, bandageP:10, allyBnd:1 } },   /* ★ v1.288.0 老師「為隊友包紮保留原本效果並將治療效果變為全體」— 次數+1/回復量+10% 兩個原效果一字未改,allyBnd 的意義由「多人連線用(單人只是數字大一點)」升級成真正的全體治療,index 端 islSkBandage 有對應分支;倒下的隊友不算在內(那是 🩹 戰場急救與 🧪 草藥精華的守備範圍) */
    { id:'SK_MED_BND_L4', g:'med', req:['SK_MED_BND_3'], u:455, v:-90, n:'藥效Ⅳ', e:'💚', d:'治療/解毒效果 +1%', eff:{ healP:1 } },
    { id:'SK_MED_BND_KEY', g:'med', sub:'bnd', dep:4, key:true, n:'不倒的意志', e:'🌟', req:['SK_MED_BND_L4'], u:500, v:-90, d:'★關鍵節點:每場戰鬥 1 次,體力歸零時保留 1 點不算戰敗', eff:{ deathSave:1 } },
    { id:'SK_MED_PHM_1',   g:'med', sub:'phm', dep:1, n:'辨識野生藥草', e:'🍀', req:['SK_MED_PHM_L1'], u:230, v:0, d:'採集時 🍀草藥 掉落機率 +25%；野生動物馴養成功率 +15%、寵物親密度提升效率 +15%', eff:{ herbP:25, tameP:15, bondGainP:15 }, sci:'認得出植物才敢用——不認得的野草絕對不能亂吃。' },   /* ★ v1.196.0 新增 bondGainP,tameP 保留不動(見 SK_CORE_LUCK 註解) */
    { id:'SK_MED_PHM_L2', g:'med', req:['SK_MED_PHM_1'], u:275, v:0, n:'強身Ⅱ', e:'🧿', d:'島上不良狀態發生機率再減免 +1%', eff:{ ailResP:1 } },
    { id:'SK_MED_PHM_2',   g:'med', sub:'phm', dep:2, n:'基礎解毒劑', e:'🧪', req:['SK_MED_PHM_L2'],   u:320, v:0, d:'可調配解毒劑,解除蛇咬中毒(需 🍀草藥 1)', eff:{ poisonCure:1 } },
    { id:'SK_MED_PHM_L3', g:'med', req:['SK_MED_PHM_2'], u:365, v:0, n:'強身Ⅲ', e:'🧿', d:'島上不良狀態發生機率再減免 +1%', eff:{ ailResP:1 } },
    { id:'SK_MED_PHM_3',   g:'med', sub:'phm', dep:3, n:'毒素抗性',   e:'🛡', req:['SK_MED_PHM_L3'],   u:410, v:0, d:'中毒每回合傷害減半,惡化速度也減半；島上活動失誤受傷 −25%', eff:{ poisonResP:50, hurtCutP:25 } },
    { id:'SK_MED_PHM_L4', g:'med', req:['SK_MED_PHM_3'], u:455, v:0, n:'強身Ⅳ', e:'🧿', d:'島上不良狀態發生機率再減免 +1%', eff:{ ailResP:1 } },
    { id:'SK_MED_PHM_KEY', g:'med', sub:'phm', dep:4, key:true, n:'進階解毒劑', e:'🌟', req:['SK_MED_PHM_L4'], u:500, v:0, d:'★關鍵節點:一次解除身上所有不良狀態(每天 1 次,需 🍀草藥 1)', eff:{ cureAll:1 } },
    { id:'SK_MED_CK_1',   g:'med', sub:'ck', dep:1, n:'恢復料理',   e:'🍲', req:['SK_MED_CK_L1'],    u:230, v:90, d:'吃料理回復量 +20%,熱食可解除失溫；養的動物每日產出 +20%', eff:{ dishP:20, coldCure:1, petYieldP:20 } },
    { id:'SK_MED_CK_L2', g:'med', req:['SK_MED_CK_1'], u:275, v:90, n:'飽足Ⅱ', e:'🍚', d:'最大體力 +1%', eff:{ hpMaxP:1 } },
    { id:'SK_MED_CK_2',   g:'med', sub:'ck', dep:2, n:'保存食物',   e:'🫙', req:['SK_MED_CK_L2'],   u:320, v:90, d:'25% 機率吃了料理卻不消耗那一份；餵動物也有 25% 不消耗飼料;建造/製作材料節省 10%', eff:{ dishSaveP:25, petFeedSaveP:25, costCutP:10 }, sci:'曬乾、煙燻、加鹽都能讓食物不容易壞——因為細菌沒有水就長不起來。' },
    { id:'SK_MED_CK_L3', g:'med', req:['SK_MED_CK_2'], u:365, v:90, n:'飽足Ⅲ', e:'🍚', d:'最大體力 +1%', eff:{ hpMaxP:1 } },
    { id:'SK_MED_CK_3',   g:'med', sub:'ck', dep:3, n:'消除疲勞',   e:'⚡', req:['SK_MED_CK_L3'],   u:410, v:90, d:'每天第一次吃料理額外回復 ⚡AP 1；養的動物每日產出 +25%', eff:{ dishAp:1, petYieldP:25 } },
    { id:'SK_MED_CK_L4', g:'med', req:['SK_MED_CK_3'], u:455, v:90, n:'飽足Ⅳ', e:'🍚', d:'最大體力 +1%', eff:{ hpMaxP:1 } },
    { id:'SK_MED_CK_KEY', g:'med', sub:'ck', dep:4, key:true, n:'營地聚餐', e:'🌟', req:['SK_MED_CK_L4'], u:500, v:90, d:'★多人連線用;在營地辦聚餐:今天攻擊 +10%(每天 1 次,需任一道料理)；養的動物每日產出 +25%、野生動物馴養成功率 +15%、寵物親密度提升效率 +15%', eff:{ feast:1, petYieldP:25, tameP:15, bondGainP:15 } },   /* ★ v1.196.0 新增 bondGainP,tameP 保留不動(見 SK_CORE_LUCK 註解) */
    /* ★ v1.163.0 ── 🎯 特殊指令星域(每個節點帶一個 cmd 鍵 → 對應 D.SK_CMDS;點亮 = 解鎖該指令,還要到能力頁裝設才會出現按鈕) ── */
    { id:'SK_CMD_1', g:'cmd', cmd:'CMD_SCAN',      n:'環境觀察', e:'🔍', req:['SK_CMD_L1'],           u:260, v:0, d:'解鎖特殊指令「🔍 環境觀察」(野外・⚡1)', eff:{}, sci:'先觀察再行動,是所有野外工作的第一步。' },
    { id:'SK_CMD_L2', g:'cmd', req:['SK_CMD_1'], u:305, v:-45, n:'警覺Ⅱ', e:'🥋', d:'閃避時額外減傷 +1%', eff:{ dodgeCutP:1 } },
    { id:'SK_CMD_L3', g:'cmd', req:['SK_CMD_1'], u:305, v:0, n:'警覺Ⅱ', e:'🥋', d:'閃避時額外減傷 +1%', eff:{ dodgeCutP:1 } },
    { id:'SK_CMD_L4', g:'cmd', req:['SK_CMD_1'], u:305, v:45, n:'警覺Ⅱ', e:'🥋', d:'閃避時額外減傷 +1%', eff:{ dodgeCutP:1 } },
    { id:'SK_CMD_2', g:'cmd', cmd:'CMD_FIRSTAID',  n:'戰場急救', e:'🩹', req:['SK_CMD_L2'],                u:350, v:-90, d:'解鎖特殊指令「🩹 戰場急救」(戰鬥・⚡2)', eff:{}, sci:'急救的順序是先止血、再保暖,最後才送醫。' },
    { id:'SK_CMD_L5', g:'cmd', req:['SK_CMD_2'], u:395, v:-90, n:'警覺Ⅲ', e:'🥋', d:'閃避時額外減傷 +1%', eff:{ dodgeCutP:1 } },
    { id:'SK_CMD_3', g:'cmd', cmd:'CMD_SMOKE',     n:'煙霧彈',   e:'💨', req:['SK_CMD_L3'],                u:350, v:0, d:'解鎖特殊指令「💨 煙霧彈」(戰鬥・⚡1)',   eff:{}, sci:'濃煙會遮住動物的視線與氣味,是很老的脫身方法。' },
    { id:'SK_CMD_L6', g:'cmd', req:['SK_CMD_3'], u:395, v:0, n:'警覺Ⅲ', e:'🥋', d:'閃避時額外減傷 +1%', eff:{ dodgeCutP:1 } },
    { id:'SK_CMD_4', g:'cmd', cmd:'CMD_QUICKPICK', n:'熟練採集', e:'🧺', req:['SK_CMD_L4'],                u:350, v:90, d:'解鎖特殊指令「🧺 熟練採集」(野外・⚡2)', eff:{}, sci:'熟練來自重複練習,動作會慢慢變成身體記得的事。' },
    { id:'SK_CMD_L7', g:'cmd', req:['SK_CMD_4'], u:395, v:90, n:'警覺Ⅲ', e:'🥋', d:'閃避時額外減傷 +1%', eff:{ dodgeCutP:1 } },
    { id:'SK_CMD_5', g:'cmd', cmd:'CMD_TRAP',      n:'佈設陷阱', e:'🪤', req:['SK_CMD_L5'],                u:440, v:-90, d:'解鎖特殊指令「🪤 佈設陷阱」(戰鬥・⚡2)', eff:{}, sci:'陷阱靠的是「位能一次放掉」,所以小小的繩子也能絆倒大東西。' },
    { id:'SK_CMD_6', g:'cmd', cmd:'CMD_CALL',      n:'呼喚夥伴', e:'📣', req:['SK_CMD_L6'],                u:440, v:0, d:'解鎖特殊指令「📣 呼喚夥伴」(戰鬥・⚡1)', eff:{}, sci:'夥伴聽到熟悉的呼喚聲會立刻放下戒心、全力照顧你,安心感能讓身體更快進入修復狀態。' },
    { id:'SK_CMD_7', g:'cmd', cmd:'CMD_RALLY',     n:'鼓舞號令', e:'⚡', req:['SK_CMD_L7'],                u:440, v:90, d:'解鎖特殊指令「⚡ 鼓舞號令」(戰鬥・⚡2)', eff:{}, sci:'一起喊口號會讓人動作更同步,這叫「節律同調」。' },
