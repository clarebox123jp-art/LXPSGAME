...
window.ISL_DB = (function(){
  ...
  D.STAT_MAX = 20;
  D.STAT_XP_NEED = 8;   /* 用進廢退:對應維度累積 8 次活動 → +1(上限 20) */
  ...
  D.ZONES = [
    { id:'beach',  n:'沙灘',  e:'🏖', order:1, unlock:{t:'start'},           unlockText:'起始',               map:{x:40,y:76}, p1:true },
    { id:'forest', n:'森林',  e:'🌲', order:2, unlock:{t:'bld', bld:'campfire'}, unlockText:'蓋好「營火」',   map:{x:52,y:52}, p1:true },
    { id:'grass',  n:'草原',  e:'🌾', order:3, unlock:{t:'explore', zone:'forest', pct:50}, unlockText:'森林探索 ≥50%', map:{x:70,y:60}, p1:true },   /* ★ P2 開放 */
    { id:'river',  n:'溪流',  e:'🏞', order:4, unlock:{t:'bld', bld:'bucket'}, unlockText:'蓋好「水桶架」',  map:{x:32,y:48}, p1:true },   /* ★ P2 開放 */
    { id:'rock',   n:'岩岸',  e:'🪨', order:5, unlock:{t:'bld', bld:'raft'},   unlockText:'蓋好「木筏」',    map:{x:14,y:66}, p1:true },   /* ★ P2 開放 */
    { id:'lake',   n:'湖泊',  e:'🏔', order:6, unlock:{t:'explore', zone:'river', pct:50}, unlockText:'溪流探索 ≥50%', map:{x:48,y:30}, p1:true },   /* ★ P3-a 開放 */
    { id:'cave',   n:'洞窟',  e:'🕳', order:7, unlock:{t:'tech', tech:'torch'}, unlockText:'研究科技「火把」',  map:{x:22,y:34}, p1:true },   /* ★ P3-a 開放 */
    { id:'cliff',  n:'懸崖',  e:'⛰', order:8, unlock:{t:'tech', tech:'pulley'}, unlockText:'研究科技「滑輪」', map:{x:82,y:38}, p1:true },   /* ★ P3-b 開放 */
    { id:'valley', n:'山谷',  e:'🌄', order:9, unlock:{t:'tech', tech:'wheel'}, unlockText:'研究科技「水車」',  map:{x:64,y:22}, p1:true },
    { id:'ruins',  n:'遺跡',  e:'🗿', order:10,unlock:{t:'tech', tech:'circuit'}, unlockText:'研究科技「電路」', map:{x:36,y:14}, p1:true },
    { id:'volcano',n:'火山',  e:'🌋', order:11,unlock:{t:'puzzle', zone:'ruins'}, unlockText:'解開遺跡機關', map:{x:78,y:12}, p1:true }
  ];
  ...
  D.SCENE.river = {
    ...
    spawn:{
      fish:  { n:3, minGap:3, act:'fish', node:'node_fish', e:'🐟', gives:'fish', label:'石𩼣魚群',
               pool:[{x:13,y:3},{x:15,y:4},{x:14,y:7},{x:15,y:9},{x:23,y:9},{x:26,y:10},{x:22,y:11},{x:28,y:12}] },
  ...
  D.SCENE.rock = {
    ...
    spawn:{
      ...
      trash: { n:5, minGap:2, act:'trash', node:'node_trash', e:'🛍', gives:'trash', label:'海廢堆',
               pool:[{x:3,y:13},{x:10,y:14},{x:14,y:13},{x:19,y:14},{x:22,y:13},{x:28,y:13},{x:6,y:14},{x:25,y:12},{x:12,y:12},{x:17,y:12}] },
  ...
  D.SCENE.lake = {
    ...
    spawn:{
      lakefish:{ n:3, minGap:3, act:'fish', node:'node_lakefish', e:'🐠', gives:'fish', label:'苦花魚', refract:true,
               pool:[{x:9,y:6},{x:22,y:6},{x:6,y:12},{x:26,y:12},{x:9,y:18},{x:22,y:18},{x:16,y:5},{x:16,y:19}] },
      lotus:  { n:3, minGap:2, act:'gather', node:'node_lotus', e:'🪷', gives:'seed', label:'台灣萍蓬草',
               pool:[{x:11,y:8},{x:21,y:8},{x:11,y:16},{x:21,y:16},{x:8,y:11},{x:24,y:13}] },
  ...
  D.SCENE.cave = {
    ...
    spawn:{
      ore:    { n:4, minGap:2, act:'quarry', node:'node_ore', e:'🟫', gives:'ore', label:'鐵礦脈',
               pool:[{x:6,y:4},{x:11,y:6},{x:20,y:3},{x:24,y:5},{x:15,y:9},{x:26,y:11},{x:5,y:14},{x:17,y:15},{x:27,y:16},{x:22,y:19}] },
