...
window.ISL_DB = (function(){
  ...
  D.PET_BOND_GAIN = { feed:4, battle:2, dayTogether:1, cap:999 };   /* ★ v1.167.0 稽核:feed 與 dayTogether 原本是死鍵,本輪補上消費點(圖鑑的「🍖 餵食」與每天同行 +1) */
