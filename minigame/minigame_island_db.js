...
window.ISL_DB = (function(){
  ...
  D.ISLAND_ADJ = ['翡翠','珊瑚','薄霧','椰風','琉璃','浪花','向陽','靜謐','潮汐','沙金','月光','風信','蜜柑','海風','星砂','潮聲','綠意','漣漪','日暮','晨曦'];
  D.ISLAND_NOUN = ['小島','灣岸','礁島','群島','沙洲','海角','秘境','漂流島','岬角','港灣','棲地','浮島','岸線','潟湖','秘灘','歸帆島','燈塔島','漁村島'];
