...
window.ISL_DB = (function(){
  ...
  var D = {};
  D.VER = 'v1.336.0';   /* ★ v1.336.0(2026-09-25)— 本檔實質異動:檔尾 D.MAKE_FEE / D.makeFee / D.makeTotal(製作貝幣單一真相)、阿獺商店全表依三原則重算(買材料=賣價×3、買成品≥自製成本×1.5)、D.decoPrice 下限、夥伴裝備價/賣價重算、D.LOG。對應 minigame_index.html v1.336.0。 */
