...
;
  ...
  D.LAYER_FRAME_ADJ = {
    hair_girl_h0: [[[0.6,0.2],[-1.2,-2.5],[0.1,1.1],[-0.7,-1.4],[1.0,1.2],[0.3,1.4]], [[0.1,-1.1],[-0.1,-1.2],[-0.2,-0.7],[-1.0,-0.8],[1.1,1.7],[0.1,2.1]], [[-0.2,1.1],[0.6,1.2],[0.1,-0.4],[-0.3,-2.1],[0.7,0.7],[-0.8,-0.5]]],
    hair_girl_h2: [[[1.8,0.5],[-0.6,0.2],[-0.3,0.2],[-1.3,-1.8],[2.0,0.2],[-1.7,0.6]], [[0.9,2.7],[2.2,-0.4],[0.1,-0.9],[-1.5,-0.8],[0.3,-1.1],[-2.1,0.5]], [[1.7,-1.1],[-0.9,2.2],[1.3,1.8],[0.0,-1.0],[1.2,-1.3],[-3.2,-0.6]]]
  };
  ...
  (function(){
    var L = [
      ...
      { k:'hornet', n:'虎頭蜂兵', e:'🐝', race:'insect', tag:'fly', tool:'smoke', zone:'森林',
        bt:{ hp:22, atk:9, def:1, spd:8, crit:15, drop:{ shell:[2,4], item:'honey', p:0.3 }, d:'成群巡邏的大黃蜂,尾針很毒。' },
