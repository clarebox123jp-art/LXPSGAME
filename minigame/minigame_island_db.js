...
window.ISL_DB = (function(){
  ...
  var D = {};
  D.VER = 'v1.352.0';   /* ★ v1.352.0(2026-09-26)— 本檔實質異動:老師「蜂蜜太難取得」⇒ 虎頭蜂兵掉蜂蜜 30%→50%、新增 D.HONEY_CHOP_P=0.25(伐木機率附帶蜂蜜);檔尾 D.LOG。 */
  void 'v1.351.0';   /* ★ v1.351.0(2026-09-26)— 本檔僅版號與 D.LOG(戰鬥暫停環境音在 index) */
  void 'v1.350.0';   /* ★ v1.350.0(2026-09-26)— 本檔僅版號與 D.LOG(營地長按/出口位置都在 index) */
  void 'v1.349.0';   /* ★ v1.349.0(2026-09-26)— 本檔實質異動:ACTS.gather.qualityHint 改寫(原文「果實會壓爛」,採葉子/花時不合);檔尾 D.LOG。 */
  void 'v1.348.0';   /* ★ v1.348.0(2026-09-26)— 本檔實質異動:D.PET_PIC_MUL.firefly 0.8→0.4(螢火蟲圖片縮小 50%);檔尾 D.LOG。 */
  ...
  void 'v1.335.0';   /* ★ v1.336.0 舊版號備查(原本是 D.VER 指派) */   /* ★ v1.335.0(2026-09-25)— 本檔實質異動:①天賦 4 節點補閃避/防禦效果(敏捷 dodgeMs、慢活節奏 dodgeGoodMs、強健 guardCutP、止血 guardHealP)②檔尾 D.COMFORT_RULE(舒適度上限 100、同種裝飾遞減)+ D.COMFORT_TIERS 覆寫 ③檔尾 D.BOSS_RULE.grd + D.BOSS_GRD(10 頭目大絕招・重壓技,HP 50%/20% 固定施放)④D.WIT_HINT(智取提示小視窗)⑤D.LOG。對應 minigame_index.html v1.335.0。 */
  /* ★ v1.334.0(2026-09-25)— 本檔實質異動:D.BOARD_PHRASES(20 句小語)/BOARD_PICK_MAX/MAIL_GIFT_MATS/MAIL_GIFT_MAT_MAX/MAIL_GIFT_ONE_MAX + D.LOG。對應 minigame_index.html v1.334.0。 */
  /* ★ v1.333.0(2026-09-25)— 本檔實質異動:D.DECOS +50(含小木屋 cabin)、D.DECO_PRICE/decoPrice/decoSell、D.DECO_TAB_OUT、D.CABIN、D.SHOP.daily、D.PET_GEAR_PRICE(賣出半價)、D.PET_GEAR_IMG(圖檔名修正)、蜂蜜小陶罐 eff 改 healP:30、D.NIGHT_GLOW.deco +4、D.LOG。 */   /* ★ v1.332.0(2026-09-25・老師「荒島已知BUG都修復」)— 本檔實質異動:D.CROPS 名稱/收成量撞鍵修正(n→harvest)、D.IMG 重複 ending_sail 鍵刪除(值相同零行為差異;本檔至此 ES5 嚴格解析零警告)、D.LOG 一筆。 */   /* ★ v1.331.0 */   /* ★ v1.331.0(2026-09-25・老師「根據企劃書完成新的寵物和寵物專用裝備」)— 本檔實質異動:D.PET_CMDS +3(cloudpounce/bluebite/scalepowder)、D.PETS +3 位 🌈 傳說夥伴(cloudleopard/bluering/swallowtail,legend:true、get.how:'legend')、D.PET_ORDER +3、D.PET_RECRUIT_LEGEND、檔尾新增 D.MON_ST(魔物中毒/混亂參數)/D.LEGEND(三條科學調查任務)/D.PET_GEAR(10 件夥伴裝備)/PET_GEAR_FLAT/PET_GEAR_CAP、D.SHOP.buy 台灣檫樹苗、D.CODEX +3、D.BT_FX 新招特效、D.LOG 一筆。 */   /* ★ v1.330.0(2026-09-24・老師「森林首次進入提示只顯示一次」)— 本檔資料零改動,只有版號同步;修法全在 index.html 端(改讀既有的 ISL.flags.forestTold 存檔旗標)。 */   /* ★ v1.329.0(2026-09-24・老師「荒島線上人數顯示在大地圖左上角」)— 本檔資料零改動,只有版號同步;新增的 #isl-map-online/islOnlineCountFetch/islOnlineCountPaint 全在 index.html 端,沿用既有 presences 心跳集合與 scene 欄位,沒有新增任何資料表。 */   /* ★ v1.328.0(2026-09-24・老師多項:煌翅/蝗翅護符逃跑率+30%/完美閃避判定太微小數值稽核調整/蝠后與深淵影魔地圖交換+數值互換/武器防具鑲嵌按鈕移到右上)— 本檔實質異動:acc_locust escAdd 15→30;acc_bat leechP 6→20+dodgeMs 40→500+zone lake→cave;acc_shadow zone cave→lake;D.AFFIX.feather dodgeMs 50→150;D.ARMOR_ROUTE.light 80→200/heavy -40→-100;acc_thunder dodgeMs 80→150;D.BOSSES batqueen/abyssshadow 兩隻 zone 與 lv/atk/spd/crit 整組互換+技能台詞場景敘述互換;D.CODEX 兩隻 where 欄位互換。UI 按鈕移位邏輯全在 index.html 端。 */   /* ★ v1.327.0(2026-09-24・老師兩項:戰鬥特殊指令面板浮動不推擠版面/大冠鷲石虎台灣藍鵲天賦技能修正)— 本檔實質異動:3 隻寵物的 tal 與對應 D.PET_CMDS 技能數值改寫(eagle critP 8→20;leopardcat lowHpAtkP 20→50+doubleclaw mul 0.75→1;bluemagpie perAllyAtkP→atkStackP:5/atkStackCapP:30+flockrush hits 3→4/mul 0.5→0.7/cd 2→4),其餘(特殊指令面板定位、islPetDmgMul、islBtPartyTalTick 疊加邏輯)全在 index.html 端。 */   /* ★ v1.326.0(2026-09-24・老師五項:傷害數字拋物線彈出/暴擊重擊音效/護盾淡藍色+不堆疊/飾品戴上鈕移到右上)— 本檔資料零改動,只有版號同步;全部邏輯與 CSS 都在 index.html 端(islBtFloat/mgBattleFloat/islDmgArc/.shieldup/6 處護盾 Math.max 不堆疊/islAccOpen 的 .tr-btn+.cb.tr)。 */   /* ★ v1.325.0(2026-09-24・老師兩項:治療型寵物自動施展技能智能行動/戰鬥受傷數字補上護盾與減傷%)— 本檔資料零改動,只有版號同步與 D.LOG 新增一筆;兩項邏輯全在 index.html 端(islBtIsHealCmd/islBtHealNeeded、islBtHurtUnit 的 _islHurtInfo 與 islBtHurtFloatText/islBtHurtFloat)。 */   /* ★ v1.324.0(2026-09-24・老師三項:天賦節點確認視窗維持星盤背景/多段攻擊傷害數字間隔0.3秒/野外小憩改全隊回滿+解狀態每天限一次)— D.SK_CMDS.CMD_REST 資料改寫:d 說明改為「全隊體力全滿、解除所有不利狀態(每天限用 1 次)」,新增 once:'day' 旗標;其餘天賦星盤確認彈窗與多段攻擊間隔邏輯全在 index.html 端(islSkPop/islBtAllyBasic/islBtPetCmd/islCmdDayUsed/islCmdDayMark)。D.LOG 新增 v1.324.0。 */   /* ★ v1.323.0(2026-09-24・老師「把所有提升屬性可以做的事情都寫完整」「腳程改跟跑步、逃亡有關」)— D.STATS 每維新增 how[] 練法清單;D.MOV_TRAIN 新增;ACTS/SKILLS 的 fish→dex、tame/ranch→wit;D.LOG 新增 v1.323.0。 */   /* ★ v1.322.0(2026-09-24・老師「許多 iPad 學生在大地圖點沙灘進不去,但可以進營地」)— 本檔資料零改動,只有版號同步與 D.LOG 新增一筆;根治(傳送點進場即被彈回大地圖)全在 index.html 端 islEnterZone/islNearCheck。本包以 v1.321.0(寵物平衡)三檔為基底疊加。 */   /* ★ v1.321.0(2026-09-24・老師六項寵物天賦/技能平衡修正)— ①領角鴞天賦改 blindOnHitP:40(攻擊時40%使目標失明,命中-50%,1回合);②櫻花鉤吻鮭天賦改 atkHealLowP:15(普攻順便治隊上血量最低者)+downHealAllP:60(自己倒下時全隊回60%HP,可復活倒下夥伴),技能 clearstream 改 healAll:40+regenAll:10(立即40%+3回合每回合10%);③五色鳥天賦改 basicHits:2(普攻2次)+cdCutOnHit:1(受傷時技能冷卻-1),技能 drumecho 改 skillSeal+dmgDownP:30(敵方全體1回合不能放技能且傷害-30%);④莫氏樹蛙天賦 rainHealP 25→100,並新增超額治療轉護盾(regenOverflowShield);⑤梅花鹿技能 reviveherb 改 healRevive:80(治療兼復活合一);⑥櫻花鉤吻鮭、五色鳥商店解鎖價格 180/160→500。12 個新/改效果鍵(blindOnHitP/atkHealLowP/downHealAllP/basicHits/cdCutOnHit/skillSeal/dmgDownP/healRevive/regenOverflowShield)的消費點全在 index.html。 */   /* ★ v1.320.0(2026-09-23・老師「我沒看到馴獸的星盤節點」)— 內容與 v1.318.0 完全相同,只換版號:v1.317.0/v1.318.0 的本檔從未上傳到 GitHub(線上一直是 v1.316.0),index 的 ?v= 同步換成 v1.320.0 讓已經快取到舊內容的平板改抓新網址。 */   /* ★ v1.318.0(2026-09-23・老師三項)— ①螢火蟲圖片不符自然科學 → 本輪只交付重生圖片提示詞,檔名沿用不變;②新增 D.PET_PIC_MUL 寵物圖片顯示倍率(梅花鹿 1.2、石虎/海鷗小白 0.9、莫氏樹蛙/螢火蟲 0.8),index 端 islPetPicMul 讀取;③D.PET_CMDS.dewmist(莫氏樹蛙 露水迷霧)regenAll 6→15,dur 3、cd 4 維持,d 說明同步;D.LOG 新增一筆。 */   /* ★ v1.317.0(2026-09-23・老師「荒島的天賦星盤新增馴獸專精路線,主要提升所有寵物各項能力和技能強化」)— D.SK_GALAXY 新增第 9 條星域 beast(🐾 馴獸專精,ang:-90);D.SK_NODES 129→145:中央新核心「馴獸之心」(pr:300,pa:-90,免前置)+ 馴獸星域 15 顆(獸力/心有靈犀/獸體/馴獸基本功/🔀猛獸本能 vs 守護本能/狂野連擊/療癒羈絆/🌟羈絆守護/萬獸共鳴/👑萬獸之王 mat:boss_tusk×2);D.SK_TITLES 新增 T_BEAST「馴獸大師」;D.LOG 新增一筆。12 個新效果鍵(petHpP/petAtkP/petDefP/petSpdP/petCdCut/petGaugeP/petGaugeStart/petCritC/petCutP/petGuts/petSkDmgP/petSkSupP)的消費點全在 index.html。Node vm 全配對距離驗證:145 顆節點全域最短仍是既有的 79.8px(SK_CORE_HP↔SK_MED_PHM_L1),新節點彼此與鄰居最近 95px;id 無重複、req/reqAny 零懸空。 */   /* ★ v1.316.0(2026-09-23・老師「跑步側面角色要往影子貼近,尺寸再縮小25%」)— 本檔零改動,側面(row2)跑步新增的 _rjSide2(縮小25%)與 _rjShiftY(貼近陰影的向下位移,用 Node+sharp 逐圖實測 footY 算出)全在 index.html 端 islRjPaint(),這裡僅版號同步。 */   /* ★ v1.315.1(2026-09-23・老師「跑步腳底貼齊水平地平線」)— 本檔零改動,縮放錨點改用逐圖實測 footY 的邏輯全在 index.html 端(islFullRunCenter/islRjPaint),這裡僅版號同步。 */   /* ★ v1.315.0(2026-09-23・老師「奔跑的側面人物還是會忽大忽小,重新將八張側面跑步循環圖的角色尺寸高度調整成和正面一樣的高度」)— 本檔零改動,新增的 islFullRunHScale() 逐格身高校正邏輯全在 index.html 端,這裡僅版號同步。 */   /* ★ v1.314.1(2026-09-22・老師修正 v1.314.0 的 AP 上限加成倍率,本檔零改動,AP 公式與說明文字全在 index.html 端(`×5`→`×1`),這裡僅版號同步。 */   /* ★ v1.314.0(2026-09-22・老師在「🎨 造型工房(GM)」再調一次後貼回聊天室的「📋 複製設定值」輸出)— D.LAYER_ADJ 全表覆蓋,詳見上方該區塊註解(本輪重點:cloth_boy/girl_c1~c3 六款服裝首次補上真正調校過的方向專屬值;hair_boy_h2、hair_girl_h0、hair_girl_h2 三個髮型重調)。本輪隨附的 index.html 有五項改動(存入倉庫選單圖示文字選取模式再縮小/戰鬥中補顯示冒險等級/戰鬥指令按鈕再縮小避免換行/跑步圖側面再放大25%正面背面再放大10%/檢查八髮型戰鬥立繪裁切),與本檔 D.LAYER_ADJ 資料表異動各自獨立,詳見 index 端 changelog。 */   /* ★ v1.307.0(2026-09-22・老師「星盤的節點距離太近都疊在一起了,修正」)— 天賦星盤節點重疊根治,分兩層原因:①v1.300.0 為 59 段既有連結逐段插入中點填充節點時,把安全間距(原本約 90px)直接砍半到 ~45px(小於節點直徑 64px),全面重疊;本輪 D.SK_CANVAS 由 1640×1640/中心 820,820 放大為 3280×3280/中心 1640,1640,D.SK_NODES 全部 129 顆節點的 u/v(直角偏移)與 pr(極座標半徑,pa 角度不動)一律 ×2,把所有既有連結的間距等比例放大回 ~90px 安全值(129 顆節點跑完全配對最短距離模擬,確認全數 ≥64px 節點直徑不重疊)。②額外查出一個 v1.300.0 之前就存在、與這次疊圖無關的獨立座標巧合:「醫療/藥理」「特殊指令」「生活技藝」三條星域的固定角度(D.SK_GALAXY 的 ang:22.5°／67.5°／-112.5°)剛好各自等於「強健」「幸運」「敏捷」三顆中央核心節點的角度(pa),三條星域各自的第一顆節點(SK_MED_PHM_L1／SK_CMD_L1／SK_LIFE_L1,v:0)因此精確落在同一條射線上,原始半徑幾乎相同(230),三對節點幾乎完全疊在同一點(SK_CORE_HP↔SK_MED_PHM_L1、SK_CORE_SPD↔SK_LIFE_L1 距離 0,SK_CORE_LUCK↔SK_CMD_L1 僅 30px),×2 縮放並不會解決同一射線上的重疊,故另外把三顆核心節點半徑 pr 由 230→300(pa 角度不動),三條星域對應第一顆節點的 u 值改為 380(cmd 因原本間距較大改為 410),把三對節點在同一射線上的間距拉開到 70~130px、全數清出安全距離;三顆核心節點原本各自的兩個既有連結節點(SK_MED_BND_L1/CK_L1 offset v:±90 → ×2 為 v:±180)與下一段既有節點(u:460 起跳)完全不動,前置關係(req)與所有其餘節點座標一律未變。收尾以程式重新載入整份資料跑「129 顆節點兩兩配對」全配對最短距離模擬驗證:全域最短距離 79.8px(SK_CORE_HP↔SK_MED_PHM_L1),≥64px 節點直徑安全,且與既有星盤其餘路段 90px 上下的既定安全間距同一量級;129 顆節點座標邊界 448~2832px,在新 3280×3280 畫布內四邊各留有餘裕。⚠ 本輪僅資料表座標/半徑數值異動,節點連線關係(req/reqAny)、效果(eff)、名稱、描述文字全部不動;沒有實機 iPad/瀏覽器畫面可供這裡直接截圖比對,以上是跑完整座標模擬算出的數學驗證,建議老師實機打開「🌟 天賦星域」面板目視覆核一次。對應 minigame_index.html v1.307.0、minigame_sw.js SHELL 同步(index/sw 本身邏輯與 CSS 零改動,只有版號與 island_db 版本查詢字串同步以破快取)。 */   /* ★ v1.300.0(2026-09-21・老師「天賦星盤在既有節點與節點中間新增對應能力的新節點(最大HP/攻擊/防禦/速度/暴擊率/跑速/治療量/異常狀態抵抗+格擋率),四捨五入計入玩家素質,依各路線專精分配,每種能力最多20個節點(+20%)」＋追加「格擋率改成閃避減傷」＋「『更多說明』視窗中心新增目前點亮節點的狀態收益清單與已解鎖特殊指令清單」)— D.SK_NODES 70→129 節點:59 段既有連結(五條武器星域各 7 段×5=35、生活技藝 5 段、醫療三支線[止血/藥理/料理]各 4 段=12、特殊指令 7 段)逐段插入一顆對應能力節點,u/v 座標取原連結兩端中點(核心→第一顆節點的一端視為 u:0/v:0),原子節點的 req 改指向新節點、新節點的 req 指向原本的父節點,鏈路長度變長但前置關係與既有節點座標/星域配置全部不動。分配(依路線專精,9 種能力・每種節點數皆 ≤20 上限):🏹弓=暴擊率(critC)7 顆、🪵棍斧=攻擊(atkP)7 顆、🔨錘=最大體力(hpMaxP)7 顆、🔱長槍=防禦(defP)7 顆、🪃迴力鏢=速度(spdP)7 顆、🧺生活技藝=跑速(moveP)5 顆、🩹止血(醫療)=治療量(healP)4 顆、🍀藥理(醫療)=異常狀態抵抗(ailResP,新效果鍵)4 顆、🍲料理(醫療)=最大體力(hpMaxP)4 顆、🎯特殊指令=閃避減傷(dodgeCutP,新效果鍵,取代老師原提議的「格擋率」——本遊戲戰鬥系統沒有被動格擋機制,只有 QTE 計時的完美閃避)7 顆。加總各能力節點數(含原本就有效果的既有節點):atkP 8/critC 12/hpMaxP 12/defP 7/spdP 8/moveP 6/healP 4/ailResP 4/dodgeCutP 7,全數 ≤20。新節點命名依深度用羅馬數字 Ⅰ~Ⅴ(分歧處兩支各自延續同一階數字),不掛 wp(不限武器,跟既有 life/med 節點同口徑,只有本來就有 wp 的原節點維持限定);全數不帶 dep 欄位,不影響既有醫療三支線互通(SK_MED_LINK)的既有捷徑判定。⚠ 邏輯端(ailResP 併入 islAilRollZone/islAilDaily 的機率折扣公式共 3 處、dodgeCutP 併入 islBtDodgeApply 的「閃過一半」傷害再折算)與「更多說明」視窗新增 islSkBonusHtml() 兩個區塊(逐一讀目前已點亮節點的 d/cmd 效果文字組出清單,不另建第二份資料)全在 index.html 端,這裡僅資料表異動。 */   /* ★ v1.299.0(2026-09-21・老師「讓所有BOSS的HP提高至5倍」+ 隨 index 好友戰鬥造型/指令按鈕文字/長按說明泡泡三項)— D.BOSSES 10 隻地圖頭目的 hp 全部 80→400(×5);D.MON_BT 是靠 island_db 檔尾迴圈自動從 D.BOSSES 同步(D.MON_BT[b.k]={hp:b.hp,...}),改這裡的來源數字就會自動帶進實際戰鬥的 hpMax 計算(islMonMake 的 b.hp),不必再改任何 index.html 端的倍率邏輯。⚠ 範圍只動 10 隻現役地圖頭目;D.DUNGEON.boss 裡的舊版「守墓石像」(hp:80,地下層目前 D.DUNGEON.open=false 停用中)與 D.BOSSES_HIDDEN.guardian(hp:140,新版最強頭目,老師裁定尚未接線)兩個都是還沒上場的資料,這輪刻意不動,等老師要開放時再一併確認數值。其餘三項(好友戰鬥造型讀取/指令按鈕文字/長按說明泡泡)全在 index.html 端,這裡僅版號同步。 */   /* ★ v1.298.0(2026-09-21・老師回報「營地點擊設施、裝飾、右方選單,主角會自己往左上角移動到底」)— 本檔零改動,真因與修法全在 index.html 端 islLongTapBind()(缺守門的全域 mouseup 監聽讓主角/寵物長按開窗共用出口誤觸移動到座標 (0,0)),這裡僅版號同步。 */   /* ★ v1.297.0(2026-09-21・老師「天賦星盤『呼喚夥伴』效果改成完全恢復1名隊友的HP,名稱和說明也修正」)— D.SK_CMDS.CMD_CALL 的 d 從「20% 最大體力」改「完全恢復體力」,sci 一併改寫成呼應治療效果的說法;天賦節點 SK_CMD_6 的 d 同步改文字,並順手修正「(野外+戰鬥・⚡1)」的錯誤標示(CMD_CALL 自 v1.165.0 起就已經是戰鬥限定)。實際治療數值(20→100)在 index.html 端 islCmdUse 的 CMD_CALL 分支。 */   /* ★ v1.296.0(2026-09-21・老師「營地點設施走位改回長按走過去再開視窗」+「戰鬥圖片複查撤回誤判」)— 本檔零改動,兩項都在 index.html 端,這裡僅版號同步。 */   /* ★ v1.295.0(2026-09-21・老師「探險編組寵物休息中要改睡覺圖」)— 本檔零改動,休息中的寵物睡覺姿態(bt_pet_<key>_sleep,v1.257.0 就已登記+上傳好)改由 islPartyOpen/islPartyPick 呼叫 islPetPicHtml 時傳 pose:'sleep',邏輯全在 index.html 端,這裡僅版號同步。 */   /* ★ v1.294.0(2026-09-21・老師「生火QTE的吹改成搧風」+「各種行動要有2~3種反應台詞」)— D.MONO.lines/pri 新增 13 種活動 star3Xxx/critXxx 共 26 把鍵(採集/伐木/採石/捕魚/打撈/馴養/烹飪/播種/製作/研究/水道/生火/建造各 2~3 句),取代原本不分活動類型的通用 star3/crit(通用版保留當備援)。islQteBlow 的搧風文案全在 index.html 端。 */   /* ★ v1.293.0(2026-09-21・老師看圖「戰場急救」天賦彈窗只有空話沒有效果說明)— 本檔零改動,islSkTap() 補上 D.SK_CMDS 效果說明的邏輯全在 index.html 端,這裡僅版號同步。 */   /* ★ v1.292.0(2026-09-21・老師在「🎨 造型工房(GM)」再調一次後貼回「📋 複製設定值」)— D.LAYER_ADJ 全表覆蓋,詳見上方註解;D.CREATE_DEFAULT 這次貼回的值與上一版逐字相同,未變動。 */   /* ★ v1.291.0(2026-09-21・老師「確認跑步8張循環的圖有沒有實機問題」)— 本檔零改動,islFullRunCenter() 的 dy 置中誤判根治全在 index.html 端,這裡僅版號同步。 */   /* ★ v1.290.0(2026-09-21・老師「繼續」— 接續 v1.289.0 交接:把新增的效果鍵真正寫進節點資料)— D.SK_NODES 9 個效果鍵正式接上對應節點的 eff 欄位(依上一包交接的建議清單):SK_CORE_HP+defHpAdd1、SK_CORE_SPD+exploreP10、SK_LIFE_2+defSlowP15、SK_LIFE_3+buildFastP10/defWoodAdd1、SK_LIFE_4+defBiteCutP30、SK_LIFE_5+exploreP10、SK_LIFE_6+buildFastP15/costCutP15、SK_MED_BND_1+defBiteCutP25、SK_MED_CK_2+costCutP10;節點座標/前置關係/路線與總數一律未動,只加效果鍵與同步改寫 d 描述文字。 */   /* ★ v1.289.0(2026-09-21・老師「跑步8張循環/天賦新效果鍵」)— 本檔零改動,ISL_RUN_SKIP/islFullRunSeq/islFullRunCenter/islBuildSecs/islConsume/islDefStart/islDefBite/islExploreGain 全在 index.html 端,這裡僅版號同步。 */   /* ★ v1.288.0(2026-09-21・老師「洞穴這個位置過不去左邊,請重新檢驗所有地圖可移動區域和不可移動區域的合理性」)— 11 區可走遮罩全面重建,實際資料寫在**本檔檔尾的覆寫區**(那裡有完整的根因與做法說明);上方 v1.152.0 的舊遮罩刻意完整保留備查、不刪。資源點/解謎點/訓練師座標本輪一個都沒改,改由 index 端新增的 islSnapCell() 執行期自動吸附到最近可走格。 */   /* ★ v1.276.0 — 本檔實質異動只有 D.LOG 新增一筆(移動方式優化/存檔誤報修正/大地圖圖示放大);程式邏輯與 CSS 全在 index.html。 */   /* ★ v1.275.0 — 本檔實質異動三張新表:①D.NIGHT(夜間門檻 apUsedPct=0.5,index 的 islIsNight() 唯一讀這個值)②D.MON_NIGHT(夜行性魔物 8 隻:夜蝠/影魔/鼴鼠土匪/水蛭精/霧沼蛙/盲眼穴蛛/鍬形蟲騎士/古代遊魂;白天不抽、夜間才加碼出現,已逐區驗算白天每區仍有 2~4 種可抽)③D.NIGHT_GLOW(夜間發光物件,分 bld/deco/pet/node 四類);④D.LOG 新增一筆。程式邏輯與 CSS 全在 index.html。 */   /* ★ v1.274.0 — 本檔零改動(D.LOG 新增一筆);寵物打盹/休息確認/跑步音效邏輯全在 index.html。 */   /* ★ v1.273.0 — 本檔實質異動:①D.IMG 新登記 11 區夜晚場景圖鍵 zone_<區>_night(全部選配,圖檔 island_zone_<區>_night.jpg 尚未生成/上傳,沒圖不影響任何畫面;程式端 islZoneBgKey 在島上有時間系統前不會主動取用,先把鍵登記好讓完整下載清單與需求表口徑一致)②D.LOG 新增一筆(物品包/倉庫勾選方塊改右上角+顯示戰鬥效果)。 */   /* ★ v1.267.0 — 本檔實質異動只有 D.LOG 新增一筆(手機橫式版面救援);CSS 全在 index 端。 */   /* ★ v1.266.0 — 本檔實質異動只有 D.LOG 新增一筆(版號對版管道被 SW 2.5 秒逾時鍘掉的根治 + iPad 重整後被共用裝置守門誤登出成訪客的根治);程式邏輯全在 index 與 sw 端。 */   /* ★ v1.265.0 — 本檔實質異動只有 D.LOG 新增一筆(設施名稱點了才顯示且不隨縮放/側欄五顆兩裝置統一貼右緣圖示填滿);程式邏輯與 CSS 全在 index 端。 */   /* ★ v1.264.0 — 本檔實質異動只有 D.LOG 新增一筆(子選單疊圖根治／營地顯示倍率下限／設施名稱);程式邏輯與 CSS 全在 index 端。 */   /* ★ v1.263.0 — 本檔實質異動只有 D.LOG 新增一筆(攻擊 BAR 速度綁更新率的根治 + 戰術/自動兩顆鈕改同一排);程式邏輯全在 index 端。 */   /* ★ v1.262.0 — 本檔實質異動只有 D.LOG 新增一筆(營地走不動的迴圈根治 + iPad 頂部欄位 ☰ 收合);程式邏輯全在 index 端。 */   /* ★ v1.261.0 — 新增 D.BT_ITEM_CATS/D.BT_ITEMS(戰鬥道具欄:材料可吃/可丟)、D.LOG 一筆;程式邏輯在 index */   /* ★ v1.260.0 — 僅 D.LOG 新增一筆(戰術/自動手動鈕移到左下角);程式邏輯全在 index。 */   /* ★ v1.259.0 — 本檔實質異動只有 D.LOG 新增一筆(音樂音效卡頓根治/暴擊字亮色/營地主角尺寸/設施 U 型陰影/子選單加寬/好友鈕深色字);程式邏輯全在 index+sw 端。 */   /* ★ v1.258.0 — 本檔實質異動只有 D.LOG 新增一筆(QTE 精緻化/寵物技能計量表+自動手動/訪客模式登入引導);程式邏輯全在 index 端。 */   /* ★ v1.257.0(2026-09-18・老師回報「營地寵物走路/睡覺沒生效,圖片連結有誤嗎」,老師已上傳 32 張圖後複查)— 老師這次上傳的截圖顯示實際檔名是 island_pet_<key>_walk/sleep.png,比資料表原本登記的 island_bt_pet_<key>_walk/sleep.png 少了 bt_ 這一段;逐一 HTTP 查證,舊登記 32 張全 404、改成登記老師實際上傳的檔名後 32 張全部 200。只改 D.IMG 對應的檔名字串,鍵名(bt_pet_<key>_walk/_sleep)與 index 端所有消費點都不必動,一行修好全部 16 隻夥伴。 */   /* ★ v1.253.0(2026-09-18・老師「海灘上的貝殼每天要重生在海灘」)— 稽核 11 區的每日資源生成(spawn 專屬節點 vs pick 隨機小物池)後發現:貝殼(shell)全島只有「岩岸」(rock)有專屬的每日貝殼堆(spawn.shell,保證每天重生);沙灘(beach)跟湖泊(lake)的貝殼都只混在 pick 那個 4~6 件的隨機池子裡,跟其他 7~4 種東西搶同一個機率(權重只有 1/8~1/4),很多天整片沙灘可能一顆貝殼都沒有——這不是程式壞掉,是設計上「每種材料只有一個主產地、其他地方只是隨緣加碼」,但沙灘是最早開放的區域,學生一開局就需要貝殼(路燈裝飾要 1 顆、造好釣竿要 2 顆),讓最早的區域反而抽不到不合理。本輪新增沙灘專屬 spawn.shell(比照岩岸同一種寫法,每天固定重生最多 2 處貝殼堆,座標選在退潮沙地與海水交界處),pick 池子裡原本的 shell 保留不拿掉、純屬額外加碼。⚠ 稽核範圍內沒有發現其他「明明該天天重生卻沒有重生」的程式性 bug——islDailyFor()/islSpawnDaily() 這套每日重置機制本身是每區、每種資源一致套用的,湖泊(lake)目前是唯一還跟沙灘同樣狀況(貝殼只在 pick 池、沒有專屬節點)的區域,是否也要加專屬節點,請老師裁定。 */   /* ★ v1.246.0 — 本檔零改動,第六章敬請期待閘門(ISL_CH6_OPEN)全在 index 端,僅版號同步 */   /* ★ v1.245.0 — 主線新增第六~八章(時間倒轉之貝/r5 r6 兩次重大抉擇/場景變體圖鍵/四件抉擇裝飾/timeshell 物品)、第四章拿掉地下層目標、D.DUNGEON.open=false、D.BOSSES_HIDDEN.guardian 最強頭目資料(未接線) */   /* ★ v1.244.0 — 本檔僅 D.LOG 新增一筆與版號同步(營地方向盤/好友連結系統/造型工房開放/結算鈕位置全在 index 端) */   /* ★ v1.243.0 — 老師「寵物技能修正」:穿山甲/綠蠵龜/椰子蟹三隻坦克型天賦重寫(固定減傷 40~60%,綠蠵龜新增每回合自癒 15%)、梅花鹿天賦改「每回合解 1 不利狀態+全隊回 8%」、螢火蟲/鮭魚兩招治療技能倍率大幅提升並拉長冷卻補償、攻擊型與控場型技能冷卻微調做出差異化定位 */   /* ★ v1.242.0 — 海鷗小白技能改「海風祝禱」(敵方命中−25%+全隊回復20%)、魔物攻擊成長 0.23→0.16、16 隻寵物 HP/防禦成長 +12%、懸崖移除野豬並下修雷精攻擊 */   /* ★ v1.241.0 — 髮型逐格定位表全面重算(對齊第 1 格)、森林~懸崖新手難度重排、海鷗小白改治療型、台灣黑熊改仇恨坦 */ void 'v1.240.0';   /* ★ v1.240.0 — 戰鬥圖檔名對齊 island_battle_*、新增 D.BT_FX 特效表 */ void 'v1.239.0';   /* ★ v1.239.0 — 本檔本輪無資料異動(頭目一覽改版/營地奔跑卡速修正/寵物數值放大三項都在 index 端),僅隨 index/sw 版號同步;D.LOG 新增一筆。 */   /* ★ v1.234.0(2026-09-17・老師「重排主線劇情/教學/NPC 對白/劇情分支、20 種新魔物、材料重新規劃」)— 檔尾新增一大段覆寫:D.MAINLINE 6 章主線、D.ROUTES 4 組分支、D.SPEAKERS、D.MON_RACES/MON_RACE_OF、20 種 wild 魔物(MONSTERS/MON_BT/MON_SKILL/MON_TAG_OF/CODEX)、DEF_TOOLS +4、新素材 chitin/silk/gel/ash、各配方 cost 重排、分支專屬裝飾 8 件、D.LOG 一筆。 */   /* ★ v1.233.0(2026-09-17・老師「全髮型動作圖快生完(含選做戰鬥),你先繼續」)— 本檔實質異動:D.IMG 預先登記 8 髮型 × 3 種整張完整人物動作圖圖鍵 run_<body>_h<n>(768×384,6 欄×3 方向)、jump_<body>_h<n>(512×384,4 欄×3 方向)、bt_<body>_h<n>(512×1024,4 欄×8 動作,側面朝右);D.LOG 新增一筆。對應 index v1.233.0、sw v1.233.0(SHELL v1.199.0)。 */   /* ★ v1.232.0(2026-09-17・跑跳改完整人物圖只換頭、脖子對齊)— 本檔僅 D.LOG 更新與版號同步。對應 index v1.232.0、sw v1.232.0(SHELL v1.198.0)。 */   /* ★ v1.231.0(2026-09-17・老師「主角跑和跳的圖片套用」)— 本檔實質異動:D.IMG 登記 run_sheet_boy/girl、jump_sheet_boy/girl 四個圖鍵(island_run_sheet_<body>.png 4 欄×3 列、island_jump_sheet_<body>.png 3 欄×3 列,頭與上半身已去背);D.LOG 新增一筆。對應 index v1.231.0、sw v1.231.0(SHELL v1.197.0)。 */   /* ★ v1.230.0(2026-09-17・老師「繼續我說要做但還沒做的內容,例如營地寵物走路和睡覺圖片」)— 本檔實質異動:①D.IMG 登記 16 位夥伴 × walk/sleep 共 32 個選配圖鍵 bt_pet_<key>_walk/_sleep(上傳同名檔即自動換圖,不必改程式;沒上傳時 index 端用程式動畫做走路/睡覺姿態)②D.CODEX_CATS 新增「👑 地圖頭目」、D.CODEX 新增 10 隻頭目條目(id 與 D.BOSSES[].k 相同,打倒頭目時既有的 islCodexAdd(m.k) 自動收錄)③D.LOG 新增一筆。對應 index v1.230.0、sw v1.230.0(SHELL v1.196.0)。 */   /* ★ v1.229.0(2026-09-17・戰鬥系統優化 B5:天賦星盤重整)— 本檔實質異動:D.SK_CANVAS 1640×1640 放射狀 8 條星域(D.SK_GALAXY 帶 ang);D.SK_NODES 49→70 節點:五條武器星域各 8 節點(專屬機制→基本功→分歧二選一 grp→分歧延伸→關鍵主動技 reqAny→精通 mst+mat 頭目素材),新增生活技藝星域 6 節點(sweetP/qteSlowP/chopAdd/quarryAdd/fishAdd/actSecP/hurtCutP/craftStar 從武器星域搬過來),清掉 SK_CORE_HP/ATK/SPD 重複寫兩次的效果鍵;節點改 u/v 或 pr/pa 座標,載入時換算 x/y;D.SK_ACTS 補 focusUse/brk/brace/spread。對應 index v1.229.0、sw v1.229.0(SHELL v1.195.0)。 */   /* ★ v1.228.0(2026-09-17・戰鬥系統優化 B4:裝備)— 本檔實質異動:新增 D.WP_TYPES/D.MON_TAGS/D.TYPE_MUL/D.MON_TAG_OF/D.WP_INFO(武器類型與固有特性)、D.SOCKET/D.AFFIX(8 種詞條)、D.ARMOR_ROUTE/D.RES_TYPES/D.ARMOR_EXT(防具三路線與抗性)、兩件新輕甲 glidevest/stormcloak、D.ACCS(10 件頭目飾品)、D.BT_SWAP;D.BT.MON_LV_HP 0.08→0.05、MON_LV_ATK 0.13→0.23;D.BOSS_RULE 新增 lvHp/lvAtk。對應 index v1.228.0、sw v1.228.0(SHELL v1.194.0)。 */   /* ★ v1.227.0(2026-09-17・老師「繼續」— 戰鬥系統優化 B3:十隻地圖頭目)— 本檔實質異動:新增 D.BOSSES(10 區頭目:數值/弱點工具/剋制武器/兩招技能/第二(三)階段/必殺技+掩護題)、D.BOSS_RULE(巢穴解鎖探索度、挑戰 AP、重生天數、韌性、隊伍 HP 縮放、獎勵、★2/★3)、D.bossByZone/D.bossByKey、10 種頭目核心素材物品、頭目 MON_BT 條目、bt_m_<頭目>_<6 態>/poi_lair_<區>/res_boss_ 系列、ui_boss 圖鍵。戰鬥流程在 index 端。對應 index v1.227.0、sw v1.227.0(SHELL v1.193.0)。 */   /* ★ v1.226.0(2026-09-17・老師「繼續。完美隔擋改成完美閃避」— 戰鬥系統優化 B2)— 本檔實質異動:新增 D.MON_SKILL(9 種魔物專屬技能+預告文字+應對提示)、D.BT.DODGE(完美閃避 QTE 判定時間)/WIT_CD(智取冷卻)/TACTICS(夥伴戰術三種)/COMBO(連攜攻擊)/METAL_ARMORS(導電鐵甲)、D.ELITE 詞綴新增「分裂」。戰鬥流程在 index 端。對應 index v1.226.0、sw v1.226.0(SHELL v1.192.0)。 */   /* ★ v1.225.0(2026-09-17・老師「照設計全部實作」— 戰鬥系統優化 B1:數值引擎)— 本檔實質異動:D.BT 魔物成長改 HP+12%/攻+10%/防+0.35/速+0.06 每級、隊伍縮放改 HP/攻倍率(ENC_LV_PER_ALLY 歸 0)、比例傷害常數 DMG_K、力氣攻擊/巧手暴擊係數;新增 D.ADV(冒險等級)、D.ELITE(精英怪)、4 種核心素材物品;D.ENC 區域等級重排(森林 3~7 … 火山 38~45);武器基礎攻擊與成長曲線、防具防禦重排(配合比例公式)、坦克型寵物 HP/防禦成長調整。對應 index v1.225.0、sw v1.225.0(SHELL v1.191.0)。 */   /* ★ v1.224.0(2026-09-17・老師「選單按鈕ICON改成圖為主字為輔」)— 本檔零改動,三組選單按鈕的 HTML 結構與 CSS 全在 index 端(islCampPaint/islSubOpen 與對應樣式),這裡僅同步版號。對應 index v1.224.0、sw v1.224.0(SHELL v1.190.0)。 */   /* ★ v1.223.0(2026-09-17・老師「重新計算戰鬥難度」)— 本檔實質異動:D.PARTY.TANK_COVER_P/TANK_CUT_P 下修、黑熊天賦 coverAddP 下修、D.BT.MON_LV_HP/MON_LV_ATK 微調、新增 D.BT.ENC_LV_PER_ALLY/ENC_EXTRA_MON_ALLY2/HP_LVUP_FLAT/PET_HP_LVUP_FLAT 四個常數、治療型三招(dewmist/glowlight/clearstream)回復量與冷卻調整;戰鬥引擎與 HP 複利改固定值的邏輯在 index 端(islHpLevelBonus/islPetLevelHpBonus/islBattleStart)。對應 index v1.223.0、sw v1.223.0(SHELL v1.189.0)。 */   /* ★ v1.222.0(2026-09-17・老師「烤魚改成某種容易取得可以生吃的果實」)— 本檔實質異動:berry(野果)由 cat:'food' 改 cat:'dish' 並補 eat:{hp:15,ap:0},比照既有 honey(蜂蜜)先例使其可直接生吃;贈送時機邏輯在 index 端 islPrologue()。對應 index v1.222.0、sw v1.222.0(SHELL v1.188.0)。 */   /* ★ v1.221.0(2026-09-17)— 本檔零改動(新增的「開局帶3個烤魚」是存檔預設值,寫在 index 端 islDefaultSave 裡,烤魚 d_fish 本來就已在 D.ITEMS/D.RECIPES 登記過,不必新增資料),僅版號同步。對應 index v1.221.0、sw v1.221.0(SHELL v1.187.0)。 */   /* ★ v1.220.0(2026-09-16・老師「字體改用冒險模式的圓體字+天賦星盤/戰鬥介面優化」)— 本檔零改動,字體堆疊順序/星盤與戰鬥介面漸層全在 index 端,這裡僅同步版號。對應 index v1.220.0、sw v1.220.0(SHELL v1.186.0)。 */
  ...
  D.IMG = {
    ...
    /* ending_sail 已在上方登記(同一張 island_ending_sail.jpg,大地圖外圍海面底圖也共用它;★ v1.332.0 刪掉這裡重複的同名鍵,值完全相同、零行為差異) */
  ...
  D.LAYER_ADJ = {
    /* ★ v1.292.0(2026-09-21・老師在「🎨 造型工房(GM)」再調一次後貼回聊天室的「📋 複製設定值」輸出)——
       全表覆蓋為這次微調過的值。本輪實際變動:①hair_boy_h2 正面/背面/側面三個方向專屬值全部重調
       ②hair_girl_h0 的 sx 從 1.240 微調成 1.190,並且**首次**補上正面/背面/側面三個方向專屬覆寫(舊表
       hair_girl_h0 只有共用值,沒有 @0/@1/@2)③hair_girl_h2 正面/背面/側面三個方向專屬值全部重調
       ④新增 bt_boy_h0/bt_boy_h1 兩把戰鬥立繪專屬微調鍵(舊表完全沒有 bt_ 開頭的鍵,這是戰鬥立繪
       隨分層造型即時換裝這項未完工事項的第一批資料,目前只做了少年 h0/h1 兩種髮型,h2/h3 與少女
       四種髮型都還沒有,套用時沒表可查會直接退回 sx:1,sy:1,dx:0,dy:0 不位移,不影響顯示)
       ⑤匯出格式這次連同 cloth_boy_c1~c3、cloth_girl_c1~c3 一起吐出來(GM 造型工房的匯出鈕看起來是
       固定跑 4 個服裝格,不管 D.CLOTHES 實際登記幾款),但這 6 把鍵的值全部是預設 {1,1,0,0}(沒有真的
       調過),而且 D.CLOTHES 目前只登記 c0(運動服,v1.184.0 老師裁定拿掉其餘三款),這幾把鍵不會被
       islLyAdj 查到、純粹是匯出格式帶出來的多餘資料,先照實寫入不影響任何顯示,之後老師若要恢復
       其他服裝款式,這裡已經先有(尚未調校過的)預設值可用。
       其餘沒被提到的鍵(hair_boy_h0/h1/h3、hair_girl_h1/h3、cloth_boy_c0、cloth_girl_c0)這次貼回來
       的值與上一版逐字比對完全相同,維持不動。 */
    cloth_boy_c0: { sx:1.000, sy:1.000, dx:0, dy:0 },
    cloth_boy_c1: { sx:0.730, sy:0.730, dx:-0.5, dy:0 },
    /* 正面 專屬 */ 'cloth_boy_c1@0': { sx:0.720, sy:0.720, dx:0, dy:0 },
    /* 側面 專屬 */ 'cloth_boy_c1@2': { dx:1 },
    cloth_boy_c2: { sx:1.000, sy:1.000, dx:0, dy:0 },
    /* 正面 專屬 */ 'cloth_boy_c2@0': { sx:0.760, sy:0.760 },
    /* 背面 專屬 */ 'cloth_boy_c2@1': { sx:0.760, sy:0.760 },
    /* 側面 專屬 */ 'cloth_boy_c2@2': { sx:0.780, sy:0.780 },
    cloth_boy_c3: { sx:1.000, sy:1.000, dx:0, dy:0 },
    /* 正面 專屬 */ 'cloth_boy_c3@0': { sx:0.660, sy:0.660 },
    /* 背面 專屬 */ 'cloth_boy_c3@1': { sx:0.650, sy:0.650 },
    /* 側面 專屬 */ 'cloth_boy_c3@2': { sx:0.600, sy:0.600 },
    ...
    bt_boy_h0: { sx:1.000, sy:1.080, dx:0, dy:0 },
    bt_boy_h1: { sx:1.000, sy:1.000, dx:0, dy:2 },
    cloth_girl_c0: { sx:1.000, sy:1.000, dx:0, dy:0 },
    /* 側面 專屬 */ 'cloth_girl_c0@2': { sy:1.000, dy:0 },
    cloth_girl_c1: { sx:1.000, sy:1.000, dx:0, dy:0 },
    /* 正面 專屬 */ 'cloth_girl_c1@0': { sx:0.800, sy:0.800 },
    /* 背面 專屬 */ 'cloth_girl_c1@1': { sx:0.800, sy:0.800 },
    /* 側面 專屬 */ 'cloth_girl_c1@2': { sx:0.800, sy:0.800 },
    cloth_girl_c2: { sx:1.000, sy:1.000, dx:0, dy:0 },
    /* 正面 專屬 */ 'cloth_girl_c2@0': { sx:0.800, sy:0.800 },
    /* 背面 專屬 */ 'cloth_girl_c2@1': { sx:0.800, sy:0.800 },
    /* 側面 專屬 */ 'cloth_girl_c2@2': { sx:0.800, sy:0.800, dx:-0.5 },
    cloth_girl_c3: { sx:1.000, sy:1.000, dx:0, dy:0 },
    /* 正面 專屬 */ 'cloth_girl_c3@0': { sx:0.660, sy:0.660 },
    /* 背面 專屬 */ 'cloth_girl_c3@1': { sx:0.660, sy:0.660 },
    /* 側面 專屬 */ 'cloth_girl_c3@2': { sx:0.650, sy:0.650, dx:0.5 },
    hair_girl_h0: { sx:1.390, sy:1.320, dx:0, dy:1.5 },
    /* 正面 專屬 */ 'hair_girl_h0@0': { sx:1.490, sy:1.720, dx:0.5, dy:23 },
    /* 背面 專屬 */ 'hair_girl_h0@1': { sx:1.490, sy:1.770, dx:0, dy:25.5 },
    /* 側面 專屬 */ 'hair_girl_h0@2': { sx:1.720, sy:1.750, dx:-2.5, dy:30.5 },
    ...
    /* 正面 專屬 */ 'hair_girl_h2@0': { sx:1.140, sy:1.200, dy:2.5 },
    /* 背面 專屬 */ 'hair_girl_h2@1': { sx:1.200, sy:1.240, dx:0.5, dy:-2.5 },
    /* 側面 專屬 */ 'hair_girl_h2@2': { sx:1.300, sy:1.210, dx:2.5, dy:-1 },
...
;   /* ★ v1.314.0(2026-09-22・老師在「🎨 造型工房(GM)」再調一次後貼回聊天室的「📋 複製設定值」輸出)——
       全表覆蓋為這次微調過的值,依老師原始貼上內容逐字寫入,未自行更動任何數字。本輪實際變動:
       ①cloth_boy_c1/c2/c3、cloth_girl_c1/c2/c3 六款服裝從上一版的預設值(1,1,0,0,尚未調過)
       全部補上真正調校過的縮放/位移值(c1~c3 這幾款服裝目前雖未在 D.CLOTHES 開放,但工房本身可以
       單獨預覽微調,老師這次一次把六款都調好貼回來,先照實寫入卡位,之後開放對應服裝時直接生效);
       ②hair_boy_h2 正面/背面/側面三個方向專屬值全部重調;③hair_girl_h0 基準值與三個方向專屬值
       全部重調;④hair_girl_h2 正面/背面/側面三個方向專屬值全部重調。其餘沒被提到的鍵(hair_boy_h0/
       h1/h3、hair_girl_h1/h3、cloth_boy_c0、cloth_girl_c0、bt_boy_h0/h1)這次貼回來的值與上一版
       逐字比對完全相同,維持不動。 */
  ...
  D.STATS = [
    /* ★ v1.323.0 老師「把所有提升屬性可以做的事情都寫完整」— 每一維新增 how[](能力頁點開說明時逐條列出「怎麼練」),
       內容必須跟 index 實際呼叫 islStatGain / 教練上課的地方一一對應(改練法時兩邊要一起改)。
       老師「提升腳程用捕魚和馴養非常不合理,修正成跟跑步、逃亡有關的行動」— 捕魚改練巧手、馴養改練巧思,
       腳程改由 D.MOV_TRAIN 三種行動練(野外奔跑距離/戰鬥逃跑/完美閃避)。 */
    { k:'dex', n:'巧手', e:'🖐', d:'拖曳類活動品質、甜蜜點寬度',
      how:[ '🌿採集、🔨建造(蓋好才算)、♻打撈海廢、🌱播種、🛠製作工具、🎣捕魚:每做完一次 +1 次練習', '🌾 營地農田收成:每收一次 +1 次練習', '🦀 陸蟹教練(岩岸):每週上一次課,3 題答對 2 題以上直接 +1' ] },
    { k:'mov', n:'腳程', e:'👣', d:'走路/奔跑速度、戰鬥逃跑成功率、完美閃避判定時間、夜襲每波多幾秒、限時活動時間',
      how:[ '🏃 在野外「雙擊奔跑」:每跑一段路 +1 次練習(每天最多 8 次)', '💨 戰鬥中按「逃跑」:逃掉了 +2 次練習、沒逃掉也 +1', '✨ 戰鬥中完美閃避魔物攻擊:+1 次練習(每場最多 2 次)', '🦌 梅花鹿教練(草原):每週上一次課,3 題答對 2 題以上直接 +1' ] },
    { k:'pow', n:'力氣', e:'💪', d:'敲打／採礦／伐木單擊量',
      how:[ '🪓伐木、⛏採石:每做完一次 +1 次練習', '⚔ 野外戰鬥打贏:每場 +1 次練習', '🐻 台灣黑熊師傅(森林):每週上一次課,3 題答對 2 題以上直接 +1' ] },
    { k:'wit', n:'巧思', e:'🧠', d:'拼圖／研究正確率、知識題提示',
      how:[ '🔥生火、🍳烹飪、💧鋪水道(鋪好才算)、🔬科技研究(成功才算)、🐾馴養:每做完一次 +1 次練習', '🌙 夜襲防衛結束:+1 次練習', '🧩 區域解謎機關解開:+2 次練習', '🕳 地下層打倒魔物或答對題目:+1 次練習', '🧠 戰鬥「智取」選對工具、頭目題答對:各 +1 次練習', '🦉 領角鴞博士(溪流):每週上一次課,3 題答對 2 題以上直接 +1' ] }
  ];
  D.MOV_TRAIN = { RUN_PX: 4000, RUN_DAY_MAX: 8, ESC_OK: 2, ESC_FAIL: 1, DODGE: 1, DODGE_PER_BT: 2 };   /* ★ v1.323.0 腳程練法:野外奔跑每累積 RUN_PX 像素(基礎跑速約 300px/秒 ⇒ 約 13 秒)+1 次練習、每天上限 RUN_DAY_MAX 次;逃跑成功/失敗;完美閃避每場上限 */
  D.STYLES = [
  ...
  D.MONO = {
    ...
    pri: {               /* 優先權:數字大的可以打斷正在顯示的低優先泡泡 */
      ...
      /* ★ v1.294.0 各活動專屬的 star3/crit 反應台詞,優先權比照原本的通用 star3/crit(=3),見下方 lines 的同名鍵 */
      star3Gather:3, star3Chop:3, star3Quarry:3, star3Fish:3, star3Trash:3, star3Tame:3, star3Cook:3, star3Plant:3, star3Craft:3, star3Research:3, star3Canal:3, star3Fire:3, star3Build:3,
      critGather:3, critChop:3, critQuarry:3, critFish:3, critTrash:3, critTame:3, critCook:3, critPlant:3, critCraft:3, critResearch:3, critCanal:3, critFire:3, critBuild:3
    },
    lines: {
      /* ── 每天 / 天氣 ── */
      ...
      /* ── 採集與活動(通用備援,活動類型找不到專屬台詞時才會用到) ── */
      actStart:  ['好,專心。', '仔細看清楚再動手。', '老師說過:先觀察,再想辦法。'],
      crit:      ['剛剛那一下抓得剛剛好!', '找到施力的角度了!', '就是這個力道!'],
      star3:     ['這個品質超好!小心不要弄壞。', '哇,這是我做過最漂亮的一次。', '狀態完美!今天運氣不錯。'],
      actFail:   ['失敗了……再來一次。', '力氣用錯地方了。下次換個方式。', '沒關係,失敗也是在學。'],
      pick:      ['這個好像用得到,先收起來。', '撿到東西了!', '島上什麼都不能浪費。'],
      /* ── ★ v1.294.0 老師回報「生完火主角說『這個品質超好,小心不要弄壞』很奇怪」— 根因是 star3/crit 兩句內心話
         原本不分活動類型,通用文字帶著「採集/手拿東西」的語感(小心弄壞、我採過最漂亮的),套到生火/建造/研究這種
         不是拿在手上的活動就顯得答非所問。改成 13 種活動(採集/伐木/採石/捕魚/打撈/馴養/烹飪/播種/製作/研究/
         水道/生火/建造)各自 2~3 句專屬反應,islActResult 呼叫時改用 islMonoActKey('star3'/'crit', A.id) 先找
         專屬台詞、找不到才退回上面的通用版(理論上 13 種活動全部涵蓋,通用版變成純保險)。 */
      star3Gather:  ['這批品質超好,挑得真準!', '眼光不錯,選對地方了。', '這個大小剛剛好,可以收工了。'],
      critGather:   ['剛剛那一下抓得剛剛好!', '找到訣竅了,一次就對!'],
      star3Chop:    ['木紋很直,劈得又快又整齊!', '這塊木頭品質真好,以後就認這個記號。'],
      critChop:     ['順著紋路劈,一刀就斷!', '這一下用對力道了!'],
      star3Quarry:  ['石頭敲得又平整又漂亮!', '這塊石材看起來很堅固。'],
      critQuarry:   ['找到石頭的弱點,一敲就開!', '這一下敲得剛剛好!'],
      star3Fish:    ['釣到的這條真肥美!', '收線的時機抓得剛剛好。'],
      critFish:     ['魚一咬餌就立刻中鉤!', '收竿的瞬間抓得剛剛好!'],
      star3Trash:   ['撈到的東西保存得很完整!', '這趟打撈收穫不錯。'],
      critTrash:    ['一撈就撈到重點,運氣真好!', '這一下打撈得剛剛好!'],
      star3Tame:    ['牠好像很喜歡我,願意跟我回營地!', '牠一點都不怕我,親近得很自然。'],
      critTame:     ['牠一下子就放鬆下來了!', '靠近的時機抓得剛剛好!'],
      star3Cook:    ['火候抓得剛剛好,聞起來好香!', '這道料理做得很成功!'],
      critCook:     ['調味的時機抓得剛剛好!', '這一下火候抓得剛剛好!'],
      star3Plant:   ['種子種得又深又穩,應該會長得很好。', '土壤翻得剛剛好,種子有足夠的空間。'],
      critPlant:    ['找到最適合的位置種下去了!', '這一鏟翻得剛剛好!'],
      star3Craft:   ['零件組裝得又緊又牢固,做工真精細!', '這件做得很扎實,拿起來很順手。'],
      critCraft:    ['組裝的力道抓得剛剛好!', '這一敲敲得剛剛好!'],
      star3Research:['原理想通了,線路接得又快又準!', '這次研究進行得很順利。'],
      critResearch: ['靈光一閃,馬上就接通了!', '這個接點接得剛剛好!'],
      star3Canal:   ['水道挖得又直又深,水流一定很順暢。', '這段水道做得很扎實。'],
      critCanal:    ['一鏟就挖到最適合的深度!', '這一下挖得剛剛好!'],
      star3Fire:    ['火生得又快又穩,今晚不怕冷了!', '搧風的力道抓得剛剛好,火苗很旺!', '這把火生得真漂亮,能撐一整晚。'],
      critFire:     ['火種一下子就點著了!', '搧風的時機抓得剛剛好!'],
      star3Build:   ['地基打得又穩又牢固,蓋起來一定很堅固!', '這次施工做得很扎實。'],
      critBuild:    ['榫接的位置抓得剛剛好!', '這一下釘得剛剛好!'],
      /* ── 營地 / 建造 / 成長 ── */
  ...
  D.ACTS = {
    gather: { n:'採集', e:'🌿', skill:'gather', stat:'dex', ap:1, sec:30, bgm:'bgm-play',
              qualityName:'輕輕摘', qualityHint:'長按拉扯,在黃區放手!太用力會把採到的東西扯壞。'   /* ★ v1.349.0 原文「果實會壓爛」,採到葉子/花時對不上 */ },
    ...
    /* ★ P2-a */
    fish:   { n:'捕魚',     e:'🎣', skill:'fish',   stat:'dex', ap:1,   /* ★ v1.323.0 老師「捕魚練腳程不合理」mov→dex(抓浮標時機靠手巧) */ sec:30, bgm:'bgm-play',
  ...
  D.SKILLS.fish   = { n:'捕魚', e:'🎣', stat:'dex', lv3:'浮標下沉窗口變長', lv5:'魚影提示', lv7:'折射位置畫虛線' };
  ...
  D.ACTS.tame  = { n:'馴養',   e:'🐾', skill:'ranch', stat:'wit', ap:2,   /* ★ v1.323.0 老師「馴養練腳程不合理」mov→wit(分類動物習性靠巧思) */ sec:30, bgm:'bgm-play',
  ...
  D.SKILLS.ranch = { n:'畜牧', e:'🐾', stat:'wit', lv3:'分類提示',       lv5:'靠近黃區更寬',   lv7:'畜欄產量 +1' };
  ...
  /* 種植:作物(seed 種下 → days 天成熟;每天要澆水或有水道;harvest=基礎收成)
     ★ v1.332.0 修正:舊版名稱與收成量共用同一個鍵 n(n:'野果' 後面又寫 n:3),物件字面值後者蓋前者,
       所有顯示作物名稱的地方(種下提示/收成吐司/農田詳情/圖鑑取得方式)都顯示成「3」。收成量改名 harvest,消費點 index 收成與播種選單同步。 */
  D.CROPS = {
    berry: { n:'野果', e:'🍓', gives:'berry', days:3, harvest:3, stages:['🌱','🌿','🌳'] },
    grain: { n:'小米', e:'🌾', gives:'grain', days:4, harvest:3, stages:['🌱','🌿','🌾'] }
  };
  ...
  D.MAIL_QTY_MAX = 20;
  D.MAIL_NOTE_MAX = 40;
  /* ★ v1.334.0(2026-09-25・老師「留言板改成 20 種讚美與心情小語,選三句,不讓玩家輸入文字;每天最多留言一次(甲=全部對象合計一次,
     含寫自己的板);留言可按 + 附禮:可採集材料一次最多 5 個、可製作裝備 1 件、可製作料理 1 份」)
     BOARD_PHRASES:索引即編號,信件 text 只存「P:3,7,12」,收件端照本表顯示 ⇒ 繞過介面硬塞的文字也顯示不出來。
     ⚠ 只能在尾端新增、不可改順序或刪除(舊信件/舊板子存的是編號)。每句 ≤12 字,三句加兩個全形空白 ≤38 字 < 40(板子上限)。
     MAIL_GIFT_MATS:可採集材料白名單(不含海廢、魔物/頭目掉落、稀有素材)。料理白名單 = D.RECIPES 的 id(執行期推導,不重寫一份)。
     可製作裝備 = 🐾 夥伴裝備(沒戴在夥伴身上的);武器/防具不開放(每人每種只一把、存檔用位置索引、帶升級等級,送出去會讓裝備錯位)。 */
  D.BOARD_PHRASES = [
    '你的營地好漂亮!', '你好厲害喔!', '謝謝你的幫忙!', '一起加油吧!', '今天好開心!',
    '有你真好～', '你是最棒的夥伴!', '下次一起去探險!', '你的夥伴好可愛!', '做得太好了!',
    '辛苦了,休息一下吧', '早安,今天也要努力!', '晚安,做個好夢～', '好想你喔!', '你好會蓋房子!',
    '一起守護小島!', '今天有點累……', '我們是好朋友!', '加油,你一定可以!', '祝你天天快樂!'
  ];
  D.BOARD_PICK_MAX = 3;
  D.MAIL_GIFT_MATS = ['wood', 'stone', 'fiber', 'leaf', 'reed', 'ore', 'herb', 'water', 'pebble', 'feather', 'seed', 'shell',
                      'mushroom', 'fish', 'egg', 'milk', 'grain', 'berry', 'honey'];
  D.MAIL_GIFT_MAT_MAX = 5;    /* 材料一次最多 5 個 */
  D.MAIL_GIFT_ONE_MAX = 1;    /* 料理 / 夥伴裝備一次 1 */
  D.FRIEND_MAX = 5;
  ...
  D.BOSSES = [
    ...
    { zone:'grass', k:'locustking', n:'飛蝗之王', e:'🦗', lv:13, hp:400, atk:26, def:4, spd:9, crit:10, tool:'torch', weakWp:['bow','boomerang'], weakPets:['gull','owl','bluemagpie','eagle','spoonbill','barbet'], core:'boss_locustwing',
    ...
    { zone:'river', k:'mudking', n:'洪流泥王', e:'🌊', lv:17, hp:400, atk:29, def:4, spd:6, crit:10, tool:'salt', weakWp:['stoneaxe','spear'], core:'boss_mudheart',
    ...
    { zone:'rock', k:'crabking', n:'巨螯椰子蟹王', e:'🦀', lv:20, hp:400, atk:31, def:4, spd:5, crit:10, tool:'fist', weakWp:['hammer','club'], core:'boss_clawshell',
    ...
    { zone:'cave', k:'batqueen', n:'霧湖蝠后', e:'🦇', lv:28, hp:400, atk:36, def:4, spd:8, crit:15, tool:'gong', weakWp:['bow','spear'], core:'boss_batfeather',   /* ★ v1.328.0 老師「蝠后出現在湖邊很奇怪,改成洞穴中,深淵影魔改成湖泊,雙方等級能力值隨地圖交換調整」— zone 與深淵影魔互換(lake↔cave 在區域難度序列裡剛好相鄰,直接互換兩者原本的 lv/atk/spd/crit 整組數值,不必重新演算;hp/def 兩隻本來就一樣不必動),原本鎖定「湖面/湖泊」的技能演出台詞同步跟著換到深淵影魔那邊,見下方 ult/skills tele 與 CODEX where。 */
      ...
      ult:{ n:'回聲風暴', e:'🌀', every:5, cd:2, mul:2.2, cover:0.2, tele:'洞穴迴盪起一圈圈回音,聲波越來越強……',
    ...
    { zone:'lake', k:'abyssshadow', n:'深淵影魔', e:'👤', lv:24, hp:400, atk:34, def:4, spd:9, crit:12, tool:'torch', weakWp:['boomerang','bow'], core:'boss_shadowgem',
      hint:'🔦 光沿直線前進,照得到的地方影子就會消失;迴力鏢和弓箭能打到躲在暗處的牠。',
      skills:[ { t:'blind', n:'熄燈', e:'🌑', p:40, cd:3, dur:2, mul:0.4, tele:'湖面的光一點一點被吸走……', hint:'全隊 2 回合攻擊有 40% 落空;🔦 智取可以取消。' },
               { t:'summon', n:'影分身', e:'👥', p:40, cd:3, k:'shadow', cnt:2, tele:'影子從水面浮起,變成好幾個……', hint:'會叫出 2 隻影魔。' } ],
      p2:{ atkMul:1.2, summon:'shadow', text:'深淵影魔的身影忽大忽小,四周越來越暗!' },
      ult:{ n:'深淵吞噬', e:'🕳', every:5, cd:2, mul:2.2, cover:0.2, tele:'整片湖面暗到伸手不見五指……',
    ...
    { zone:'cliff', k:'thunderbird', n:'雷鳴怪鳥', e:'⚡', lv:32, hp:400, atk:38, def:4, spd:9, crit:12, tool:'glove', weakWp:['bow','spear'], core:'boss_thunderplume',
    ...
    { zone:'valley', k:'magmabeetle', n:'熔甲蟲王', e:'🔥', lv:36, hp:400, atk:41, def:4, spd:5, crit:10, tool:'water', weakWp:['hammer','club'], core:'boss_magmashell',
    ...
    { zone:'ruins', k:'gorgonqueen', n:'石化蛇后', e:'🐍', lv:42, hp:400, atk:43, def:4, spd:7, crit:15, tool:'mirror', weakWp:['stoneaxe','spear'], core:'boss_gorgonscale',
    ...
    { zone:'volcano', k:'lavacolossus', n:'熔岩巨像', e:'🌋', lv:48, hp:400, atk:46, def:4, spd:4, crit:10, tool:'water', weakWp:['hammer'], core:'boss_lavaheart',
  ...
  D.CODEX.push(
    ...
    { id:'batqueen',     cat:'boss', n:'霧湖蝠后',     e:'🦇', img:'bt_m_batqueen_idle',     where:'洞窟巢穴', d:'蝙蝠是唯一真正會飛的哺乳類,翅膀其實是長長的手指撐開的皮膜;很多蝙蝠吃蚊子等害蟲,是人類的好幫手。' },
    { id:'abyssshadow',  cat:'boss', n:'深淵影魔',     e:'👤', img:'bt_m_abyssshadow_idle',  where:'湖泊巢穴', d:'光沿直線前進,被不透光的東西擋住就形成影子;光源越靠近物體,影子就越大。' },
  ...
  D.AFFIX = [
    ...
    { k:'feather',  n:'輕羽',     e:'🪶', eff:{ spdAdd:3, dodgeMs:150 },  cost:{ herb_essence:2 }, boss:['boss_locustwing','boss_batfeather','boss_thunderplume'], d:'速度 +3,完美閃避判定時間 +0.15 秒。', sci:'東西越輕,同樣的力氣就能揮得越快(質量小、加速度大)。' },   /* ★ v1.328.0 老師「完美閃避判定+0.04秒太沒效果,檢查還有哪些這種太微小的數值一起合理調整」— 稽核全部 dodgeMs 來源後發現:完美閃避判定基礎時間是 320~650ms(D.BT.DODGE),舊版這些裝備加成只有 40~80ms(≈基礎值的 6~13%),幾乎感覺不到差異。本輪把「詞條/防具路線/頭目飾品」這三種次要來源一起等比例拉高到有感的量級(50→150、80→200、-40→-100、80→150),蝠后耳墜(acc_bat)則照老師指定直接給 500(這格是頭目飾品裡唯一的「主打」完美閃避效果,拉開跟其他次要來源的差距是刻意的)。 */
  ...
  D.ARMOR_ROUTE = {
    light: { n:'輕甲', e:'🪶', dodgeMs:200, d:'穿起來輕快:完美閃避判定時間 +0.2 秒。' },
    mid:   { n:'中甲', e:'⚖', resAll:10, d:'攻守平衡:所有抗性 +10%。' },
    heavy: { n:'重甲', e:'🪨', counterMul:0.6, dodgeMs:-100, d:'又硬又重:完美閃避後一定順勢反擊(60% 傷害),但判定時間 −0.1 秒。' }
  };
  ...
  D.ACCS = [
    ...
    { id:'acc_locust',  zone:'grass',   n:'蝗翅護符', e:'🪽', eff:{ spdAdd:3, escAdd:30 },                    d:'速度 +3、逃跑成功率 +30%。' },   /* ★ v1.328.0 老師「煌翅護符(蝗翅護符)逃跑成功率改成+30%」15→30 */
    ...
    { id:'acc_bat',     zone:'cave',    n:'蝠后耳墜', e:'🦇', eff:{ leechP:20, dodgeMs:500 },                  d:'普攻吸血 20%、完美閃避判定 +0.5 秒。' },   /* ★ v1.328.0 老師「蝠后耳墜普攻吸血改成20%」6→20;「完美閃避判定+0.04秒太沒效果,改成+0.5秒」dodgeMs 40→500;zone 隨頭目蝠后一起從 lake 換成 cave(見 D.BOSSES 蝠后/深淵影魔地圖交換說明) */
    { id:'acc_shadow',  zone:'lake',    n:'影晶戒',   e:'🔮', eff:{ critC:8, noMiss:1 },                      d:'暴擊率 +8%、不會因隱身或熄燈落空。' },   /* ★ v1.328.0 zone 隨頭目深淵影魔一起從 cave 換成 lake */
    { id:'acc_thunder', zone:'cliff',   n:'雷羽髮飾', e:'⚡', eff:{ dodgeMs:150, res:{ thunder:40 } },       d:'完美閃避判定 +0.15 秒、雷抗性 +40%。' },   /* ★ v1.328.0 dodgeMs 80→150,同一輪稽核調整 */
   ...
   * ══════════════════════════════════════════════════════════════════════════ */
  D.SK_CANVAS = { w:3280, h:3280, cx:1640, cy:1640 };   /* ★ v1.229.0 B5:星圖改放射狀 8 條星域(每條沿 ang 角度往外長),畫布放大 */
  D.SK_GALAXY = [
    ...
    { k:'beast',     n:'馴獸專精星域',   e:'🐾', c:'#e0b07a', ang:-90 }       /* ★ v1.317.0 老師「天賦星盤新增馴獸專精路線,主要提升所有寵物各項能力和技能強化」— 第 9 條星域,插在 弓箭(-67.5)與 生活技藝(-112.5)正中間的 -90 度(正上方)。這兩條鄰居在內圈只有 v:±124 寬,-90 度這條縫本來就空著;本星域節點 v 一律壓在 ±70 以內,Node 全配對距離驗證最短不低於既有全域最短 79.8px。 */
  ];
  ...
  D.SK_NODES = [
    ...
    { id:'SK_BOW_L1', g:'bow', req:['SK_CORE_ATK'], u:170, v:0, n:'銳眼Ⅰ', e:'🎯', d:'暴擊率 +1%', eff:{ critC:1 } },
    { id:'SK_CLUB_L1', g:'club', req:['SK_CORE_ATK'], u:170, v:0, n:'怪力Ⅰ', e:'💪', d:'物理攻擊 +1%', eff:{ atkP:1 } },
    { id:'SK_HAMMER_L1', g:'hammer', req:['SK_CORE_ATK'], u:170, v:0, n:'壯健Ⅰ', e:'💗', d:'最大體力 +1%', eff:{ hpMaxP:1 } },
    { id:'SK_SPEAR_L1', g:'spear', req:['SK_CORE_ATK'], u:170, v:0, n:'堅守Ⅰ', e:'🛡', d:'防禦 +1%', eff:{ defP:1 } },
    { id:'SK_BOOMERANG_L1', g:'boomerang', req:['SK_CORE_ATK'], u:170, v:0, n:'靈動Ⅰ', e:'🌀', d:'行動速度 +1%', eff:{ spdP:1 } },
    { id:'SK_CORE_HP',   g:'core', n:'強健', e:'💪', req:[], pr:300, pa:22.5,   d:'最大體力 +10%;每日 ⚡AP +1;夜襲營火血量 +1;🛡 防禦時受到的傷害再 −15%', eff:{ hpMaxP:10, apAdd:1, defHpAdd:1, guardCutP:15 } },
    { id:'SK_MED_BND_L1', g:'med', req:['SK_CORE_HP'], u:380, v:-180, n:'藥效Ⅰ', e:'💚', d:'治療/解毒效果 +1%', eff:{ healP:1 } },
    { id:'SK_MED_CK_L1', g:'med', req:['SK_CORE_HP'], u:380, v:180, n:'飽足Ⅰ', e:'🍚', d:'最大體力 +1%', eff:{ hpMaxP:1 } },
    { id:'SK_CORE_LUCK', g:'core', n:'幸運', e:'🍀', req:[], pr:300, pa:67.5,   d:'稀有掉落率 +5%;野生動物馴養成功率 +10%、寵物親密度提升效率 +10%', eff:{ luckP:5, tameP:10, bondGainP:10 } },
    { id:'SK_MED_PHM_L1', g:'med', req:['SK_CORE_LUCK'], u:380, v:0, n:'強身Ⅰ', e:'🧿', d:'島上不良狀態發生機率再減免 +1%', eff:{ ailResP:1 } },
    { id:'SK_CMD_L1', g:'cmd', req:['SK_CORE_LUCK'], u:410, v:0, n:'警覺Ⅰ', e:'🥋', d:'閃避時額外減傷 +1%', eff:{ dodgeCutP:1 } },
    { id:'SK_CORE_SPD',  g:'core', n:'敏捷', e:'💨', req:[], pr:300, pa:-112.5, d:'行動速度 +5%;島上走路速度 +12%;探索度增加 +10%;💨 完美閃避判定 +0.1 秒', eff:{ spdP:5, moveP:12, exploreP:10, dodgeMs:100 } },
    { id:'SK_LIFE_L1', g:'life', req:['SK_CORE_SPD'], u:380, v:0, n:'健步Ⅰ', e:'👟', d:'島上走路速度 +1%', eff:{ moveP:1 } },
    /* ── 🏹 弓箭星域:🎯 專注層 ── */
    { id:'SK_BOW_1', g:'bow', wp:['bow'], n:'專注呼吸', e:'🎯', req:['SK_BOW_L1'], u:340, v:0, d:'命中時累積「🎯專注」1 層(上限 3):每層暴擊率 +4%、傷害 +3%;整回合落空專注就散掉', eff:{ focusOn:1 }, sci:'拉弓前先穩住呼吸,手才不會晃——專注靠的是身體放鬆,不是用力。' },
    { id:'SK_BOW_L2', g:'bow', req:['SK_BOW_1'], u:434.5, v:0, n:'銳眼Ⅱ', e:'🎯', d:'暴擊率 +1%', eff:{ critC:1 } },
    { id:'SK_BOW_2', g:'bow', wp:['bow'], n:'基本功', e:'🎯', req:['SK_BOW_L2'], u:530, v:0, d:'暴擊率 +5%、傷害 +5%', eff:{ critC:5, dmgP:5 } },
    { id:'SK_BOW_L3A', g:'bow', req:['SK_BOW_2'], u:624.5, v:-62, n:'銳眼Ⅲ', e:'🎯', d:'暴擊率 +1%', eff:{ critC:1 } },
    { id:'SK_BOW_L3B', g:'bow', req:['SK_BOW_2'], u:624.5, v:62, n:'銳眼Ⅲ', e:'🎯', d:'暴擊率 +1%', eff:{ critC:1 } },
    { id:'SK_BOW_F1A', g:'bow', wp:['bow'], grp:'bow_f', n:'屏息凝神', e:'🌬', req:['SK_BOW_L3A'], u:720, v:-124, d:'【分歧・二選一】專注上限 +2(最多 5 層),每層暴擊率再 +2%', eff:{ focusMax:2, focusCrit:2 } },
    { id:'SK_BOW_L4A', g:'bow', req:['SK_BOW_F1A'], u:814.5, v:-124, n:'銳眼Ⅳ', e:'🎯', d:'暴擊率 +1%', eff:{ critC:1 } },
    { id:'SK_BOW_F1B', g:'bow', wp:['bow'], grp:'bow_f', n:'快手連發', e:'⚡', req:['SK_BOW_L3B'], u:720, v:124, d:'【分歧・二選一】命中後 12% 機率不消耗這個回合;落空時專注只掉 1 層', eff:{ freeP:12, focusKeep:1 } },
    { id:'SK_BOW_L4B', g:'bow', req:['SK_BOW_F1B'], u:814.5, v:124, n:'銳眼Ⅳ', e:'🎯', d:'暴擊率 +1%', eff:{ critC:1 } },
    { id:'SK_BOW_F2A', g:'bow', wp:['bow'], n:'一擊必殺', e:'💥', req:['SK_BOW_L4A'], u:910, v:-124, d:'專注滿層時,下一箭命中必定暴擊、暴擊傷害再 +30%,射完專注歸零', eff:{ focusBurst:1 } },
    { id:'SK_BOW_F2B', g:'bow', wp:['bow'], n:'箭雨', e:'🌧', req:['SK_BOW_L4B'], u:910, v:124, d:'普通攻擊後 30% 機率多射一箭,打另一隻魔物(50% 傷害、必中)', eff:{ arrowP:30 } },
    { id:'SK_BOW_KEY', g:'bow', wp:['bow'], key:true, act:'bow_volley', n:'連射', e:'🌟', reqAny:['SK_BOW_F2A','SK_BOW_F2B'], u:1100, v:0, d:'★關鍵節點:解鎖絕招「連射」;專注每 1 層讓連射傷害 +10%(用掉全部專注)' },
    { id:'SK_BOW_L5', g:'bow', req:['SK_BOW_KEY'], u:1194.5, v:0, n:'銳眼Ⅴ', e:'🎯', d:'暴擊率 +1%', eff:{ critC:1 } },
    { id:'SK_BOW_M', g:'bow', wp:['bow'], mst:true, n:'鷹眼', e:'👑', req:['SK_BOW_L5'], mat:{ boss_batfeather:2 }, u:1290, v:0, d:'【精通】絕招每場可以用 2 次;開戰就有 1 層專注。需要頭目素材 🪶蝠后之羽 ×2(洗點後再點不必重付)', eff:{ actAdd:1, focusStart:1 }, sci:'老鷹的眼睛能看清幾百公尺外的小動物,因為牠視網膜上的感光細胞特別密。' },
    /* ── 🪵 棍棒石斧星域:🪓 破甲層 ── */
    { id:'SK_CLUB_1', g:'club', wp:['club','stoneaxe'], n:'破甲打擊', e:'🪓', req:['SK_CLUB_L1'], u:340, v:0, d:'攻擊命中時,讓目標疊 1 層「🪓破甲」(上限 3):每層防禦 −6%;破甲留在那隻魔物身上,換目標也不會消失', eff:{ brkOn:1 }, sci:'一直敲同一個地方,硬殼上的小裂縫會越來越大——這就是「疲勞破壞」。' },
    { id:'SK_CLUB_L2', g:'club', req:['SK_CLUB_1'], u:434.5, v:0, n:'怪力Ⅱ', e:'💪', d:'物理攻擊 +1%', eff:{ atkP:1 } },
    { id:'SK_CLUB_2', g:'club', wp:['club','stoneaxe'], n:'基本功', e:'🎯', req:['SK_CLUB_L2'], u:530, v:0, d:'暴擊率 +5%、傷害 +5%', eff:{ critC:5, dmgP:5 } },
    { id:'SK_CLUB_L3A', g:'club', req:['SK_CLUB_2'], u:624.5, v:-62, n:'怪力Ⅲ', e:'💪', d:'物理攻擊 +1%', eff:{ atkP:1 } },
    { id:'SK_CLUB_L3B', g:'club', req:['SK_CLUB_2'], u:624.5, v:62, n:'怪力Ⅲ', e:'💪', d:'物理攻擊 +1%', eff:{ atkP:1 } },
    { id:'SK_CLUB_F1A', g:'club', wp:['club','stoneaxe'], grp:'club_f', n:'重劈', e:'🪨', req:['SK_CLUB_L3A'], u:720, v:-124, d:'【分歧・二選一】破甲上限 +2(最多 5 層),每層再 −2%(滿層防禦 −40%)', eff:{ brkMax:2, brkDef:2 } },
    { id:'SK_CLUB_L4A', g:'club', req:['SK_CLUB_F1A'], u:814.5, v:-124, n:'怪力Ⅳ', e:'💪', d:'物理攻擊 +1%', eff:{ atkP:1 } },
    { id:'SK_CLUB_F1B', g:'club', wp:['club','stoneaxe'], grp:'club_f', n:'趁亂追擊', e:'💫', req:['SK_CLUB_L3B'], u:720, v:124, d:'【分歧・二選一】對暈眩中的目標傷害 +25%,而且每次多疊 1 層破甲', eff:{ vsStunP:25, brkStun:1 } },
    { id:'SK_CLUB_L4B', g:'club', req:['SK_CLUB_F1B'], u:814.5, v:124, n:'怪力Ⅳ', e:'💪', d:'物理攻擊 +1%', eff:{ atkP:1 } },
    { id:'SK_CLUB_F2A', g:'club', wp:['club','stoneaxe'], n:'碎甲', e:'💢', req:['SK_CLUB_L4A'], u:910, v:-124, d:'目標破甲疊滿時,你的傷害 +30%', eff:{ brkFullP:30 } },
    { id:'SK_CLUB_F2B', g:'club', wp:['club','stoneaxe'], n:'反擊', e:'🛡', req:['SK_CLUB_L4B'], u:910, v:124, d:'被魔物打中時 15% 機率立刻反擊(50% 傷害),反擊也會疊破甲', eff:{ counterP:15, brkCounter:1 } },
    { id:'SK_CLUB_KEY', g:'club', wp:['club','stoneaxe'], key:true, act:'club_smash', n:'猛擊', e:'🌟', reqAny:['SK_CLUB_F2A','SK_CLUB_F2B'], u:1100, v:0, d:'★關鍵節點:解鎖絕招「猛擊」;猛擊命中再疊 2 層破甲' },
    { id:'SK_CLUB_L5', g:'club', req:['SK_CLUB_KEY'], u:1194.5, v:0, n:'怪力Ⅴ', e:'💪', d:'物理攻擊 +1%', eff:{ atkP:1 } },
    { id:'SK_CLUB_M', g:'club', wp:['club','stoneaxe'], mst:true, n:'裂岩者', e:'👑', req:['SK_CLUB_L5'], mat:{ boss_magmashell:2 }, u:1290, v:0, d:'【精通】每隻魔物第一次被你打中就直接疊 2 層破甲;傷害 +8%。需要頭目素材 🟥熔甲殼片 ×2(洗點後再點不必重付)', eff:{ brkOpen:2, dmgP:8 }, sci:'岩石遇熱膨脹、遇冷收縮,反覆幾次就會裂開——這叫「熱脹冷縮造成的風化」。' },
    /* ── 🔨 錘星域:🔋 蓄力層 ── */
    { id:'SK_HAMMER_1', g:'hammer', wp:['hammer'], n:'蓄力架勢', e:'🔋', req:['SK_HAMMER_L1'], u:340, v:0, d:'按「🛡 防禦」時蓄 1 層「🔋蓄力」(上限 2):下一次攻擊或絕招每層傷害 +30%、擊暈機率 +8%,打出去就用掉', eff:{ chargeOn:1 }, sci:'把錘子舉高再落下,位能變成動能——舉得越高,打下去越重。' },
    { id:'SK_HAMMER_L2', g:'hammer', req:['SK_HAMMER_1'], u:434.5, v:0, n:'壯健Ⅱ', e:'💗', d:'最大體力 +1%', eff:{ hpMaxP:1 } },
    { id:'SK_HAMMER_2', g:'hammer', wp:['hammer'], n:'基本功', e:'🎯', req:['SK_HAMMER_L2'], u:530, v:0, d:'暴擊率 +5%、傷害 +5%', eff:{ critC:5, dmgP:5 } },
    { id:'SK_HAMMER_L3A', g:'hammer', req:['SK_HAMMER_2'], u:624.5, v:-62, n:'壯健Ⅲ', e:'💗', d:'最大體力 +1%', eff:{ hpMaxP:1 } },
    { id:'SK_HAMMER_L3B', g:'hammer', req:['SK_HAMMER_2'], u:624.5, v:62, n:'壯健Ⅲ', e:'💗', d:'最大體力 +1%', eff:{ hpMaxP:1 } },
    { id:'SK_HAMMER_F1A', g:'hammer', wp:['hammer'], grp:'hammer_f', n:'厚積薄發', e:'🏋', req:['SK_HAMMER_L3A'], u:720, v:-124, d:'【分歧・二選一】蓄力上限 +1(最多 3 層),每層傷害再 +10%', eff:{ chargeMax:1, chargeMul:10 } },
    { id:'SK_HAMMER_L4A', g:'hammer', req:['SK_HAMMER_F1A'], u:814.5, v:-124, n:'壯健Ⅳ', e:'💗', d:'最大體力 +1%', eff:{ hpMaxP:1 } },
    { id:'SK_HAMMER_F1B', g:'hammer', wp:['hammer'], grp:'hammer_f', n:'震盪', e:'😵', req:['SK_HAMMER_L3B'], u:720, v:124, d:'【分歧・二選一】擊暈機率 +12%;蓄力每層擊暈機率再 +6%', eff:{ stunAddP:12, chargeStun:6 }, sci:'重物撞擊會把能量變成震動傳出去。' },
    { id:'SK_HAMMER_L4B', g:'hammer', req:['SK_HAMMER_F1B'], u:814.5, v:124, n:'壯健Ⅳ', e:'💗', d:'最大體力 +1%', eff:{ hpMaxP:1 } },
    { id:'SK_HAMMER_F2A', g:'hammer', wp:['hammer'], n:'地鳴', e:'🌋', req:['SK_HAMMER_L4A'], u:910, v:-124, d:'蓄力滿層出手時,其他魔物也會受到 40% 傷害', eff:{ chargeSplash:40 } },
    { id:'SK_HAMMER_F2B', g:'hammer', wp:['hammer'], n:'硬扛', e:'🧱', req:['SK_HAMMER_L4B'], u:910, v:124, d:'每次受傷固定 −3;身上有蓄力時受傷再 −20%', eff:{ dmgCut:3, chargeGuard:20 } },
    { id:'SK_HAMMER_KEY', g:'hammer', wp:['hammer'], key:true, act:'hammer_quake', n:'地裂重擊', e:'🌟', reqAny:['SK_HAMMER_F2A','SK_HAMMER_F2B'], u:1100, v:0, d:'★關鍵節點:解鎖絕招「地裂重擊」;蓄力也會加在這一擊上' },
    { id:'SK_HAMMER_L5', g:'hammer', req:['SK_HAMMER_KEY'], u:1194.5, v:0, n:'壯健Ⅴ', e:'💗', d:'最大體力 +1%', eff:{ hpMaxP:1 } },
    { id:'SK_HAMMER_M', g:'hammer', wp:['hammer'], mst:true, n:'山崩', e:'👑', req:['SK_HAMMER_L5'], mat:{ boss_lavaheart:1 }, u:1290, v:0, d:'【精通】普通攻擊命中 25% 機率自動蓄 1 層;開戰就有 1 層蓄力。需要頭目素材 ❤️‍🔥巨像熔心 ×1(洗點後再點不必重付)', eff:{ chargeAutoP:25, chargeStart:1 }, sci:'山崩是因為坡上的土石重量大過摩擦力,一點點震動就讓整片滑下來。' },
    /* ── 🔱 長槍星域:🔱 架槍反擊 ── */
    { id:'SK_SPEAR_1', g:'spear', wp:['spear'], n:'架槍', e:'🔱', req:['SK_SPEAR_L1'], u:340, v:0, d:'按「🛡 防禦」時架起長槍:到你下一回合前,魔物普通攻擊打你,你一定反刺一下(50% 傷害)', eff:{ braceOn:1 }, sci:'長槍比對手的手臂長,先把槍尖對準對方,對方衝過來就等於自己撞上來。' },
    { id:'SK_SPEAR_L2', g:'spear', req:['SK_SPEAR_1'], u:434.5, v:0, n:'堅守Ⅱ', e:'🛡', d:'防禦 +1%', eff:{ defP:1 } },
    { id:'SK_SPEAR_2', g:'spear', wp:['spear'], n:'基本功', e:'🎯', req:['SK_SPEAR_L2'], u:530, v:0, d:'暴擊率 +5%、傷害 +5%', eff:{ critC:5, dmgP:5 } },
    { id:'SK_SPEAR_L3A', g:'spear', req:['SK_SPEAR_2'], u:624.5, v:-62, n:'堅守Ⅲ', e:'🛡', d:'防禦 +1%', eff:{ defP:1 } },
    { id:'SK_SPEAR_L3B', g:'spear', req:['SK_SPEAR_2'], u:624.5, v:62, n:'堅守Ⅲ', e:'🛡', d:'防禦 +1%', eff:{ defP:1 } },
    { id:'SK_SPEAR_F1A', g:'spear', wp:['spear'], grp:'spear_f', n:'以守代攻', e:'🛡', req:['SK_SPEAR_L3A'], u:720, v:-124, d:'【分歧・二選一】反刺傷害 +30%(變成 80%),而且反刺可以暴擊', eff:{ braceMul:30, braceCrit:1 } },
    { id:'SK_SPEAR_L4A', g:'spear', req:['SK_SPEAR_F1A'], u:814.5, v:-124, n:'堅守Ⅳ', e:'🛡', d:'防禦 +1%', eff:{ defP:1 } },
    { id:'SK_SPEAR_F1B', g:'spear', wp:['spear'], grp:'spear_f', n:'放血', e:'🩸', req:['SK_SPEAR_L3B'], u:720, v:124, d:'【分歧・二選一】普通攻擊與反刺命中時,讓目標流血 1 層(每回合 −2)', eff:{ bleedOn:1 } },
    { id:'SK_SPEAR_L4B', g:'spear', req:['SK_SPEAR_F1B'], u:814.5, v:124, n:'堅守Ⅳ', e:'🛡', d:'防禦 +1%', eff:{ defP:1 } },
    { id:'SK_SPEAR_F2A', g:'spear', wp:['spear'], n:'見招拆招', e:'👁', req:['SK_SPEAR_L4A'], u:910, v:-124, d:'完美閃避時也會順勢反刺(不必先架槍)', eff:{ braceDodge:1 } },
    { id:'SK_SPEAR_F2B', g:'spear', wp:['spear'], n:'先發制人', e:'🥇', req:['SK_SPEAR_L4B'], u:910, v:124, d:'每場戰鬥第一擊必定命中;對流血中的目標傷害 +15%', eff:{ firstHit:1, vsBleedP:15 } },
    { id:'SK_SPEAR_KEY', g:'spear', wp:['spear'], key:true, act:'spear_combo', n:'突刺連環', e:'🌟', reqAny:['SK_SPEAR_F2A','SK_SPEAR_F2B'], u:1100, v:0, d:'★關鍵節點:解鎖絕招「突刺連環」;放完之後自動架起長槍' },
    { id:'SK_SPEAR_L5', g:'spear', req:['SK_SPEAR_KEY'], u:1194.5, v:0, n:'堅守Ⅴ', e:'🛡', d:'防禦 +1%', eff:{ defP:1 } },
    { id:'SK_SPEAR_M', g:'spear', wp:['spear'], mst:true, n:'不動如山', e:'👑', req:['SK_SPEAR_L5'], mat:{ boss_thunderplume:2 }, u:1290, v:0, d:'【精通】架槍時受到的傷害 −30%;架槍多撐 1 回合。需要頭目素材 ⚡雷鳴羽 ×2(洗點後再點不必重付)', eff:{ braceCut:30, braceKeep:1 }, sci:'重心越低、腳站越開,身體越不容易被推倒——所以架槍要蹲低。' },
    /* ── 🪃 迴力鏢星域:↪ 彈射 ── */
    { id:'SK_BOOMERANG_1', g:'boomerang', wp:['boomerang'], n:'迴旋彈射', e:'↪', req:['SK_BOOMERANG_L1'], u:340, v:0, d:'迴力鏢第二段彈到另一隻魔物的那一下,傷害 +20%', eff:{ bounceMul:20 }, sci:'迴力鏢彎曲的翼形讓它一邊旋轉一邊繞回來。' },
    { id:'SK_BOOMERANG_L2', g:'boomerang', req:['SK_BOOMERANG_1'], u:434.5, v:0, n:'靈動Ⅱ', e:'🌀', d:'行動速度 +1%', eff:{ spdP:1 } },
    { id:'SK_BOOMERANG_2', g:'boomerang', wp:['boomerang'], n:'基本功', e:'🎯', req:['SK_BOOMERANG_L2'], u:530, v:0, d:'暴擊率 +5%、傷害 +5%', eff:{ critC:5, dmgP:5 } },
    { id:'SK_BOOMERANG_L3A', g:'boomerang', req:['SK_BOOMERANG_2'], u:624.5, v:-62, n:'靈動Ⅲ', e:'🌀', d:'行動速度 +1%', eff:{ spdP:1 } },
    { id:'SK_BOOMERANG_L3B', g:'boomerang', req:['SK_BOOMERANG_2'], u:624.5, v:62, n:'靈動Ⅲ', e:'🌀', d:'行動速度 +1%', eff:{ spdP:1 } },
    { id:'SK_BOOMERANG_F1A', g:'boomerang', wp:['boomerang'], grp:'boomerang_f', n:'雙迴旋', e:'🌀', req:['SK_BOOMERANG_L3A'], u:720, v:-124, d:'【分歧・二選一】一回合多丟 1 段', eff:{ hitsAdd:1 } },
    { id:'SK_BOOMERANG_L4A', g:'boomerang', req:['SK_BOOMERANG_F1A'], u:814.5, v:-124, n:'靈動Ⅳ', e:'🌀', d:'行動速度 +1%', eff:{ spdP:1 } },
    { id:'SK_BOOMERANG_F1B', g:'boomerang', wp:['boomerang'], grp:'boomerang_f', n:'精準迴旋', e:'🎯', req:['SK_BOOMERANG_L3B'], u:720, v:124, d:'【分歧・二選一】彈射傷害再 +30%,並且優先彈向血量最少的魔物', eff:{ bounceMul:30, bounceSmart:1 } },
    { id:'SK_BOOMERANG_L4B', g:'boomerang', req:['SK_BOOMERANG_F1B'], u:814.5, v:124, n:'靈動Ⅳ', e:'🌀', d:'行動速度 +1%', eff:{ spdP:1 } },
    { id:'SK_BOOMERANG_F2A', g:'boomerang', wp:['boomerang'], n:'追打', e:'💫', req:['SK_BOOMERANG_L4A'], u:910, v:-124, d:'對暈眩中的目標傷害 +20%;彈射命中 15% 機率把目標打暈', eff:{ vsStunP:20, bounceStunP:15 } },
    { id:'SK_BOOMERANG_F2B', g:'boomerang', wp:['boomerang'], n:'回收', e:'♻', req:['SK_BOOMERANG_L4B'], u:910, v:124, d:'命中後 25% 機率多賺 1 點武器熟練;彈射打倒魔物時回復 15% 體力', eff:{ xpBackP:25, bounceKillHeal:15 } },   /* ★ v1.288.0 老師「迴力鏢的『回收』打倒敵人恢復自己體力改成 15%」— 6→15(原本 6% 在中後期一場打下來幾乎感覺不到,而且這一節點的對照組「追打」是純傷害加成,回復量太低會讓分歧變成沒得選) */
    { id:'SK_BOOMERANG_KEY', g:'boomerang', wp:['boomerang'], key:true, act:'boom_dance', n:'迴旋亂舞', e:'🌟', reqAny:['SK_BOOMERANG_F2A','SK_BOOMERANG_F2B'], u:1100, v:0, d:'★關鍵節點:解鎖絕招「迴旋亂舞」' },
    { id:'SK_BOOMERANG_L5', g:'boomerang', req:['SK_BOOMERANG_KEY'], u:1194.5, v:0, n:'靈動Ⅴ', e:'🌀', d:'行動速度 +1%', eff:{ spdP:1 } },
    { id:'SK_BOOMERANG_M', g:'boomerang', wp:['boomerang'], mst:true, n:'旋風', e:'👑', req:['SK_BOOMERANG_L5'], mat:{ boss_shadowgem:2 }, u:1290, v:0, d:'【精通】第三段也會彈射(打第三隻魔物,沒有就打第二隻)。需要頭目素材 🔮深淵影晶 ×2(洗點後再點不必重付)', eff:{ bounceAdd:1 }, sci:'旋轉的東西會比較穩——陀螺、腳踏車輪子都是靠這個原理不倒。' },
    /* ── 🧺 中央・生活技藝星域(B5:原本散在各武器星域的生活效果全部搬到這裡,不必再為了砍樹去點某把武器) ── */
    { id:'SK_LIFE_1', g:'life', n:'巧手', e:'🖐', req:['SK_LIFE_L1'], u:460, v:0, d:'所有 QTE 甜蜜點 +8%(島上活動與戰鬥攻擊都算)', eff:{ sweetP:8 } },
    { id:'SK_LIFE_L2', g:'life', req:['SK_LIFE_1'], u:550, v:-62, n:'健步Ⅱ', e:'👟', d:'島上走路速度 +1%', eff:{ moveP:1 } },
    { id:'SK_LIFE_L3', g:'life', req:['SK_LIFE_1'], u:550, v:62, n:'健步Ⅱ', e:'👟', d:'島上走路速度 +1%', eff:{ moveP:1 } },
    { id:'SK_LIFE_2', g:'life', n:'慢活節奏', e:'🐢', req:['SK_LIFE_L2'], u:640, v:-124, d:'所有 QTE 指針變慢 12%;夜襲魔物爬行再慢 15%;戰鬥閃避鈕「閃過一半」的判定時間 +0.2 秒', eff:{ qteSlowP:12, defSlowP:15, dodgeGoodMs:200 } },
    { id:'SK_LIFE_L4', g:'life', req:['SK_LIFE_2'], u:730, v:-124, n:'健步Ⅲ', e:'👟', d:'島上走路速度 +1%', eff:{ moveP:1 } },
    { id:'SK_LIFE_3', g:'life', n:'伐木採石', e:'🪓', req:['SK_LIFE_L3'], u:640, v:124, d:'砍樹/採石 產量各 +1;建造速度 +10%;夜襲補血次數上限 +1', eff:{ chopAdd:1, quarryAdd:1, buildFastP:10, defWoodAdd:1 }, sci:'順著木頭纖維的方向劈,比橫著砍省力很多。' },
    { id:'SK_LIFE_L5', g:'life', req:['SK_LIFE_3'], u:730, v:124, n:'健步Ⅲ', e:'👟', d:'島上走路速度 +1%', eff:{ moveP:1 } },
    { id:'SK_LIFE_4', g:'life', n:'小心作業', e:'🧤', req:['SK_LIFE_L4'], u:820, v:-124, d:'島上活動失誤受傷 −30%;夜襲被咬扣血 −30%', eff:{ hurtCutP:30, defBiteCutP:30 } },
    { id:'SK_LIFE_5', g:'life', n:'漁獵好手', e:'🎣', req:['SK_LIFE_L5'], u:820, v:124, d:'捕魚產量 +1;採集作答時間 +8%;探索度增加 +10%', eff:{ fishAdd:1, actSecP:8, exploreP:10 } },
    { id:'SK_LIFE_6', g:'life', key:true, n:'匠心', e:'🌟', req:['SK_LIFE_4','SK_LIFE_5'], u:1000, v:0, d:'★建造/製作品質 ★ +1;QTE 甜蜜點再 +5%、指針再慢 10%;建造速度再 +15%、材料節省 15%', eff:{ craftStar:1, sweetP:5, qteSlowP:10, buildFastP:15, costCutP:15 }, sci:'熟能生巧:重複練習會讓大腦把動作變成「自動化」,不用想也做得準。' },
    { id:'SK_MED_BND_1',   g:'med', sub:'bnd', dep:1, n:'止血',     e:'🩹', req:['SK_MED_BND_L1'],     u:460, v:-180, d:'戰鬥中可止血:去除自己身上的流血/蜂螫；島上活動失誤受傷 −25%;夜襲被咬扣血再 −25%;🛡 按防禦時額外回復 5% 最大體力', eff:{ bleedCure:1, hurtCutP:25, defBiteCutP:25, guardHealP:5 } },
    { id:'SK_MED_BND_L2', g:'med', req:['SK_MED_BND_1'], u:550, v:-180, n:'藥效Ⅱ', e:'💚', d:'治療/解毒效果 +1%', eff:{ healP:1 } },
    { id:'SK_MED_BND_2',   g:'med', sub:'bnd', dep:2, n:'緊急包紮', e:'🧻', req:['SK_MED_BND_L2'],   u:640, v:-180, d:'每場戰鬥 1 次:立刻回復 30% 體力(不用藥草)', eff:{ bandageP:30, bandageN:1 } },
    { id:'SK_MED_BND_L3', g:'med', req:['SK_MED_BND_2'], u:730, v:-180, n:'藥效Ⅲ', e:'💚', d:'治療/解毒效果 +1%', eff:{ healP:1 } },
    { id:'SK_MED_BND_3',   g:'med', sub:'bnd', dep:3, n:'為隊友包紮', e:'🤝', req:['SK_MED_BND_L3'], u:820, v:-180, d:'緊急包紮改成治療「全隊」(主角+所有沒倒下的隊友);可用次數 +1、回復量 +10%', eff:{ bandageN:1, bandageP:10, allyBnd:1 } },   /* ★ v1.288.0 老師「為隊友包紮保留原本效果並將治療效果變為全體」— 次數+1/回復量+10% 兩個原效果一字未改,allyBnd 的意義由「多人連線用(單人只是數字大一點)」升級成真正的全體治療,index 端 islSkBandage 有對應分支;倒下的隊友不算在內(那是 🩹 戰場急救與 🧪 草藥精華的守備範圍) */
    { id:'SK_MED_BND_L4', g:'med', req:['SK_MED_BND_3'], u:910, v:-180, n:'藥效Ⅳ', e:'💚', d:'治療/解毒效果 +1%', eff:{ healP:1 } },
    { id:'SK_MED_BND_KEY', g:'med', sub:'bnd', dep:4, key:true, n:'不倒的意志', e:'🌟', req:['SK_MED_BND_L4'], u:1000, v:-180, d:'★關鍵節點:每場戰鬥 1 次,體力歸零時保留 1 點不算戰敗', eff:{ deathSave:1 } },
    { id:'SK_MED_PHM_1',   g:'med', sub:'phm', dep:1, n:'辨識野生藥草', e:'🍀', req:['SK_MED_PHM_L1'], u:460, v:0, d:'採集時 🍀草藥 掉落機率 +25%；野生動物馴養成功率 +15%、寵物親密度提升效率 +15%', eff:{ herbP:25, tameP:15, bondGainP:15 }, sci:'認得出植物才敢用——不認得的野草絕對不能亂吃。' },   /* ★ v1.196.0 新增 bondGainP,tameP 保留不動(見 SK_CORE_LUCK 註解) */
    { id:'SK_MED_PHM_L2', g:'med', req:['SK_MED_PHM_1'], u:550, v:0, n:'強身Ⅱ', e:'🧿', d:'島上不良狀態發生機率再減免 +1%', eff:{ ailResP:1 } },
    { id:'SK_MED_PHM_2',   g:'med', sub:'phm', dep:2, n:'基礎解毒劑', e:'🧪', req:['SK_MED_PHM_L2'],   u:640, v:0, d:'可調配解毒劑,解除蛇咬中毒(需 🍀草藥 1)', eff:{ poisonCure:1 } },
    { id:'SK_MED_PHM_L3', g:'med', req:['SK_MED_PHM_2'], u:730, v:0, n:'強身Ⅲ', e:'🧿', d:'島上不良狀態發生機率再減免 +1%', eff:{ ailResP:1 } },
    { id:'SK_MED_PHM_3',   g:'med', sub:'phm', dep:3, n:'毒素抗性',   e:'🛡', req:['SK_MED_PHM_L3'],   u:820, v:0, d:'中毒每回合傷害減半,惡化速度也減半；島上活動失誤受傷 −25%', eff:{ poisonResP:50, hurtCutP:25 } },
    { id:'SK_MED_PHM_L4', g:'med', req:['SK_MED_PHM_3'], u:910, v:0, n:'強身Ⅳ', e:'🧿', d:'島上不良狀態發生機率再減免 +1%', eff:{ ailResP:1 } },
    { id:'SK_MED_PHM_KEY', g:'med', sub:'phm', dep:4, key:true, n:'進階解毒劑', e:'🌟', req:['SK_MED_PHM_L4'], u:1000, v:0, d:'★關鍵節點:一次解除身上所有不良狀態(每天 1 次,需 🍀草藥 1)', eff:{ cureAll:1 } },
    { id:'SK_MED_CK_1',   g:'med', sub:'ck', dep:1, n:'恢復料理',   e:'🍲', req:['SK_MED_CK_L1'],    u:460, v:180, d:'吃料理回復量 +20%,熱食可解除失溫；養的動物每日產出 +20%', eff:{ dishP:20, coldCure:1, petYieldP:20 } },
    { id:'SK_MED_CK_L2', g:'med', req:['SK_MED_CK_1'], u:550, v:180, n:'飽足Ⅱ', e:'🍚', d:'最大體力 +1%', eff:{ hpMaxP:1 } },
    { id:'SK_MED_CK_2',   g:'med', sub:'ck', dep:2, n:'保存食物',   e:'🫙', req:['SK_MED_CK_L2'],   u:640, v:180, d:'25% 機率吃了料理卻不消耗那一份；餵動物也有 25% 不消耗飼料;建造/製作材料節省 10%', eff:{ dishSaveP:25, petFeedSaveP:25, costCutP:10 }, sci:'曬乾、煙燻、加鹽都能讓食物不容易壞——因為細菌沒有水就長不起來。' },
    { id:'SK_MED_CK_L3', g:'med', req:['SK_MED_CK_2'], u:730, v:180, n:'飽足Ⅲ', e:'🍚', d:'最大體力 +1%', eff:{ hpMaxP:1 } },
    { id:'SK_MED_CK_3',   g:'med', sub:'ck', dep:3, n:'消除疲勞',   e:'⚡', req:['SK_MED_CK_L3'],   u:820, v:180, d:'每天第一次吃料理額外回復 ⚡AP 1；養的動物每日產出 +25%', eff:{ dishAp:1, petYieldP:25 } },
    { id:'SK_MED_CK_L4', g:'med', req:['SK_MED_CK_3'], u:910, v:180, n:'飽足Ⅳ', e:'🍚', d:'最大體力 +1%', eff:{ hpMaxP:1 } },
    { id:'SK_MED_CK_KEY', g:'med', sub:'ck', dep:4, key:true, n:'營地聚餐', e:'🌟', req:['SK_MED_CK_L4'], u:1000, v:180, d:'★多人連線用;在營地辦聚餐:今天攻擊 +10%(每天 1 次,需任一道料理)；養的動物每日產出 +25%、野生動物馴養成功率 +15%、寵物親密度提升效率 +15%', eff:{ feast:1, petYieldP:25, tameP:15, bondGainP:15 } },   /* ★ v1.196.0 新增 bondGainP,tameP 保留不動(見 SK_CORE_LUCK 註解) */
    /* ★ v1.163.0 ── 🎯 特殊指令星域(每個節點帶一個 cmd 鍵 → 對應 D.SK_CMDS;點亮 = 解鎖該指令,還要到能力頁裝設才會出現按鈕) ── */
    { id:'SK_CMD_1', g:'cmd', cmd:'CMD_SCAN',      n:'環境觀察', e:'🔍', req:['SK_CMD_L1'],           u:520, v:0, d:'解鎖特殊指令「🔍 環境觀察」(野外・⚡1)', eff:{}, sci:'先觀察再行動,是所有野外工作的第一步。' },
    { id:'SK_CMD_L2', g:'cmd', req:['SK_CMD_1'], u:610, v:-90, n:'警覺Ⅱ', e:'🥋', d:'閃避時額外減傷 +1%', eff:{ dodgeCutP:1 } },
    { id:'SK_CMD_L3', g:'cmd', req:['SK_CMD_1'], u:610, v:0, n:'警覺Ⅱ', e:'🥋', d:'閃避時額外減傷 +1%', eff:{ dodgeCutP:1 } },
    { id:'SK_CMD_L4', g:'cmd', req:['SK_CMD_1'], u:610, v:90, n:'警覺Ⅱ', e:'🥋', d:'閃避時額外減傷 +1%', eff:{ dodgeCutP:1 } },
    { id:'SK_CMD_2', g:'cmd', cmd:'CMD_FIRSTAID',  n:'戰場急救', e:'🩹', req:['SK_CMD_L2'],                u:700, v:-180, d:'解鎖特殊指令「🩹 戰場急救」(戰鬥・⚡2)', eff:{}, sci:'急救的順序是先止血、再保暖,最後才送醫。' },
    { id:'SK_CMD_L5', g:'cmd', req:['SK_CMD_2'], u:790, v:-180, n:'警覺Ⅲ', e:'🥋', d:'閃避時額外減傷 +1%', eff:{ dodgeCutP:1 } },
    { id:'SK_CMD_3', g:'cmd', cmd:'CMD_SMOKE',     n:'煙霧彈',   e:'💨', req:['SK_CMD_L3'],                u:700, v:0, d:'解鎖特殊指令「💨 煙霧彈」(戰鬥・⚡1)',   eff:{}, sci:'濃煙會遮住動物的視線與氣味,是很老的脫身方法。' },
    { id:'SK_CMD_L6', g:'cmd', req:['SK_CMD_3'], u:790, v:0, n:'警覺Ⅲ', e:'🥋', d:'閃避時額外減傷 +1%', eff:{ dodgeCutP:1 } },
    { id:'SK_CMD_4', g:'cmd', cmd:'CMD_QUICKPICK', n:'熟練採集', e:'🧺', req:['SK_CMD_L4'],                u:700, v:180, d:'解鎖特殊指令「🧺 熟練採集」(野外・⚡2)', eff:{}, sci:'熟練來自重複練習,動作會慢慢變成身體記得的事。' },
    { id:'SK_CMD_L7', g:'cmd', req:['SK_CMD_4'], u:790, v:180, n:'警覺Ⅲ', e:'🥋', d:'閃避時額外減傷 +1%', eff:{ dodgeCutP:1 } },
    { id:'SK_CMD_5', g:'cmd', cmd:'CMD_TRAP',      n:'佈設陷阱', e:'🪤', req:['SK_CMD_L5'],                u:880, v:-180, d:'解鎖特殊指令「🪤 佈設陷阱」(戰鬥・⚡2)', eff:{}, sci:'陷阱靠的是「位能一次放掉」,所以小小的繩子也能絆倒大東西。' },
    { id:'SK_CMD_6', g:'cmd', cmd:'CMD_CALL',      n:'呼喚夥伴', e:'📣', req:['SK_CMD_L6'],                u:880, v:0, d:'解鎖特殊指令「📣 呼喚夥伴」(戰鬥・⚡1)', eff:{}, sci:'夥伴聽到熟悉的呼喚聲會立刻放下戒心、全力照顧你,安心感能讓身體更快進入修復狀態。' },
    { id:'SK_CMD_7', g:'cmd', cmd:'CMD_RALLY',     n:'鼓舞號令', e:'⚡', req:['SK_CMD_L7'],                u:880, v:180, d:'解鎖特殊指令「⚡ 鼓舞號令」(戰鬥・⚡2)', eff:{}, sci:'一起喊口號會讓人動作更同步,這叫「節律同調」。' },
    { id:'SK_CMD_8', g:'cmd', cmd:'CMD_REST', key:true, n:'野外小憩', e:'🔥', req:['SK_CMD_6','SK_CMD_7'], u:1060, v:90, d:'★解鎖特殊指令「🔥 野外小憩」(野外・⚡3)', eff:{}, sci:'休息時身體會把血糖轉回肌肉裡的肝醣,這就是「恢復」。' },
    /* ★ v1.317.0 ── 🐾 馴獸專精星域(老師:主要提升所有寵物各項能力和技能強化) ──
       效果鍵全部是新鍵、只作用在「寵物」隊友(好友借用/協助角色不吃),index 端消費點:
       petHpP/petAtkP/petDefP/petSpdP → islPetStats(夥伴圖鑑、詳情卡、戰鬥單位同一個出口,顯示=實作);
       petCdCut → islPetStats 的 cdCut(與親密度減冷卻疊加,冷卻最少仍是 1 回合);
       petGaugeP/petGaugeStart → islBtGaugeTick / islBtMakeAllies(技能計量);petCritC → islBtAllyBasic;
       petCutP/petGuts → islBtHurtUnit;petSkDmgP → islBtPetCmd 傷害;petSkSupP → islPetHealMul + islBtShieldAll。
       路線:核心「馴獸之心」(免前置,跟其他四顆中央節點一樣一開始就能點)→ 獸力Ⅰ → 心有靈犀 → 獸體Ⅰ → 馴獸基本功
       → 🔀分歧二選一(猛獸本能/守護本能)→ 分歧延伸 → 🌟羈絆守護(任一條走完)→ 萬獸共鳴 → 👑萬獸之王(精通,🦷鐵牙獠牙 ×2)。
       ⚠ 本區註解同樣嚴禁「星號+斜線」。 */
    { id:'SK_CORE_BEAST', g:'core', n:'馴獸之心', e:'🐾', req:[], pr:300, pa:-90, d:'所有寵物最大體力/攻擊/防禦/速度 +3%;寵物親密度提升效率 +5%(馴獸專精星域從這裡出發)', eff:{ petHpP:3, petAtkP:3, petDefP:3, petSpdP:3, bondGainP:5 } },
    { id:'SK_BEAST_L1', g:'beast', req:['SK_CORE_BEAST'], u:400, v:0, n:'獸力Ⅰ', e:'💪', d:'寵物攻擊 +2%', eff:{ petAtkP:2 } },
    { id:'SK_BEAST_1', g:'beast', n:'心有靈犀', e:'💞', req:['SK_BEAST_L1'], u:495, v:0, d:'寵物技能計量累積速度 +20%(每次行動 +25% 變成 +30%);開戰時計量先有 25%', eff:{ petGaugeP:20, petGaugeStart:25 }, sci:'狗狗會看主人的眼神和手勢行動——長時間相處,動物會學會讀懂你的肢體語言。' },
    { id:'SK_BEAST_L2', g:'beast', req:['SK_BEAST_1'], u:590, v:0, n:'獸體Ⅰ', e:'💗', d:'寵物最大體力 +2%', eff:{ petHpP:2 } },
    { id:'SK_BEAST_2', g:'beast', n:'馴獸基本功', e:'🎯', req:['SK_BEAST_L2'], u:685, v:0, d:'寵物最大體力/攻擊/防禦/速度 各 +4%;寵物普通攻擊暴擊率 +5%', eff:{ petHpP:4, petAtkP:4, petDefP:4, petSpdP:4, petCritC:5 } },
    { id:'SK_BEAST_L3A', g:'beast', req:['SK_BEAST_2'], u:780, v:-60, n:'獸力Ⅱ', e:'💪', d:'寵物攻擊 +2%', eff:{ petAtkP:2 } },
    { id:'SK_BEAST_L3B', g:'beast', req:['SK_BEAST_2'], u:780, v:60, n:'獸甲Ⅰ', e:'🛡', d:'寵物防禦 +2%', eff:{ petDefP:2 } },
    { id:'SK_BEAST_F1A', g:'beast', grp:'beast_f', n:'猛獸本能', e:'🐯', req:['SK_BEAST_L3A'], u:875, v:-70, d:'【分歧・二選一】寵物攻擊 +8%、寵物普通攻擊暴擊率 +10%', eff:{ petAtkP:8, petCritC:10 }, sci:'石虎、大冠鷲這些掠食者靠的是瞬間爆發力,所以狩獵時一出手就要又快又準。' },
    { id:'SK_BEAST_L4A', g:'beast', req:['SK_BEAST_F1A'], u:970, v:-70, n:'獸速Ⅰ', e:'💨', d:'寵物速度 +2%', eff:{ petSpdP:2 } },
    { id:'SK_BEAST_F1B', g:'beast', grp:'beast_f', n:'守護本能', e:'🐢', req:['SK_BEAST_L3B'], u:875, v:70, d:'【分歧・二選一】寵物防禦 +8%、最大體力 +8%;寵物受到的傷害 −8%', eff:{ petDefP:8, petHpP:8, petCutP:8 }, sci:'穿山甲、烏龜遇到危險會把身體捲起來或縮進殼裡,用最硬的部位保護自己。' },
    { id:'SK_BEAST_L4B', g:'beast', req:['SK_BEAST_F1B'], u:970, v:70, n:'獸體Ⅱ', e:'💗', d:'寵物最大體力 +2%', eff:{ petHpP:2 } },
    { id:'SK_BEAST_F2A', g:'beast', n:'狂野連擊', e:'💥', req:['SK_BEAST_L4A'], u:1065, v:-70, d:'寵物專屬技能的傷害 +25%', eff:{ petSkDmgP:25 } },
  ...
  D.SK_MED_LINK = false;   /* ★ v1.323.0 老師看圖「幸運沒有點亮,後面節點不該開放;飽足還沒點,後面不該開放」— 舊設計的醫療星域「互通」(任一條醫療分支有點亮,其他分支同深度 dep 的節點就算前置達成)讓 藥效線一點亮,辨識野生藥草/恢復料理/保存食物…全部跳過前置直接變可點,違反 v1.311.0 老師定的「必須照路線依序走」。關掉互通,一律只看 req;舊存檔跳點的由 index islSkMigrateB7 退點。 */
  ...
  D.SK_TITLES = [
    ...
    { id:'T_BEAST',  n:'馴獸大師',     e:'🐾', cond:'key:SK_BEAST_KEY',                 d:'寵物親密度提升效率 +10%', eff:{ bondGainP:10 } }   /* ★ v1.317.0 馴獸專精星域關鍵節點頭銜 */
  ];
  ...
  D.PETS = {
    ...
    deer:        { n:'梅花鹿',     e:'🦌', type:'heal', npc:true, sz:106,
                   ...
                   sci:'梅花鹿曾在台灣野外絕跡,靠人工復育才重新回到墾丁的草原上。' },   /* ★ v1.321.0 老師「梅花鹿的技能修正:以80%HP治療1名隊友(可以復活)」— cmd:reviveherb 的 fx 改用新的 healRevive 欄位,見 D.PET_CMDS.reviveherb */
    owl:         { n:'領角鴞',     e:'🦉', type:'atk',  npc:true, sz:72,
                   b:{ hp:55, atk:10, def:2, spd:8 }, g:{ hp:5.49, atk:1.05, def:0.28, spd:0.32 },
                   cmd:'dive',      talent:'夜盲突襲:對敵人造成傷害時,有 40% 機率使目標失明(命中 −50%)1 回合', tal:{ blindOnHitP:40 },   /* ★ v1.321.0 老師「領角鴞的天賦修正:對敵人造成傷害時有40%的機率使目標失明(命中-50%)1回合」— 取代原本的 firstDmgP(第一個出手傷害+12%) */
    ...
    leopardcat:  { n:'石虎',       e:'🐆', type:'atk', sz:60,
                   ...
                   cmd:'doubleclaw', talent:'夜行獵手:目標體力低於50%時,自己造成的傷害 +50%', tal:{ lowHpAtkP:50 },   /* ★ v1.327.0 老師「石虎天賦修正:目標HP低於50%時,自己造成的傷害+50%」— 20→50,且效果口徑從「攻擊力+20%」改成消費點端(islPetDmgMul)真正的「傷害+50%」 */
    ...
    bluemagpie:  { n:'台灣藍鵲',   e:'🐦', type:'atk', sz:55,
                   ...
                   cmd:'flockrush',  talent:'銳羽蓄能:每回合開始自己攻擊力 +5%,最多疊加至 +30%', tal:{ atkStackP:5, atkStackCapP:30 },   /* ★ v1.327.0 老師「台灣藍鵲天賦修正:每回合開始時自己攻擊力+5%,最多+30%」— 取代舊版「隊伍中每多一位夥伴+5%」的 perAllyAtkP,改成消費點端 islBtPartyTalTick 每回合開始疊加、islPetAtk 讀 u.atkStack 套用 */
    ...
    eagle:       { n:'大冠鷲',     e:'🦅', type:'atk', sz:65,
                   ...
                   cmd:'talondive',  talent:'高空視野:自己的普通攻擊有 20% 機率暴擊(1.5 倍)', tal:{ critP:20 },   /* ★ v1.327.0 老師「大冠鷲天賦修正:自己的普通攻擊暴擊率+20%」— 8→20 */
    ...
    treefrog:    { n:'莫氏樹蛙',   e:'🐸', type:'heal', sz:28,
                   ...
                   cmd:'dewmist',    talent:'濕潤皮膚:雨天或颱風天,自己的治療效果 +100%,且超過上限的治療量轉換為護盾', tal:{ rainHealP:100 },   /* ★ v1.321.0 老師「莫氏樹蛙的天賦修正:雨天或颱風天,自己的治療效果+100%,並且超過上限的治療量轉換為護盾」— rainHealP 25→100;超額轉護盾是新機制,見 index 端 islBtRegenTick 的 regenOverflowShield */
    ...
    salmon:      { n:'櫻花鉤吻鮭', e:'🐟', type:'heal', sz:35,
                   ...
                   cmd:'clearstream',talent:'力竭迴游:普通攻擊時恢復友方 HP 最低的隊友 15% HP;自己倒下時,使全隊恢復 60% HP(可復活倒下的夥伴)', tal:{ atkHealLowP:15, downHealAllP:60 },   /* ★ v1.321.0 老師「櫻花鉤吻鮭的天賦修正」— 取代原本的 lowHealP(自己半血+30%治療);atkHealLowP 消費點在 islBtAllyBasic(沿用既有 islBtHealOne),downHealAllP 消費點在 islBtHurtUnit(u.down 判定那一刻觸發) */
                   get:{ how:'shop', price:500 },   /* ★ v1.321.0 老師「櫻花鉤吻鮭和五色鳥的解鎖費用提高至500貝」— 180→500 */
    ...
    barbet:      { n:'五色鳥',     e:'🎨', type:'ctrl', sz:35,
                   ...
                   cmd:'drumecho',   talent:'鑿洞連擊:普通攻擊為 2 次;自己受到傷害時,技能冷卻縮短 1 回合', tal:{ basicHits:2, cdCutOnHit:1 },   /* ★ v1.321.0 老師「五色鳥的天賦修正」— 取代原本的 sealAdd(封招效果延長1回合);basicHits 消費點在 islBtAllyBasic,cdCutOnHit 消費點在 islBtHurtUnit */
                   get:{ how:'shop', price:500 },   /* ★ v1.321.0 老師「櫻花鉤吻鮭和五色鳥的解鎖費用提高至500貝」— 160→500 */
                   sci:'五色鳥會用嘴在枯木上鑿洞當巢,叫聲像敲木魚,所以被叫做「森林裡的花和尚」。' },

    /* ── 🌈 C 組:傳說夥伴 3 位(★ v1.331.0 企畫書《傳說夥伴與寵物裝備》老師定案 2026-09-24)──
       legend:true = 新分級標記(圖鑑/詳情卡顯示 🌈),不進任何野外遇敵池(islPetEncounterRoll 只挑 get.how==='tame')、
       不進阿獺商店;取得方式是各自一條「科學調查任務」(D.LEGEND,index 端 islLegend*)。
       基礎值與成長比同型夥伴高約 10~15%;招募問答改讀 D.PET_RECRUIT_LEGEND(10 題全考、答對 9 題)。
       天賦鍵一律寫在 tal,index 端不寫死(沿用 v1.164.0 慣例):
         splashP/splashMul + soloCritP/soloCritMul(雲豹:場上還有其他魔物才擲波及,只剩 1 隻才擲單體爆發,同一次普攻只會吃其中一種)、
         poisonOnHitP/poisonOnHitDur/poisonOnHitDmgP + blindWithPoison(藍環章魚:同一顆骰同時中毒+失明)、aggroCutP(被魔物點名的權重 −N%)、
         atkHealAllP(寬尾鳳蝶:普攻後全隊回 N%,與櫻花鉤吻鮭 atkHealLowP 同族的全體版)。 */
    cloudleopard:{ n:'台灣雲豹',   e:'🐆', type:'atk', sz:110, legend:true,
                   b:{ hp:58, atk:12, def:3, spd:9 }, g:{ hp:5.6, atk:1.25, def:0.32, spd:0.36 },
                   cmd:'cloudpounce', talent:'樹梢伏擊:自己的普通攻擊有 30% 機率波及其他所有魔物(各受 50% 傷害);場上只剩 1 隻魔物時,改成 50% 機率造成 2 倍傷害', tal:{ splashP:30, splashMul:50, soloCritP:50, soloCritMul:2 },
                   get:{ how:'legend', quest:'camera' },
                   sci:'台灣雲豹是台灣原生的大型貓科動物,身上有像雲朵的大斑塊,很會爬樹。2013 年學者調查多年都沒有找到,宣布在台灣野外滅絕。保護森林,就是保護還活著的動物。',
                   food:'egg', quiz:[
        { q:'台灣雲豹身上的斑紋看起來像什麼？', o:['像雲朵一樣的大斑塊','細細的直條紋','全身純黑沒有花紋','小小的圓點'], a:0, why:'雲豹身上有像雲朵的大塊斑紋，名字就是這樣來的。' },
        { q:'台灣雲豹特別擅長做什麼？', o:['爬樹','潛水','挖地洞','在沙漠奔跑'], a:0, why:'雲豹四肢粗壯、尾巴長，很會在樹上活動。' },
        { q:'2013 年學者宣布台灣雲豹的狀況是？', o:['在台灣野外滅絕','數量太多要控制','變成最常見的動物','搬到外國居住'], a:0, why:'學者用自動相機調查多年都沒有拍到，宣布台灣雲豹在野外滅絕。' },
        { q:'研究人員調查森林裡的野生動物，常用什麼不會打擾動物的工具？', o:['紅外線自動相機','大聲敲鑼','設陷阱抓起來','放鞭炮'], a:0, why:'自動相機架好就能自己拍照，人不用守在森林裡，也不會嚇到動物。' },
        { q:'紅外線自動相機是被什麼觸發拍照的？', o:['動物身體散發的熱','月亮的光','下雨的聲音','風吹的樹葉'], a:0, why:'感應器偵測到動物體溫和周圍的溫度差，相機就會自己按快門。' },
        { q:'台灣雲豹屬於哪一科動物？', o:['貓科','犬科','熊科','鹿科'], a:0, why:'雲豹和石虎一樣，都是貓科動物。' },
        { q:'雲豹長長的尾巴主要幫助牠做什麼？', o:['在樹上保持平衡','游泳划水','嚇跑敵人','儲存食物'], a:0, why:'長尾巴像平衡桿，讓雲豹在樹枝上走得穩。' },
        { q:'森林裡的大型肉食動物消失了，代表什麼？', o:['食物鏈頂端出了問題，生態系可能不平衡','森林變得更安全、不用擔心','草食動物一定也全部消失','完全沒有影響'], a:0, why:'頂端掠食者會控制其他動物的數量，牠們消失常代表整個生態系出了問題。' },
        { q:'想保護還活著的野生動物，最重要的是？', o:['保護牠們生活的森林棲地','把牠們全部抓進動物園','多開道路方便觀察','在山上放生外來種'], a:0, why:'棲地還在，動物才有地方吃、住、長大。' },
        { q:'在魯凱族的傳說裡，雲豹扮演什麼角色？', o:['帶領祖先找到新家園的聖獸','偷吃農作物的壞蛋','從來沒有出現過','被當成家裡的寵物'], a:0, why:'魯凱族傳說雲豹帶領祖先找到居住的地方，是族人非常敬重的動物。' }
      ] },
    bluering:    { n:'藍環章魚',   e:'🐙', type:'atk', sz:40, legend:true,
                   b:{ hp:46, atk:9, def:2, spd:10 }, g:{ hp:4.7, atk:1.00, def:0.26, spd:0.40 },
                   cmd:'bluebite', talent:'警戒藍環:普通攻擊時 35% 機率讓目標中毒 2 回合+失明 2 回合(失明時攻擊有一半會打偏);自己被魔物選為攻擊目標的機率 −75%', tal:{ poisonOnHitP:35, poisonOnHitDur:2, poisonOnHitDmgP:8, blindWithPoison:2, aggroCutP:75 },
                   get:{ how:'legend', quest:'tidepool' },
                   sci:'藍環章魚只有手掌大,生氣時身上的藍色圓環會一閃一閃,那是「警告色」。牠的唾液含有河豚毒素,毒性很強。台灣東北角、墾丁的潮池偶爾看得到——在海邊看到漂亮的小章魚,千萬不要用手碰!',
                   food:'fish', quiz:[
        { q:'藍環章魚生氣或受到驚嚇時，身上的藍色圓環會怎樣？', o:['一閃一閃變得更亮','完全消失','變成紅色','掉下來'], a:0, why:'牠會讓藍環快速閃爍，警告敵人不要靠近。' },
        { q:'藍環章魚身上這種鮮豔的顏色叫做什麼？', o:['警告色','保護色','偽裝色','婚姻色'], a:0, why:'用鮮豔顏色告訴敵人「我有毒，別惹我」，叫做警告色。' },
        { q:'藍環章魚的唾液裡含有哪一種強烈的毒素？', o:['河豚毒素','蜂毒','蛇毒','沒有任何毒'], a:0, why:'藍環章魚的唾液含有河豚毒素，毒性非常強。' },
        { q:'在潮池看到漂亮的小章魚，正確的做法是？', o:['保持距離觀察，不要用手碰','抓起來帶回家','用手戳戳看','放進口袋'], a:0, why:'沒見過的海洋生物可能有毒，不用手碰是海邊最重要的安全規則。' },
        { q:'藍環章魚大約有多大？', o:['跟手掌差不多大','跟人一樣大','跟汽車一樣大','比螞蟻還小'], a:0, why:'藍環章魚體型很小，只有手掌大，所以常被人小看。' },
        { q:'章魚有幾隻腕足？', o:['8 隻','6 隻','10 隻','4 隻'], a:0, why:'章魚有 8 隻腕足，英文 octopus 的 octo 就是「八」。' },
        { q:'章魚屬於哪一類動物？', o:['軟體動物','魚類','甲殼類','哺乳類'], a:0, why:'章魚和貝類、烏賊一樣是軟體動物（頭足類）。' },
        { q:'台灣哪裡的潮池偶爾看得到藍環章魚？', o:['東北角、墾丁','合歡山','日月潭','台北盆地中央'], a:0, why:'藍環章魚住在溫暖的淺海礁岩，台灣東北角和墾丁的潮池偶爾看得到。' },
        { q:'章魚遇到危險時常用什麼方法逃走？', o:['噴出墨汁擋住敵人視線','裝死不動','大聲叫','長出翅膀飛走'], a:0, why:'章魚會噴墨汁形成一團黑霧，趁敵人看不清楚時溜走。' },
        { q:'去潮池觀察生物，下列哪一個是好習慣？', o:['觀察完把翻開的石頭放回原位','把生物帶回家養','把垃圾留在潮池','踩在珊瑚上拍照'], a:0, why:'石頭底下是很多生物的家，看完放回原位，牠們才不會被太陽曬乾。' }
      ] },
    swallowtail: { n:'寬尾鳳蝶',   e:'🦋', type:'ctrl', sz:50, legend:true,
                   b:{ hp:44, atk:7, def:2, spd:11 }, g:{ hp:4.6, atk:0.62, def:0.30, spd:0.42 },
                   cmd:'scalepowder', talent:'蜜粉療癒:普通攻擊時恢復我方全體 10% 最大體力', tal:{ atkHealAllP:10 },
                   get:{ how:'legend', quest:'butterfly' },
                   sci:'寬尾鳳蝶是台灣特有的「國寶蝶」,後翅有寬寬的尾突。牠的幼蟲只吃台灣檫樹的葉子,檫樹變少,寬尾鳳蝶也跟著變少。蝴蝶翅膀上是一片片小鱗片,摸了會掉粉,所以看蝴蝶只用眼睛就好。',
                   food:'honey', quiz:[
        { q:'寬尾鳳蝶被大家稱作什麼？', o:['國寶蝶','國寶魚','國鳥','國花'], a:0, why:'寬尾鳳蝶是台灣特有又稀有的蝴蝶，被稱為「國寶蝶」。' },
        { q:'寬尾鳳蝶的幼蟲只吃哪一種植物的葉子？', o:['台灣檫樹','稻子','高麗菜','榕樹'], a:0, why:'寬尾鳳蝶幼蟲只吃台灣檫樹的葉子，沒有檫樹就長不大。' },
        { q:'寬尾鳳蝶的名字是怎麼來的？', o:['後翅有寬寬的尾突','身體特別寬','翅膀是方形的','尾巴會發光'], a:0, why:'牠的後翅有一段寬寬的尾突，所以叫「寬尾」鳳蝶。' },
        { q:'蝴蝶的一生要經過哪四個階段？', o:['卵→幼蟲→蛹→成蟲','卵→成蟲','幼蟲→成蟲→蛹→卵','蛹→卵→成蟲→幼蟲'], a:0, why:'蝴蝶從卵孵出幼蟲，幼蟲化蛹，最後羽化成蝴蝶。' },
        { q:'要經過卵、幼蟲、蛹、成蟲四個階段的昆蟲，叫做什麼？', o:['完全變態','不完全變態','沒有變態','冬眠'], a:0, why:'多了「蛹」這個階段，叫做完全變態；蝗蟲、蟬沒有蛹，是不完全變態。' },
        { q:'摸了蝴蝶翅膀，手上會沾到粉，那些粉其實是？', o:['翅膀上的小鱗片','花粉','灰塵','蝴蝶的汗'], a:0, why:'蝴蝶翅膀上覆蓋著一片片細小的鱗片，一摸就會掉。' },
        { q:'成蝶主要怎麼進食？', o:['用捲起來的口器吸花蜜','啃樹皮','吃小蟲','喝海水'], a:0, why:'蝴蝶的口器像一根捲起來的吸管，要吃時才伸直吸花蜜。' },
        { q:'為什麼寬尾鳳蝶變得越來越少？', o:['幼蟲的食草台灣檫樹變少了','天敵太少','天氣太冷','牠們搬去國外'], a:0, why:'台灣檫樹被砍伐、棲地變少，寬尾鳳蝶的幼蟲就沒有東西吃。' },
        { q:'看到野外的蝴蝶，最好的欣賞方式是？', o:['只用眼睛看，不要抓或摸','抓起來做標本','用網子捕回家','拔掉翅膀觀察'], a:0, why:'翅膀鱗片掉了會影響飛行，只用眼睛欣賞對蝴蝶最友善。' },
        { q:'蝴蝶在花叢間飛來飛去，幫花朵做了什麼重要的事？', o:['幫忙傳播花粉','吃掉花瓣','把花弄枯','幫花澆水'], a:0, why:'蝴蝶吸花蜜時身上沾到花粉，帶到下一朵花，幫植物傳粉結果。' }
      ] }
  };
  D.PET_ORDER = ['bear','owl','gull','deer','leopardcat','bluemagpie','eagle','pangolin','turtle','coconutcrab','treefrog','firefly','salmon','macaque','spoonbill','barbet','cloudleopard','bluering','swallowtail'];   /* ★ v1.331.0 +3 位 🌈 傳說夥伴(放最後;下方 bt_pet_/walk/sleep 圖鍵迴圈會自動登記,圖片全部選配,缺圖退 emoji) */
  /* ★ v1.318.0 老師「梅花鹿圖片尺寸放大20%;石虎、海鷗小白縮小10%;莫氏樹蛙、螢火蟲縮小20%」— 寵物圖片顯示倍率(沒列的 = 1)。
  ...
  D.PET_RECRUIT_LEGEND = { quizPick:10, quizPass:9, retryNextDay:1 };   /* ★ v1.331.0 🌈 傳說夥伴:10 題全考、答對 9 題;沒過不扣東西,當天不能再考(ISL.legend.quizDay) */
  ...
  D.SK_CMDS = {
    ...
    CMD_CALL:      { n:'呼喚夥伴', e:'📣', ap:1, where:'battle', d:'讓體力最低的一位隊友立刻完全恢復體力',           sci:'夥伴聽到熟悉的呼喚聲會立刻放下戒心、全力照顧你,安心感能讓身體更快進入修復狀態。' },   /* ★ v1.297.0 老師「呼喚夥伴效果改成完全恢復1名隊友的HP」— 20% → 100%,d/sci 同步修正(sci 原本講「動物能分辨熟悉的聲音」跟治療效果搭不起來,改寫成能呼應「呼喚→全力照顧→加速恢復」這個因果的說法);★ v1.165.0 由 both 改 battle:野外沒有隊友單位可以治療(隊友每場戰鬥才建立),掛在野外會變成按了沒反應的死按鈕 */
    CMD_RALLY:     { n:'鼓舞號令', e:'⚡', ap:2, where:'battle', d:'全隊攻擊 +25%,持續 3 回合',                          sci:'一起喊口號會讓人動作更同步,這叫「節律同調」。' },
    CMD_REST:      { n:'野外小憩', e:'🔥', ap:3, where:'field', once:'day', d:'在野外原地生火休息,全隊(自己+隊友)體力全滿、解除所有不利狀態(每天限用 1 次)', sci:'休息時身體會把血糖轉回肌肉裡的肝醣,這就是「恢復」;充足的休息也是免疫系統對抗發炎、加速痊癒最重要的一步。' }   /* ★ v1.324.0 老師「天賦節點－野外小憩 效果改成 恢復全隊100%的HP並解除所有不利狀態(每天限用一次)」— 30%小補改成滿血+全解不良狀態的關鍵恢復手段,代價是每天只能用一次(ap 照舊 3);新增 once:'day' 通用旗標,index islCmdUse/islCmdField 讀這個旗標決定要不要擋用過的按鈕,以後其他指令要做「每天一次」直接比照掛這個欄位即可,不必再各自寫一顆專用旗標 */
  };
  ...
  (function(){
    var L = [
      ...
      { k:'hornet', n:'虎頭蜂兵', e:'🐝', race:'insect', tag:'fly', tool:'smoke', zone:'森林',
        bt:{ hp:22, atk:7, def:1, spd:8, crit:10, drop:{ shell:[2,4], item:'honey', p:0.5 }, d:'成群巡邏的大黃蜂,尾針很毒。' },   /* ★ v1.241.0 新手難度:森林是第一個會戰鬥的區域,這隻原本攻擊 9、暴擊 15% 是全森林最痛的一隻(比野豬還高),下修到與野豬/鐵甲蟲同級距(攻擊 7、暴擊 10%) */
...
(function(){
  ...
  D.LOG.unshift({ v: 'v1.304.0', d: '2026-09-22', items: [
    '💇 修好跑步時頭髮會一塊一塊變色的問題,跑步、跳躍的髮色現在跟走路時一樣。',
    '🏃 側面跑步的動作變快一倍,看起來更像在跑;正面、背面維持原本速度。'
  ] });
  D.LOG.unshift({ v: 'v1.300.0', d: '2026-09-21', items: [
    '🌟 天賦星盤新增很多小節點!每個武器星域、生活技藝、醫療三條路線、特殊指令,節點與節點之間都多了一顆小節點,點亮就能拿到一點點固定加成(最大體力/攻擊/防禦/速度/暴擊率/跑速/治療量/異常狀態抵抗/閃避減傷),依每條路線的專長分配。',
    '🥋 特殊指令路線新增「閃避減傷」:一般閃避(沒點滿的那種)受到的傷害會再減少一些,完美閃避本來就是完全不受傷,不受影響。',
    '📖 天賦星盤「更多說明」視窗中間新增兩份清單:目前已經點亮的節點帶來哪些狀態收益、以及已經解鎖了哪些特殊指令,一次看清楚不用逐顆點開查。'
  ] });
  /* ★ v1.317.0 馴獸專精星域(本檔慣例:新版一律用檔尾 D.LOG.unshift,改上方初值陣列會被蓋掉) */
  D.LOG.unshift({ v: 'v1.317.0', d: '2026-09-23', items: [
    '🐾 天賦星盤新增第 9 條路線「馴獸專精星域」!在星盤正上方,從中央新的「馴獸之心」出發,一開始就能點。',
    '💪 一路點下去,所有寵物的體力、攻擊、防禦、速度都會變強;「心有靈犀」讓寵物技能計量集得更快,開戰就先有一截。',
    '🔀 中段二選一:🐯「猛獸本能」讓寵物更會打(攻擊+暴擊),🐢「守護本能」讓寵物更耐打(防禦+體力+減傷)。後面再接「狂野連擊」(技能傷害 +25%)或「療癒羈絆」(技能治療/護盾 +25%)。',
    '🌟 關鍵節點「羈絆守護」:每隻寵物每場戰鬥第一次被打倒時會咬牙撐住、保留 1 點體力;點亮還能拿到頭銜「🐾 馴獸大師」。',
    '👑 精通「萬獸之王」要用 🦷鐵牙獠牙 ×2(打倒森林的鐵牙山豬王取得):寵物技能冷卻 −1 回合,四項能力再 +5%。'
  ] });
  D.LOG.unshift({ v: 'v1.318.0', d: '2026-09-23', items: [
    '🐸 莫氏樹蛙的「露水迷霧」變強了:全隊接下來 3 回合,每回合恢復 15% 體力(原本 6%),冷卻一樣是 4 回合。',
    '📏 寵物大小重新調整,更接近真實比例:梅花鹿變大一點,石虎、海鷗小白稍微變小,莫氏樹蛙和螢火蟲再小一些(營地和戰鬥畫面)。'
  ] });
  D.LOG.unshift({ v: 'v1.321.0', d: '2026-09-24', items: [
    '🦉 領角鴞天賦改版:攻擊敵人時有 40% 機率讓對方「失明」,接下來 1 回合命中率 −50%。',
    '🐟 櫻花鉤吻鮭天賦改版:普通攻擊會順便治療隊上血量最低的隊友(15%);自己倒下時,拚盡全力讓全隊恢復 60% 體力(倒下的夥伴也能因此復活)。技能「清流一躍」加強:立刻回 40% 體力,接下來 3 回合再各回 10%。',
    '🎨 五色鳥天賦改版:普通攻擊變成連續 2 次;自己受傷時,技能冷卻會縮短 1 回合。技能「啄木聲波」加強:敵方全體 1 回合內無法使用技能(只能普通攻擊),而且這回合造成的傷害降低 30%。',
    '🐸 莫氏樹蛙天賦加強:雨天或颱風天的治療效果從 +25% 大幅提升到 +100%,而且超過血量上限的部分會轉換成護盾,不再浪費。',
    '🦌 梅花鹿技能「還魂草藥」改版:改成用 80% 最大體力治療 1 位隊友,對象如果已經倒下就直接復活(不再只能復活)。',
    '💰 櫻花鉤吻鮭、五色鳥的商店解鎖價格調整為 500 貝。'
  ] });
  D.LOG.unshift({ v: 'v1.322.0', d: '2026-09-24', items: [
    '🏖 修正:從傳送點回到大地圖後,同一天再點沙灘(或其他區域)會馬上被送回大地圖、進不去的問題。'
  ] });
  D.LOG.unshift({ v: 'v1.323.0', d: '2026-09-24', items: [
    '🧭 選隊友改成直接打開夥伴圖鑑,可以用類型(含好友)篩選、依等級/HP/攻擊/防禦/速度/親密度排序。',
    '💊 受傷休息的夥伴,名字下面就有小小的「復活」按鈕。',
    '🗺 大地圖每個區域名字旁邊會顯示探索度 %。',
    '👣 腳程改成靠「跑步、逃跑、完美閃避」來練;捕魚改練巧手、馴養改練巧思。能力頁點四維可以看到每一維的所有練法。',
    '🌟 修正天賦星盤:醫療星域一定要照連線依序點,不能再跳過前面的節點;之前跳著點的會退回點數。'
  ] });
  D.LOG.unshift({ v: 'v1.324.0', d: '2026-09-24', items: [
    '🌟 點天賦節點時,說明/確認視窗改成小視窗疊在星盤上面,星盤不會被整個蓋掉,關掉視窗也不用重新打開星盤。',
    '⚔ 戰鬥中連續多段攻擊(例如石虎的二段爪擊)的傷害數字,改成每段間隔 0.3 秒才跳出來,不會全部疊在一起看不清楚。',
    '🔥 天賦節點「野外小憩」大加強:改成全隊(自己+隊友)體力回滿、解除所有不利狀態、休息中的夥伴也能恢復精神,不過每天只能用 1 次。'
  ] });
  D.LOG.unshift({ v: 'v1.325.0', d: '2026-09-24', items: [
    '💊 治療型寵物(海鷗小白/梅花鹿/莫氏樹蛙/螢火蟲/櫻花鉤吻鮭)自動放技能改聰明一點:大家都健康的時候不會亂放,有人體力低於 70% 才治療、有人倒下優先復活、身上有不良狀態優先解除。',
    '⚔ 戰鬥受傷數字補上護盾/減傷資訊:被護盾擋掉一部分,會顯示「原本傷害(擋下多少)」;有減傷 %,會顯示「原本傷害(減傷多少 %)」,看得出真正扣了多少血。'
  ] });

  /* ══════════════════════════════════════════════════════════════════════════
   * ★ v1.331.0(2026-09-25・老師「根據企劃書完成新的寵物和寵物專用裝備」)
   *   企畫書《荒島求生｜傳說夥伴 ×3 ＋ 夥伴專用裝備 ×10》Phase 0 定案內容正式實作。
   *   index 端出口(只准從這幾支讀,不要散讀本區資料):
   *     islLegend*        → 三條科學調查任務(面板/換日判定/遭遇)
   *     islPetGearEff(u,k) → 戰鬥單位 u 身上夥伴裝備的效果值(已折品質加成)
   *     islPetGearStatEff(k,key) → 寵物鍵 k 的裝備效果(給 islPetStats 四維用)
   *   ⚠ 本區註解嚴禁出現「星號+斜線」字樣(v1.227.0 教訓)。
   * ══════════════════════════════════════════════════════════════════════════ */

  /* ── 魔物新狀態:中毒/混亂(傳說夥伴帶進來的新戰鬥機制)──
     poisonBossMul:地圖頭目中毒扣血倍率(減半);confuseBossHitDownP/Dur:頭目免疫混亂,改成命中下降 N% 持續 N 回合(走既有失明 blindT 那套「打偏」判定)。 */
  D.MON_ST = { poisonBossMul:0.5, confuseBossHitDownP:30, confuseBossDur:2 };

  /* ── 🌈 傳說夥伴調查任務 ──
     minPets:已招募夥伴數門檻;三條任務的進度全部存在 ISL.legend(雲端存檔,換裝置不重來)。 */
  D.LEGEND = {
    minPets: 15,   /* ★ v1.339.0 老師「傳說夥伴募集條件改成 已招募15位夥伴」— 8→15(一般夥伴共 16 位:4 NPC+10 馴養+2 商店,15 = 只差 1 位就全收)。index 端 islLegendOn/圖鑑取得方式/調查面板三處都讀這個值,單一真相只改這裡 */
    camera: { pet:'cloudleopard', n:'紅外線自動相機調查', e:'📷', tech:'circuit',
              item:{ n:'自動相機', e:'📷', cost:{ ore:3, crystal:1, core_spark:1, fiber:4 } },
              zones:['forest','cliff','valley'], p:8, pRain:12, meetZone:'cliff',
              d:'在森林、懸崖、山谷各架一台自動相機。每天換日時,每台相機有 8% 機率拍到雲豹(雨天 12%)。三區都拍到之後,下一個雨天進懸崖區就會遇到牠。',
              sci:'研究人員就是用紅外線自動相機調查野生動物——動物經過時,體溫觸發感應器,相機自己按快門,人不用守在森林裡。' },
    tidepool:{ pet:'bluering', n:'潮池安全觀察', e:'🪣', puzzle:'rock', boss:'rock', zone:'rock', p:6,
              d:'解開岩岸的「潮池」謎題並打倒巨螯椰子蟹王後,每天第一次在岩岸採集時,有 6% 機率在潮池發現藍環章魚。遇到時要選對做法!',
              sci:'在野外看到沒見過的海洋生物,不用手碰,是海邊最重要的安全規則。',
              choices:[ { k:'hand',   t:'✋ 用手抓起來', ok:false, r:'章魚身上的藍環突然一閃一閃——牠噴出一團墨汁逃走了!幸好沒被咬到。藍環章魚的毒很強,在海邊看到漂亮的小章魚,千萬不要用手碰。今天牠不會再出現了。' },
                        { k:'bucket', t:'🪣 用水桶連海水舀起來', ok:true, r:'你小心地連海水一起舀起來,完全沒有碰到牠。章魚在水桶裡慢慢放鬆下來。' },
                        { k:'watch',  t:'👀 保持距離先觀察', ok:true, r:'你蹲在旁邊靜靜觀察,章魚發現你沒有惡意,慢慢爬到你附近的石頭上。' } ] },
    butterfly:{ pet:'swallowtail', n:'種樹養蝶,看完整變態', e:'🌱', treeBoss:'valley', growDays:6, layP:25, stageDays:2,
              stages:[ { k:'egg', n:'卵', e:'🥚' }, { k:'larva', n:'幼蟲', e:'🐛' }, { k:'pupa', n:'蛹', e:'🫘' }, { k:'adult', n:'成蝶', e:'🦋' } ],
              pests:[ { n:'小鳥', e:'🐦' }, { n:'寄生蜂', e:'🐝' } ],
              d:'打倒山谷頭目「熔甲蟲王」後,阿獺會賣台灣檫樹苗。種在營地照顧 6 天長成大樹,之後每天 25% 機率有寬尾鳳蝶來產卵,接著依序看到卵→幼蟲→蛹→成蝶(每階段 2 天)。幼蟲期每天都要趕走一次天敵,漏掉一天就得重來。',
              sci:'蝴蝶是「完全變態」昆蟲,要經過卵、幼蟲、蛹、成蟲四個階段;毛毛蟲和蝴蝶長得完全不一樣,吃的東西也不同。' }
  };
  D.LEGEND_ORDER = ['camera', 'tidepool', 'butterfly'];

  /* 阿獺上架台灣檫樹苗(legendTree:只在打倒山谷頭目後、還沒種過樹、寬尾鳳蝶還沒加入時出現;只能買 1) */
  D.SHOP.buy.push({ id:'sassafras', n:'台灣檫樹苗', e:'🌱', price:{shell:60}, legendTree:true, give:{kind:'legendTree'},
                    d:'寬尾鳳蝶的幼蟲只吃台灣檫樹的葉子。種在營地照顧 6 天,就會長成讓蝴蝶產卵的大樹。' });

  /* 自然圖鑑:傳說夥伴加入時由既有 islPetGet→islCodexAdd(k) 自動收錄 */
  D.CODEX.push({ id:'cloudleopard', cat:'animal', n:'台灣雲豹', e:'🐆', img:'bt_pet_cloudleopard_idle', where:'懸崖(傳說)', d:'台灣原生的大型貓科動物,2013 年宣布在台灣野外滅絕;身上的雲狀斑塊是牠名字的由來。' });
  D.CODEX.push({ id:'bluering',     cat:'animal', n:'藍環章魚', e:'🐙', img:'bt_pet_bluering_idle',     where:'岩岸潮池(傳說)', d:'只有手掌大,藍環是警告色;唾液含河豚毒素,看到千萬不要用手碰。' });
  D.CODEX.push({ id:'swallowtail',  cat:'animal', n:'寬尾鳳蝶', e:'🦋', img:'bt_pet_swallowtail_idle',  where:'營地檫樹(傳說)', d:'台灣特有的國寶蝶,幼蟲只吃台灣檫樹葉,經過卵、幼蟲、蛹、成蟲的完全變態。' });

  /* ── 🐾 夥伴專用裝備 ×10 ──
     每位夥伴 1 件、裝備跟著夥伴走;沿用護甲的拖曳零件組裝(parts)+ ★ 品質(效果 ×(1 + D.ARMOR_QUAL × (★−1)))。
     hand:true = 不需要製作台;req.bosses = 必須打倒過這些區的地圖頭目才能製作(清單鎖灰並提示)。
     eff 效果鍵(index 端 islPetGearEff 單一出口):
       atkP/defP/hpP 四維%・spdAdd/defAdd 平加・critC 普攻暴擊率・dodgeAddP 被攻擊時額外迴避・regenP 每回合開頭回自身%
       ailResistP 不利狀態抗性(暈眩/麻痺/變慢/燒燙,上限 80)・cleanseOnce 每場第一次被施加不利狀態自動解除
       gaugeAddP 技能計量充能 +%・skillPowP 專屬指令 fx 數值 +%・cdCut 專屬指令冷卻 −N(最少 1)
       turnShieldP 每回合開頭給自身 N% 最大體力護盾・shieldRecvP 獲得護盾量 +%・bossDmgP 對地圖頭目傷害 +%
       gutsOnce 每場第一次被擊倒保留 1 體力・dmgHalfP 受到傷害時 N% 機率減半。
     FLAT 內的鍵是旗標/回合數,不吃品質加成。 */
  D.PET_GEAR_FLAT = { cleanseOnce:1, gutsOnce:1, cdCut:1 };
  D.PET_GEAR_CAP = { ailResistP:80, dodgeAddP:50, dmgHalfP:60, critC:60 };
  D.PET_GEAR = [
    { id:'pg_collar',  n:'纖維項圈',     e:'🌿', tier:1, hand:true, sell:8,
      cost:{ fiber:8, shell:5, pebble:3 }, eff:{ atkP:10, critC:20 }, d:'攻擊 +10%,普攻暴擊率 +20%',
      sci:'一根纖維很容易斷,搓成繩子後很多根一起出力,就很牢固;磨尖的卵石邊緣特別容易咬進縫隙。',
      parts:[ {k:'rope', n:'項圈繩', need:'fiber', hint:'纖維搓成繩,很多根一起出力才牢固', e:'🌿'}, {k:'clasp', n:'亮面貝扣', need:'shell', hint:'挑一片又亮又硬的貝殼當扣環', e:'🐚'}, {k:'spike', n:'尖角石片', need:'pebble', hint:'磨尖的卵石邊緣容易咬進縫隙', e:'⚪'} ] },
    { id:'pg_leafmail', n:'月桃葉貝甲',  e:'🍃', tier:1, hand:true, sell:8,
      cost:{ leaf:8, shell:6, fiber:4 }, eff:{ defP:10, ailResistP:20 }, d:'防禦 +10%,不利狀態抗性 +20%',
      sci:'葉子一層層疊起來,撞擊的力量會被分散;月桃葉本身有特殊香氣,古人也用它包粽子防潮防蟲。',
      parts:[ {k:'body', n:'葉甲', need:'leaf', hint:'大片的月桃葉一層層疊起來', e:'🍃'}, {k:'plate', n:'貝殼補強片', need:'shell', hint:'硬貝殼縫在最容易被咬的地方', e:'🐚'}, {k:'tie', n:'綁繩', need:'fiber', hint:'纖維搓成繩綁緊', e:'🌿'} ] },
    { id:'pg_featherring', n:'羽毛腳環', e:'🪶', tier:1, hand:true, sell:8,
      cost:{ feather:8, reed:6, fiber:3 }, eff:{ spdAdd:5, dodgeAddP:20 }, d:'速度 +5,被攻擊時迴避率 +20%',   /* ★ v1.333.0 老師採建議③:+10→+5(初階裝備,夥伴 Lv1 速度只有 2~11) */
      sci:'鳥的羽毛又輕又有空氣層,是大自然最輕的材料之一,戴上腳步特別輕盈。',
      parts:[ {k:'ring', n:'環圈', need:'reed', hint:'中空的蘆葦又輕又能彎成圈', e:'🎋'}, {k:'deco', n:'羽飾', need:'feather', hint:'最輕的材料就是羽毛', e:'🪶'}, {k:'tie', n:'綁繩', need:'fiber', hint:'把羽毛綁牢在環上', e:'🌿'} ] },
    { id:'pg_shellguard', n:'貝殼護片',  e:'🐚', tier:1, hand:true, sell:10,
      cost:{ shell:10, wood:6, water:2 }, eff:{ hpP:10, regenP:5 }, d:'最大體力 +10%,每回合恢復自身 5% 最大體力',
      sci:'貝殼是碳酸鈣做的,又硬又是弧形,攻擊會被「滑開」;潮濕的內襯能讓傷口好得比較快。',
      parts:[ {k:'plate', n:'貝甲片', need:'shell', hint:'弧形的貝殼能把攻擊滑開', e:'🐚'}, {k:'frame', n:'木框', need:'wood', hint:'撐住貝殼不變形', e:'🪵'}, {k:'wet', n:'保水層', need:'water', hint:'保持潮濕,傷口好得快', e:'💧'} ] },
    { id:'pg_honeyjar', n:'蜂蜜小陶罐',  e:'🍯', tier:2, hand:false, sell:25,
      cost:{ honey:5, stone:4, water:3, crystal:1 }, eff:{ healP:30, gaugeAddP:25 }, d:'使用治療技能時治療量 +30%,技能計量充能速度 +25%',   /* ★ v1.333.0 老師:regenP:10(每回合回自身 10%)→ healP:30(治療技能治療量 +30%;index islBtPetCmdFx 只放大 heal/healAll/healRevive/revive/regenAll) */
      sci:'蜂蜜的糖分很高、水分很少,細菌很難生長,所以放很久都不會壞,是最古老的天然「能量補給品」。',
      parts:[ {k:'jar', n:'陶罐', need:'stone', hint:'石頭磨粉加水捏成土罐', e:'🪨'}, {k:'fill', n:'蜂蜜', need:'honey', hint:'糖分高、不容易壞的能量', e:'🍯'}, {k:'chip', n:'共鳴晶片', need:'crystal', hint:'小小一片水晶嵌在罐口', e:'💎'} ] },
    { id:'pg_herbsachet', n:'草藥香包',  e:'🍀', tier:2, hand:false, sell:25,
      cost:{ herb:6, herb_essence:2, fiber:4 }, eff:{ cleanseOnce:1, ailResistP:40, healRecvP:25 }, d:'每場第一次被施加不利狀態時自動解除;不利狀態抗性 +40%;受到治療時恢復量 +25%',   /* ★ v1.333.0 老師新增 healRecvP:25(index islBtHealRecv) */
    ...
    { id:'pg_ember',   n:'火精護符',     e:'🔥', tier:2, hand:false, sell:35,
      cost:{ core_ember:3, relic:2, stone:5 }, eff:{ turnShieldP:10, shieldRecvP:25 }, d:'每回合開頭給自身 10% 最大體力的護盾,獲得的護盾量 +25%',
      sci:'石頭導熱慢,能把熱留住,所以古人用石頭圍住火堆;三枚火精核心疊起來,護盾更厚實。',
      parts:[ {k:'base', n:'石座', need:'stone', hint:'石頭導熱慢,把熱留住', e:'🪨'}, {k:'core', n:'火精', need:'core_ember', hint:'三枚火精核心疊起來', e:'🔴'}, {k:'rune', n:'古紋', need:'relic', hint:'照遺物上的紋路刻', e:'🏺'} ] },
    { id:'pg_fang',    n:'獸王之牙',     e:'🦷', tier:3, hand:false, sell:120,
      cost:{ boss_mudheart:1, boss_clawshell:2, boss_batfeather:1, boss_thunderplume:1, ore:5 }, req:{ bosses:['river','rock','cave','cliff'] },
      eff:{ atkP:15, spdAdd:10, critC:25, bossDmgP:15 }, d:'攻擊 +15%,速度 +10,普攻暴擊率 +25%,對地圖頭目傷害 +15%',
      sci:'肉食動物的犬齒又尖又長,是用來咬住獵物的工具;集齊洪流泥王、巨螯椰子蟹王、霧湖蝠后、雷鳴怪鳥四位頭目的素材,才做得出「集眾獸之力」的牙飾。',
      parts:[ {k:'claw', n:'主爪', need:'boss_clawshell', hint:'巨螯碎殼最堅硬', e:'🦀'}, {k:'inlay', n:'鑲件', need:'boss_mudheart', hint:'泥王之心、蝠后之羽、雷鳴羽鑲在一起', e:'🟤'}, {k:'chain', n:'鍊子', need:'ore', hint:'鐵鍊才撐得住重量', e:'🟫'} ] },
    { id:'pg_magma',   n:'熔心勇氣徽章', e:'🌋', tier:3, hand:false, sell:200,
      cost:{ boss_lavaheart:1, boss_gorgonscale:1, boss_shadowgem:1, crystal:3, relic:3 }, req:{ bosses:['ruins','lake','volcano'] },
      eff:{ hpP:15, defP:15, gutsOnce:1, dmgHalfP:30 }, d:'最大體力 +15%,防禦 +15%;每場第一次被擊倒時保留 1 體力;受到傷害時 30% 機率傷害減半',   /* ★ v1.333.0 老師採建議②:defAdd:10(固定)→ defP:15(%),最貴的裝備對坦克才划算 */
      sci:'火山熔岩冷卻後會變成堅硬的岩石,台灣的澎湖玄武岩就是這樣形成的;巨像熔心要先打倒石化蛇后、深淵影魔,最後在火山擊敗熔岩巨像才能集齊。',
      parts:[ {k:'base', n:'徽章底', need:'boss_gorgonscale', hint:'蛇后鱗和深淵影晶當底座', e:'🐍'}, {k:'heart', n:'心核', need:'boss_lavaheart', hint:'全島最強頭目的熔心', e:'❤️‍🔥'}, {k:'gem', n:'鑲嵌', need:'crystal', hint:'三顆水晶圍一圈', e:'💎'} ] }
  ];
  D.petGear = function(id){ var i; for(i = 0; i < D.PET_GEAR.length; i++){ if(D.PET_GEAR[i].id === id) return D.PET_GEAR[i]; } return null; };
  /* ★ v1.333.0 修正:老師上傳的檔名是 island_pgear_<英文名>.png,舊碼自動拼成 island_pg_<id>.png(如 island_pg_fang.png)全部 404 ⇒ 十件圖從未顯示。
     改成逐件對照表(2026-09-25 逐一對 GitHub raw 驗過 9 件 200;月桃葉貝甲 leafmail 尚未找到上傳檔,先預留此檔名) */
  D.PET_GEAR_IMG = { pg_collar:'collar', pg_leafmail:'leafmail', pg_featherring:'featherring', pg_shellguard:'shellguard', pg_honeyjar:'honeyjar',
                     pg_herbsachet:'herbsachet', pg_chime:'crystalchime', pg_ember:'emberamulet', pg_fang:'beastfang', pg_magma:'magmabadge' };
  (function(){ var i, g; for(i = 0; i < D.PET_GEAR.length; i++){ g = D.PET_GEAR[i]; D.IMG[g.id] = 'island_pgear_' + (D.PET_GEAR_IMG[g.id] || g.id) + '.png'; } })();   /* 圖片 512×512 透明底,缺圖退 emoji */
  D.IMG.ui_petgear = D.IMG.ui_petgear || 'island_ui_petgear.png';
  D.IMG.ui_legend = D.IMG.ui_legend || 'island_ui_legend.png';

  /* 戰鬥特效(沿用既有 GIF,零新素材) */
  if(D.BT_FX){
    D.BT_FX.petCmd = D.BT_FX.petCmd || {}; D.BT_FX.petAtk = D.BT_FX.petAtk || {};
    D.BT_FX.petCmd.cloudpounce = { c:'集中效果線.gif', t:'斬擊.gif', s:'sfx-slash' };
    D.BT_FX.petCmd.bluebite    = { t:'紫光籠罩吸收.gif', s:'sfx-darkness', v:0.35 };
    D.BT_FX.petCmd.scalepowder = { c:'花瓣飛起.gif', t:'閃亮.gif', s:'sfx-imprison-burst' };
    D.BT_FX.petAtk.cloudleopard = { t:'斬擊.gif' };
    D.BT_FX.petAtk.bluering     = { t:'水球攻擊.gif', tz:0.7 };
    D.BT_FX.petAtk.swallowtail  = { t:'閃亮.gif', tz:0.7 };
  }

  D.LOG.unshift({ v: 'v1.331.0', d: '2026-09-25', items: [
    '🌈 新增三位傳說夥伴:🐆 台灣雲豹(全體攻擊)、🐙 藍環章魚(中毒)、🦋 寬尾鳳蝶(讓魔物混亂打自己人)。招募夥伴滿 8 位後,到 🏕 營地 →「🌈 傳說夥伴調查」開始三條科學調查任務。',
    '📷 雲豹:做自動相機架在森林、懸崖、山谷;🪣 藍環章魚:岩岸潮池安全觀察;🌱 寬尾鳳蝶:種台灣檫樹,看卵→幼蟲→蛹→成蝶。傳說夥伴的問答是 10 題要答對 9 題。',
    '🐾 新增 10 件夥伴專用裝備:👤 角色 →「🐾 夥伴裝備」,用島上材料組裝,每位夥伴可以戴 1 件;後期的獸王之牙、熔心勇氣徽章要打倒多位地圖頭目才做得出來。',
    '⚔ 新戰鬥狀態:☠ 中毒(魔物每回合扣血)、💫 混亂(魔物攻擊自己的同伴);地圖頭目中毒減半、不會混亂(改成命中下降)。',
    '🦉 修正:領角鴞的「失明」天賦之前一直沒有真正生效,現在失明的魔物攻擊會有一半打偏。'
  ] });
  D.LOG.unshift({ v: 'v1.332.0', d: '2026-09-25', items: [
    '🌾 修正:農田作物的名字一直顯示成「3」(種下、收成、農田詳情都是),現在會正確顯示「野果」「小米」。',
    '💤 補回營地寵物「隨機打盹」:每分鐘每隻寵物有 33% 機率趴下來睡 1 分鐘,時間到自己醒來。'
  ] });

  /* ══════════════════════════════════════════════════════════════════════════
   * ★ v1.333.0(2026-09-25・老師五項+補充)— 阿獺每日商品輪替/每日裝飾/50 種新裝飾家具/小木屋室內四房間/縮放 20%~300%/前後圖層
   *   新欄位(全部選配,舊裝飾沒寫就吃預設):
   *     p   = 商店價(貝幣);賣出一律 floor(p/2)。舊裝飾的價寫在 D.DECO_PRICE。
   *     z   = 預設圖層 1~9(數字大的蓋住數字小的;主角與夥伴固定 10)。沒寫:設施 4、裝飾 5。
   *     sz  = 營地基礎大小倍率(1 = 舊裝飾的 56px 圖示);室內另夾上限 D.CABIN.furSzMax。
   *     out = 只能擺在戶外(水池/噴泉/樹…),不能搬進小木屋。
   *     uniq= 全島只能有 1 個(小木屋)。
   *     shop= 不能自己做,只能等阿獺「今日裝飾」上架(cost 空)。
   * ══════════════════════════════════════════════════════════════════════════ */
  D.DECO_PRICE = { pot:16, fence:16, lamp:24, rug:24, chime:24, flower:24, table:32, bed:40, statue:50,
                   koi:40, mirror:60, vase:70,
                   r_ash:40, r_ice:60, r_wetland:40, r_crystal:80, r_buoy:30, r_woodpile:30, r_sapling:40, r_lumber:20, r_petbed:40, r_banner:30, r_stonelamp:40, r_elamp:150 };
  D.DECO_DEF_Z = 5; D.BLD_DEF_Z = 4; D.CHAR_Z = 10;
  D.DECO_TAB_OUT = { fence:1, lamp:1, flower:1, chime:1, statue:1 };   /* 舊裝飾在裝飾面板歸「🌳 戶外」頁(沒有 out 旗標,仍可搬進小木屋) */
  D.DECO_SCALE_MIN = 0.2; D.DECO_SCALE_MAX = 3.0;
  D.decoPrice = function(id){ var i; for(i = 0; i < D.DECOS.length; i++){ if(D.DECOS[i].id === id) return D.DECOS[i].p || D.DECO_PRICE[id] || Math.max(10, (D.DECOS[i].comfort || 2) * 8); } return 10; };
  /* ★ v1.333.0 老師選「甲」:自己做得出來的東西(有 cost、非 shop),賣價 = min(半價, 材料回收價) ⇒ 做了再賣永遠不會賺。
     材料回收價 = Σ 材料數量 × 阿獺收購價(SHOP.sell);阿獺不收的稀有材料用 MAT_VAL 估值(只用來算這個上限,不能拿去賣)。 */
  D.MAT_VAL = { herb_essence:8, core_spark:15, core_ember:15,
                boss_mudheart:60, boss_clawshell:60, boss_batfeather:60, boss_thunderplume:60, boss_lavaheart:60, boss_gorgonscale:60, boss_shadowgem:60 };
  D.matValue = function(cost){ var k, v = 0, u; for(k in cost){ if(cost.hasOwnProperty(k)){ u = (D.SHOP.sell[k] != null) ? D.SHOP.sell[k] : (D.MAT_VAL[k] || 0); v += u * cost[k]; } } return v; };
  D.decoSell = function(id){ var i, d = null, half = Math.floor(D.decoPrice(id) / 2); for(i = 0; i < D.DECOS.length; i++){ if(D.DECOS[i].id === id){ d = D.DECOS[i]; break; } } if(d && !d.shop && d.cost){ var hasCost = false, k; for(k in d.cost){ if(d.cost.hasOwnProperty(k)) hasCost = true; } if(hasCost) return Math.max(1, Math.min(half, D.matValue(d.cost))); } return half; };
  /* ★ v1.333.0 老師「製作裝飾要花費 AP」:舒適 ≤3 ⚡1、≤6 ⚡2、更大 ⚡3;小木屋 ⚡5 */
  D.decoAp = function(id){ var i, d; if(id === 'cabin') return 5; for(i = 0; i < D.DECOS.length; i++){ if(D.DECOS[i].id === id){ d = D.DECOS[i]; return d.comfort <= 3 ? 1 : (d.comfort <= 6 ? 2 : 3); } } return 1; };

  /* ── 🌳 戶外 22 種(含小木屋)── */
  D.DECOS.push({ id:'cabin',     n:'小木屋',     e:'🏡', img:'deco_cabin',     comfort:10, p:320, z:4, sz:3.2, out:1, uniq:1, cost:{wood:40, stone:15, fiber:12, shell:10}, d:'木頭裡有很多小空隙藏著空氣,空氣不太會傳熱,所以木屋冬暖夏涼。點門口的「進入小木屋」可以進去擺家具。' });
  D.DECOS.push({ id:'pool',      n:'石砌水池',   e:'🟦', img:'deco_pool',      comfort:6,  p:90,  z:1, sz:2.2, out:1, cost:{stone:20, water:6},           d:'水池的水看起來比實際淺——光從水裡射出來時會「折射」偏轉。' });
  D.DECOS.push({ id:'fountain',  n:'貝殼噴泉',   e:'⛲', img:'deco_fountain',  comfort:8,  p:180, z:4, sz:2.0, out:1, shop:true, cost:{},              d:'水從高處流下來產生壓力,就能從低處的小孔噴上去。' });
  D.DECOS.push({ id:'lotuspond', n:'荷花池',     e:'🪷', img:'deco_lotuspond', comfort:6,  p:80,  z:1, sz:2.0, out:1, cost:{stone:10, water:8, seed:4},   d:'荷葉表面有細小的凸起,水珠滾一滾就帶走灰塵——叫「蓮葉效應」。' });
  D.DECOS.push({ id:'well',      n:'古井',       e:'🪣', img:'deco_well',      comfort:4,  p:60,  z:4, sz:1.6, out:1, cost:{stone:16, wood:6},            d:'雨水滲進土裡變成地下水,挖井就能把它打上來。' });
  D.DECOS.push({ id:'swing',     n:'樹下鞦韆',   e:'🌳', img:'deco_swing',     comfort:5,  p:60,  z:4, sz:2.0, out:1, cost:{wood:10, fiber:6},            d:'鞦韆是一種「擺」:繩子越長,來回一趟的時間越久。' });
  D.DECOS.push({ id:'hammock',   n:'吊床',       e:'🧶', img:'deco_hammock',   comfort:5,  p:55,  z:4, sz:1.8, out:1, cost:{fiber:12, wood:6},            d:'身體的重量被網子分散到很多條繩子上,躺起來就不痛。' });
  D.DECOS.push({ id:'stonepath', n:'石板步道',   e:'🪨', img:'deco_stonepath', comfort:2,  p:20,  z:1, sz:1.6, out:1, cost:{stone:8},                     d:'鋪了石板,下雨天走路就不會陷進泥巴裡。' });
  D.DECOS.push({ id:'woodbridge',n:'小木橋',     e:'🌉', img:'deco_woodbridge',comfort:3,  p:36,  z:2, sz:1.8, out:1, cost:{wood:12},                     d:'拱形的橋能把壓在上面的重量分散到兩端。' });
  D.DECOS.push({ id:'mailbox',   n:'木頭信箱',   e:'📮', img:'deco_mailbox',   comfort:2,  p:20,  z:5, sz:1.0, out:1, cost:{wood:5, shell:2},             d:'好友的信和禮物,就是從這裡來的。' });
  D.DECOS.push({ id:'scarecrow', n:'稻草人',     e:'🌾', img:'deco_scarecrow', comfort:3,  p:30,  z:5, sz:1.5, out:1, cost:{reed:8, wood:4, fiber:3},     d:'會隨風晃動的人形,讓小鳥以為有人在,不敢來偷吃種子。' });
  D.DECOS.push({ id:'birdhouse', n:'鳥屋',       e:'🐦', img:'deco_birdhouse', comfort:3,  p:30,  z:5, sz:1.3, out:1, cost:{wood:6, feather:2},           d:'洞口大小決定哪種鳥會住進來——太大的洞會被大鳥佔走。' });
  D.DECOS.push({ id:'logseat',   n:'圓木椅',     e:'🪵', img:'deco_logseat',   comfort:3,  p:24,  z:5, sz:1.1,         cost:{wood:8},                      d:'數一數木頭橫切面的年輪,就知道這棵樹活了幾年。' });
  D.DECOS.push({ id:'palm',      n:'椰子樹',     e:'🌴', img:'deco_palm',      comfort:4,  p:70,  z:5, sz:2.4, out:1, shop:true, cost:{},              d:'椰子殼裡有空氣又防水,能在海上漂好幾個月,漂到別的島發芽。' });
  D.DECOS.push({ id:'bamboo',    n:'竹叢',       e:'🎍', img:'deco_bamboo',    comfort:3,  p:30,  z:5, sz:2.0, out:1, cost:{reed:10, seed:2},             d:'竹子是草不是樹,有的一天就能長高好幾十公分。' });
  D.DECOS.push({ id:'lights',    n:'貝殼串燈',   e:'🎇', img:'deco_lights',    comfort:4,  p:45,  z:6, sz:1.8, out:1, cost:{shell:6, fiber:4, crystal:1},  d:'一顆顆小燈串在同一條線上,電流要一路流過每一顆。' });
  D.DECOS.push({ id:'sundial',   n:'日晷',       e:'🕰', img:'deco_sundial',   comfort:4,  p:45,  z:5, sz:1.3, out:1, cost:{stone:10, pebble:4},          d:'太陽在天空移動,影子跟著轉,看影子就知道幾點了。' });
  D.DECOS.push({ id:'windmill',  n:'小風車',     e:'🎡', img:'deco_windmill',  comfort:5,  p:60,  z:5, sz:2.0, out:1, cost:{wood:10, fiber:6, stone:4},   d:'風推動葉片旋轉,把風的能量變成轉動的能量。' });
  D.DECOS.push({ id:'flowerarch',n:'花拱門',     e:'💐', img:'deco_flowerarch',comfort:5,  p:55,  z:5, sz:2.0, out:1, cost:{wood:8, seed:4, fiber:4},     d:'爬藤植物會用捲鬚纏住支架,一路往上長去找陽光。' });
  D.DECOS.push({ id:'sandcastle',n:'沙堡',       e:'🏰', img:'deco_sandcastle',comfort:3,  p:40,  z:3, sz:1.6, out:1, shop:true, cost:{},              d:'乾沙堆不起來,加一點水,沙粒之間的水會把它們黏在一起。' });
  D.DECOS.push({ id:'picnic',    n:'野餐墊',     e:'🧺', img:'deco_picnic',    comfort:3,  p:24,  z:1, sz:1.6,         cost:{fiber:6},                     d:'格子布是經線和緯線一上一下交錯織成的。' });
  D.DECOS.push({ id:'telescope', n:'天文望遠鏡', e:'🔭', img:'deco_telescope', comfort:6,  p:150, z:5, sz:1.4,         shop:true, cost:{},              d:'兩片透鏡把遠方的光收集起來放大,月球上的坑洞都看得見。' });
  /* ── 🪑 室內家具 28 種(也可以擺在戶外)── */
  D.DECOS.push({ id:'sofa',      n:'藤編沙發',   e:'🛋', img:'deco_sofa',      comfort:5,  p:50,  z:5, sz:1.6, cost:{reed:10, fiber:6},             d:'藤條泡水變軟好彎,乾了之後就固定成形。' });
  D.DECOS.push({ id:'bookshelf', n:'書架',       e:'📚', img:'deco_bookshelf', comfort:4,  p:40,  z:4, sz:1.6, cost:{wood:10},                     d:'把漂流瓶裡撿到的書都排好,這裡就是島上的圖書館。' });
  D.DECOS.push({ id:'wardrobe',  n:'衣櫃',       e:'🚪', img:'deco_wardrobe',  comfort:4,  p:45,  z:4, sz:1.7, cost:{wood:12},                     d:'樟木會散發香氣,讓蠹蟲不敢靠近衣服。' });
  D.DECOS.push({ id:'dresser',   n:'梳妝台',     e:'🪞', img:'deco_dresser',   comfort:4,  p:45,  z:4, sz:1.4, cost:{wood:8, shell:4, crystal:1},  d:'水晶磨平當鏡子,光打在平滑的面上會反射回來。' });
  D.DECOS.push({ id:'desk',      n:'書桌',       e:'📝', img:'deco_desk',      comfort:3,  p:32,  z:5, sz:1.4, cost:{wood:8},                      d:'寫觀察日記的好地方:記下日期、天氣,還有看到什麼。' });
  D.DECOS.push({ id:'chair',     n:'木椅',       e:'🪑', img:'deco_chair',     comfort:2,  p:18,  z:6, sz:1.0, cost:{wood:4},                      d:'四隻腳一樣長才坐得穩——三隻腳的凳子在不平的地上反而更穩。' });
  D.DECOS.push({ id:'dining',    n:'長餐桌',     e:'🍽', img:'deco_dining',    comfort:4,  p:40,  z:5, sz:1.8, cost:{wood:10},                     d:'一起吃飯的人越多,桌子越要長。' });
  D.DECOS.push({ id:'stove',     n:'石爐灶',     e:'🍳', img:'deco_stove',     comfort:4,  p:50,  z:4, sz:1.4, cost:{stone:12, ore:2},             d:'石頭圍住火,熱不會一下子散掉,煮東西更省柴。' });
  D.DECOS.push({ id:'cupboard',  n:'碗櫃',       e:'🥣', img:'deco_cupboard',  comfort:3,  p:34,  z:4, sz:1.4, cost:{wood:8, stone:2},             d:'櫃門有細縫通風,碗盤才不會悶出霉味。' });
  D.DECOS.push({ id:'fireplace', n:'壁爐',       e:'🔥', img:'deco_fireplace', comfort:6,  p:70,  z:3, sz:1.8, cost:{stone:16, ore:2},             d:'熱空氣比較輕會往上跑,所以煙會自己從煙囪飄出去。' });
  D.DECOS.push({ id:'bunkbed',   n:'雙層床',     e:'🛏', img:'deco_bunkbed',   comfort:6,  p:60,  z:4, sz:1.8, cost:{wood:12, fiber:8, leaf:4},     d:'往上疊一層,同樣的地板面積就能睡兩個人。' });
  D.DECOS.push({ id:'rocker',    n:'搖椅',       e:'🪑', img:'deco_rocker',    comfort:4,  p:40,  z:5, sz:1.3, cost:{wood:8, fiber:3},             d:'椅腳是弧形的,重心一移動就會前後搖。' });
  D.DECOS.push({ id:'floorlamp', n:'立燈',       e:'🪔', img:'deco_floorlamp', comfort:3,  p:36,  z:6, sz:1.4, cost:{wood:3, shell:2, crystal:1},   d:'燈罩把光往下集中,看書時就不刺眼。' });
  D.DECOS.push({ id:'clock',     n:'掛鐘',       e:'🕰', img:'deco_clock',     comfort:3,  p:36,  z:7, sz:1.0, cost:{wood:4, ore:1, shell:2},       d:'鐘擺每擺一次的時間幾乎一樣,所以能拿來計時。' });
  D.DECOS.push({ id:'painting',  n:'島嶼風景畫', e:'🖼', img:'deco_painting',  comfort:4,  p:80,  z:7, sz:1.2, shop:true, cost:{},              d:'阿獺畫的——近的東西畫大、遠的東西畫小,畫就有了深度。' });
  D.DECOS.push({ id:'hangplant', n:'吊掛盆栽',   e:'🌿', img:'deco_hangplant', comfort:3,  p:26,  z:7, sz:1.1, cost:{fiber:4, seed:2},             d:'植物的莖會朝著有光的方向長,這叫「向光性」。' });
  D.DECOS.push({ id:'aquarium',  n:'小水族箱',   e:'🐠', img:'deco_aquarium',  comfort:6,  p:140, z:5, sz:1.4, shop:true, cost:{},              d:'水草行光合作用放出氧氣,小魚才能在裡面呼吸。' });
  D.DECOS.push({ id:'guitar',    n:'手作吉他',   e:'🎸', img:'deco_guitar',    comfort:4,  p:45,  z:6, sz:1.2, cost:{wood:6, fiber:4},             d:'弦越緊、越細,振動越快,聲音就越高。' });
  D.DECOS.push({ id:'organ',     n:'小風琴',     e:'🎹', img:'deco_organ',     comfort:6,  p:160, z:5, sz:1.6, shop:true, cost:{},              d:'踩踏板把空氣送進簧片,簧片振動就發出聲音。' });
  D.DECOS.push({ id:'globe',     n:'地球儀',     e:'🌍', img:'deco_globe',     comfort:5,  p:120, z:6, sz:1.1, shop:true, cost:{},              d:'地球儀的軸是斜的——地球自轉軸傾斜,才有春夏秋冬。' });
  D.DECOS.push({ id:'specimen',  n:'標本櫃',     e:'🦋', img:'deco_specimen',  comfort:5,  p:60,  z:4, sz:1.5, cost:{wood:8, crystal:1, shell:4},   d:'把撿到的貝殼、羽毛分門別類放好,就是一座小小的自然博物館。' });
  D.DECOS.push({ id:'roundrug',  n:'圓形編織毯', e:'🟠', img:'deco_roundrug',  comfort:3,  p:24,  z:1, sz:1.8, cost:{fiber:6},                     d:'從中心一圈一圈往外編,圓就越來越大。' });
  D.DECOS.push({ id:'cushion',   n:'羽毛坐墊',   e:'🟫', img:'deco_cushion',   comfort:3,  p:26,  z:5, sz:0.9, cost:{fiber:4, feather:2},           d:'羽毛之間藏著很多空氣,坐下去軟綿綿的。' });
  D.DECOS.push({ id:'curtain',   n:'窗簾',       e:'🪟', img:'deco_curtain',   comfort:3,  p:26,  z:6, sz:1.4, cost:{fiber:8},                     d:'厚的布會擋住光,早上才不會太早被曬醒。' });
  D.DECOS.push({ id:'basket',    n:'收納籃',     e:'🧺', img:'deco_basket',    comfort:2,  p:18,  z:5, sz:1.0, cost:{reed:6},                      d:'蘆葦中間是空心的,又輕又有彈性,很好編。' });
  D.DECOS.push({ id:'teaset',    n:'茶具組',     e:'🫖', img:'deco_teaset',    comfort:3,  p:30,  z:6, sz:0.9, cost:{stone:6, shell:2},             d:'台灣的高山茶很有名,泡茶的水溫會改變茶的味道。' });
  D.DECOS.push({ id:'plushbear', n:'黑熊玩偶',   e:'🧸', img:'deco_plushbear', comfort:5,  p:90,  z:6, sz:1.0, shop:true, cost:{},              d:'台灣黑熊胸前有 V 字白毛,是台灣最大的陸地哺乳動物。' });
  ...
  D.CABIN = {
    ...
    /* ★ v1.344.0 老師「小木屋內也能操作主角移動」「角色身高 = 屋內房門高度的 75%」「後面房間改成後院」—
       ...
       doorH = 這張圖裡「房門」高度占房間高的比例;主角身高 = doorH × charDoorK(v1.344.0 訂 0.75,v1.347.0 老師要求再縮 25% ⇒ 0.5625)。
       img0/doorH0 = 新圖還沒上傳時退回的舊圖與舊圖的門高(新舊圖門的位置刻意設計成相同,座標共用)。
       以後換房間圖只要改這裡的數字,程式不必動。 */
    charDoorK: 0.5625, spd: 1.67,   /* ★ v1.347.0 老師「屋內主角太大,縮小 25%」:0.75 × 0.75 = 0.5625(身高 = 房門高 56.25%);
                                       spd = 每秒走幾個「主角身高」,身高變小後同步 1.25 ÷ 0.75 ≈ 1.67,在房間裡走路的實際快慢不變 */
    rooms: [
  ...
  /* ── ★ v1.333.0 老師「所有主角飾品效果修正」(只覆寫 eff/d,取得方式與圖不動)──
     新效果鍵(index 消費點):moveP 野外/營地走路速度%(islZone 移動、islCampWalkSpd)・gutsP 致命傷 N% 保留 1HP(islBtHurtUnit 主角分支)
       reflectP 反彈實際受到傷害 N%(islBtHeroReflect)・cutP 每次受傷 −N%(islBtHurtUnit)・ailResP 所有不利狀態抵抗 +N(islResRoll/暈眩石化)
       skillP 絕招傷害與戰鬥特殊指令效果 +N%(islHeroSkMul)・apSaveP 使用 AP 時 N% 不消耗(islApPay 單一出口) */
  (function(){ var E = {
      acc_tusk:     { eff:{ atkP:10, toughP:20 },                d:'攻擊 +10%、打頭目削韌 +20%。' },
      acc_locust:   { eff:{ spdAdd:5, escAdd:30, moveP:15 },     d:'速度 +5、逃跑成功率 +30%、走路速度 +15%。' },   /* 老師採建議①:+10→+5(魔物速度只有 2~10,+10 幾乎必定先手) */
      acc_mud:      { eff:{ hpP:10, gutsP:20 },                  d:'體力上限 +10%、受到致命傷害時 20% 機率保留 1 體力。' },
      acc_claw:     { eff:{ defP:10, reflectP:50 },              d:'防禦 +10%、把受到的傷害反彈 50% 給攻擊你的魔物。' },
  ...
  D.LOG.unshift({ v: 'v1.333.0', d: '2026-09-25', items: [
    '🦦 阿獺雜貨鋪每天換貨:材料和料理每天只上架 6 樣,偶爾(10%)會出現一件夥伴裝備!每天還有一件「今日裝飾」。',
    '🪴 新增 50 種裝飾和家具:水池、噴泉、荷花池、鞦韆、風車、沙發、書架、壁爐、水族箱……所有裝飾都能賣給阿獺換一半的貝幣。',
    '🏡 小木屋:蓋好後點門口的「🚪 進入小木屋」,裡面有客廳和左、右、後共 4 個房間,每間可以擺 20 件家具。',
    '🔍 設施和裝飾可以縮到 20%、放到 300%;新增「圖層 1~9」:數字大的會蓋住數字小的,主角和夥伴永遠在最上面。',
    '🍖 修正:餵夥伴時按「取消」其實會吃掉物品包第一格的東西、還會加親密度。現在只有真的餵了料理才算,而且每隻夥伴每天只能餵 1 次。',
    '🍯 蜂蜜小陶罐改成:使用治療技能時治療量 +30%,技能計量充能速度 +25%。🐾 夥伴裝備的圖片現在會正確顯示了。',
    '🍀 草藥香包新增:受到治療時恢復量 +25%。🪴 製作裝飾現在要花 AP(大件的比較多);自己做得出來的裝飾和夥伴裝備,賣給阿獺的價錢不會超過材料的價錢。',
    '💍 主角飾品全面加強:巨螯手環會反彈傷害、泥心墜飾有機會撐住 1 體力、蛇鱗手鏡抵抗所有不利狀態、巨像之心讓 AP 有機會不消耗……到 👤 角色 → 💍 飾品 看看。'
  ] });
  D.LOG.unshift({ v: 'v1.334.0', d: '2026-09-25', items: [
    '💌 留言改成「選句子」:從 20 句讚美和心情小語裡選 1~3 句,不用打字。每天可以留言 1 次(寫自己的留言板、留給好友、留給島主都算)。',
    '🎁 留言時按「＋ 附上禮物」可以一起送禮:材料一次最多 5 個、料理 1 份、夥伴裝備 1 件。原本好友名單的「🎁送禮」按鈕併進「💌留言/送禮」。'
  ] });

  /* ★ v1.335.0 老師「重新調整目前的裝飾舒適度和上限,讓玩家適當擺設家具達到當前最高舒適度」
     max:舒適度上限(index 的 AP 公式 floor(min(舒適,100)/20) 本來就只算到 100,超過從來沒效果 ⇒ 直接封頂)。
     dupN/dupMul:同一種裝飾(營地+小木屋合計)第 1 件全額、第 2 件 × dupMul(至少 1 分)、第 dupN+1 件起 0 分。
     tent:帳篷 Lv0~5 加成(沿用舊值)。74 種裝飾各擺 1 件總和 306,帳篷 +8、小木屋 +10 ⇒ 約 20 種不同裝飾就能滿 100。
     COMFORT_TIERS 改成照實列出所有門檻(舊表只寫到 50,AP 每 20 點 +1 的隱藏加成從沒列出來)。上方 v1.94.0 舊表保留不刪。 */
  D.COMFORT_RULE = { max:100, dupN:2, dupMul:0.5, tent:[0, 0, 2, 4, 6, 8] };
  D.COMFORT_TIERS = [ { at:10, t:'睡覺多回 10 體力' }, { at:20, t:'明日 AP +2' }, { at:35, t:'夜襲機率 −10%' }, { at:40, t:'明日 AP +3' },
    { at:50, t:'睡覺體力全滿' }, { at:60, t:'明日 AP +4' }, { at:80, t:'明日 AP +5' }, { at:100, t:'明日 AP +6(最高舒適度)' } ];
  /* ★ v1.335.0 老師「荒島 BOSS 的 HP 在 50%、瀕死前固定施展大絕招(重壓技),要有大特效和音效」
     D.BOSS_RULE.grd:at 觸發門檻(HP 比例,各觸發一次;一刀跨兩個門檻只放一次)、guardMul 主角有防禦時在「防禦倍率」之外再 ×、
     allyMul 主角有防禦時夥伴受傷倍率(主角喊「趴下!」)、stunMul 主角暈眩中(沒辦法防禦)只被擦到的倍率、tough 扛住後反震削韌、chg 錘類扛住多蓄力。
     D.BOSS_GRD[頭目 key]:n/e 招名、aoe 1=全體 0=只打主角、t 沿用 MON_SKILL 型別(決定打中特效;chain=雷抗性、burn=燒燙)、mul 傷害倍率、
     stun/slow/dot+dur/blind/strip 沒扛住時的附加狀態、s 放出音效、tele 預告台詞、how 防禦的動作、sci 放完後的自然知識。
     規則(index islBtBossGrd):不跳閃避鈕、智取不能取消;破韌/暈眩只會延後;蓄勢期間其他攻擊不會用掉主角的防禦。 */
  D.BOSS_RULE.grd = { at:[0.5, 0.2], guardMul:0.6, allyMul:0.6, stunMul:0.6, tough:15, chg:1 };
  D.BOSS_GRD = {
    boarking:     { n:'連根掀地',   e:'🌋', aoe:1, t:'quake',  mul:1.5, stun:1,        s:'sfx-earthquake',       tele:'獠牙深深插進土裡,整片地面開始隆起……', how:'壓低重心站穩', sci:'野豬會用鼻子和獠牙翻土找根莖和蚯蚓(拱土),力氣大到能掀起一整片草皮。' },
    locustking:   { n:'蝗群過境',   e:'🦗', aoe:1, t:'multi',  mul:1.5, strip:1,       s:'sfx-wing',             tele:'四面八方的蝗蟲全都飛起來,天空一下子暗了……', how:'縮起身體護住頭臉', sci:'蝗蟲大量聚集時會變成成群遷飛的蟲雲,躲到哪裡都一樣,只能護住頭臉等牠們飛過。' },
    mudking:      { n:'土石流',     e:'🪨', aoe:1, t:'aoe',    mul:1.5, slow:2,        s:'sfx-cleopatra-burst',  tele:'上游傳來轟隆隆的聲音,溪水突然變得好混濁……', how:'抓緊大石頭穩住', sci:'土石流又快又廣,人跑不贏。溪水突然變混濁、傳出轟隆聲都是前兆,要提早往高處避難。' },
    crabking:     { n:'巨螯鉗碎',   e:'🦀', aoe:0, t:'charge', mul:2.8, dot:4, dur:2,  s:'sfx-crack',            tele:'巨螯張到最大,盯住了你……', how:'用武器卡住鉗口', sci:'椰子蟹的鉗力是甲殼類中數一數二的,被夾住就甩不開,只能用硬東西卡住鉗口。' },
    batqueen:     { n:'迴聲震爆',   e:'〰', aoe:1, t:'aoe',    mul:1.5, stun:1,        s:'sfx-detective-burst',  tele:'蝠后張大嘴巴,洞壁開始嗡嗡震動……', how:'摀住耳朵蹲低', sci:'聲音是振動,會在洞壁之間來回反射、從四面八方傳來,身體躲不開,只能摀住耳朵。' },
    abyssshadow:  { n:'暗潮吞沒',   e:'🕳', aoe:1, t:'blind',  mul:1.5, blind:2,       s:'sfx-darkness',         tele:'湖水開始打轉,黑色的浪一波波湧上岸……', how:'抓緊岸邊屏住氣', sci:'光在水中會被吸收,越深的地方越暗;被拖進深水前要抓緊岸邊、屏住呼吸。' },
    thunderbird:  { n:'天雷直擊',   e:'⚡', aoe:0, t:'chain',  mul:2.8, stun:1,        s:'sfx-thunder',          tele:'雷雲壓到頭頂,頭髮一根根豎了起來……', how:'雙腳併攏蹲低', sci:'閃電的速度極快,看到再閃絕對來不及;打雷時要雙腳併攏、蹲低身體,遠離高處和大樹。' },
    magmabeetle:  { n:'沸騰噴霧',   e:'♨', aoe:1, t:'burn',   mul:1.5, dot:5, dur:2,  s:'sfx-blast',            tele:'尾端冒出滾燙的白煙,發出啪啪的聲響……', how:'用防具擋住臉', sci:'步行蟲(放屁蟲)會把兩種化學物質在身體裡混合,噴出接近 100°C 的滾燙霧氣;霧一散開就躲不掉。' },
    gorgonqueen:  { n:'巨蟒絞纏',   e:'🐍', aoe:0, t:'charge', mul:2.8, dot:6, dur:2,  s:'sfx-vine',             tele:'長長的身體悄悄繞到你身後……', how:'繃緊身體撐住', sci:'蟒蛇沒有毒,是用身體一圈圈纏住獵物再慢慢勒緊;被纏住就逃不了,只能繃緊身體撐住。' },
    lavacolossus: { n:'火山碎屑流', e:'🌋', aoe:1, t:'burn',   mul:1.7, dot:5, dur:2,  s:'sfx-pharaoh-burst',    tele:'火山口噴出滾滾黑煙,沿著山坡衝下來……', how:'躲在盾牌後面', sci:'火山碎屑流是高溫氣體夾著火山灰和岩塊衝下山坡,時速可以超過 100 公里,人跑不贏,只能躲在堅固的掩蔽後面。' }
  };
  /* ★ v1.335.0 老師「智取點開時畫面上方顯示提示小視窗,不要太明白告知答案」— 每隻魔物一句引導式提問,不寫出工具名稱。
     key = 魔物 k(分身/精英同 k);沒有登記的用 _def。 */
  D.WIT_HINT = {
    _def:       '仔細看看牠的樣子和習性……牠最怕什麼呢?',
    shadow:     '影子是怎麼形成的?要是四周一下子全亮起來……?',
    beetle:     '鐵甲蟲的甲殼……會是鐵做的嗎?有什麼東西特別喜歡鐵?',
    bat:        '黑漆漆的洞裡,牠是怎麼「看」路的?那對大耳朵好像很靈敏……',
    boar:       '牠其實只是受了驚的動物……動作夠快,是不是就能把牠嚇跑?',
    slime:      '黏答答的身體裡好像全是水……有什麼能把水分吸出來?',
    ember:      '燃燒需要三個條件……少了其中一個會怎樣?',
    basilisk:   '牠的目光是一道光……光碰到什麼東西會被彈回去?',
    spark:      '電流很愛穿過某些材料,卻過不了另一些材料……',
    thornvine:  '藤蔓靠什麼把水從根送到葉子?那條「水管」斷了會怎樣?',
    hornet:     '蜂群靠「氣味」互相通知有敵人……要是聞不到了呢?',
    mantis:     '牠的前腳像鐮刀一樣鋒利,正面硬拚太危險……能不能把牠整隻罩住?',
    mole:       '牠的眼睛幾乎看不見,那牠是怎麼知道外面有動靜的?',
    mittencrab: '牠揮著大螯,嘴巴卻一直動個不停……是不是肚子餓了?',
    leech:      '軟軟的身體濕答答的,好像一碰就會縮起來……',
    urchin:     '全身都是刺,徒手碰一定會痛……怎樣才能讓刺刺不進皮膚?',
    jelly:      '千萬別讓皮膚碰到那些觸手……隔著什麼才安全?',
    snakehead:  '這隻外來的大魚什麼都想吞下肚……',
    mistfrog:   '青蛙的皮膚總是濕濕的,牠其實也靠皮膚呼吸……',
    cavespider: '蛛絲很堅韌,但它是蛋白質做的……蛋白質遇到高溫會怎樣?',
    golem:      '結晶排得整整齊齊……有沒有什麼「振動」能讓它沿著紋路裂開?',
    harpy:      '牠俯衝得太快,衝下來那一刻根本轉不了彎……',
    rockslide:  '曬了一整天的熱石頭,突然遇冷會怎樣?',
    pollen:     '花粉輕飄飄地浮在空中……怎樣才能讓它飄不起來?',
    stag:       '鍬形蟲長大以後喝什麼過活?聞到甜甜的味道……',
    clockwork:  '喀啦喀啦轉的齒輪,是用什麼金屬做的?',
    wraith:     '牠躲在光照不到的暗處……能不能把光「轉個彎」送過去?',
    salamander: '牠身上的火靠熱量撐著……把熱帶走會怎樣?',
    ashcrow:    '農夫在田裡掛亮晶晶的帶子,是為了嚇走誰?',
    guardian:   '石像全身硬梆梆……巨大的振動會讓它怎麼樣?',
    boarking:   '野生動物突然聽到好大的聲響,會有什麼反應?',
    locustking: '晚上的蟲子會繞著什麼打轉?蟲群又最怕什麼熱熱亮亮、會冒煙的東西?',
    mudking:    '泥巴王全身都是水和泥……把水分抽走,牠還撐得住嗎?',
    crabking:   '螃蟹要是被翻成背朝下……還爬得起來嗎?',
    batqueen:   '牠用聲音「看」世界……如果聲音被打亂了呢?',
    abyssshadow:'光沿直線前進,照得到的地方,影子就……?',
    thunderbird:'全身帶電,碰到就麻……有什麼材料電流過不去?',
    magmabeetle:'燒得通紅的外殼,要是突然冷下來會怎樣?',
    gorgonqueen:'她的目光能把人變成石頭……要是讓目光彈回她自己身上呢?',
    lavacolossus:'滾燙的熔岩冷卻之後,會變成什麼?又脆又硬……'
  };
  D.LOG.unshift({ v: 'v1.335.0', d: '2026-09-25', items: [
    '🛡❗ 地圖頭目血量掉到一半、還有快撐不住的時候,一定會放出「大絕招」!這招閃不掉,看到預告就按 🛡 防禦扛住——扛住還能震掉牠的韌性。',
    '🧠 智取時畫面上方會出現一句小提示,想一想牠怕什麼;智取選單開著時點別隻魔物,提示和選項會跟著換。',
    '😊 舒適度最高 100:同一種裝飾第 1 件全額、第 2 件算一半、第 3 件起不加分——多擺幾種不同的裝飾和家具,大約 20 種就能住到最舒服!點 🏠 看每一級的好處。',
    '🛡 天賦加強:「敏捷」完美閃避判定 +0.1 秒、「慢活節奏」閃過一半的判定 +0.2 秒、「強健」防禦時受傷再 −15%、「止血」按防禦多回 5% 體力。'
  ] });
  /* ══ ★ v1.336.0(2026-09-25・老師「製作所有的東西都要消耗適量的貝幣」「10×等級 + 材料賣價總和的 30%」「重新合理修正所有商品買賣價格」)══
     ① 製作費(單一真相,index 的 islMakeFee 直接呼叫 D.makeFee):
        費用 = per × 等級 + 材料價值(D.matValue,即賣價表)× rate,四捨五入、最少 1。
        等級:工具看 lv 表;防具/夥伴裝備看 tier;武器新做 1、升級=升級後等級;設施新建 1、升級=升級後等級;
              料理=食材種類數;裝飾=1+⌊(舒適度−1)/3⌋。
     ② 價格三原則(整張商店表依此重算,不再手寫數字):
        ・材料賣價(SHOP.sell)維持不變——它是全島的計價單位,委託報酬、回收價都以它為準;
        ・向阿獺「買材料」= 賣價 × 3(買比賣貴,採集才划算);
        ・向阿獺「買成品」(料理/裝飾/夥伴裝備)≥ 自己做的總成本(材料價值+製作費)× 1.5(自己做一定比較省);
        ・賣成品 = min(商店價一半, 材料回收價)(沿用 v1.333.0 裁定甲:做了再賣不能賺——現在多了製作費,更不可能賺)。 */
  D.MAKE_FEE = { per: 10, rate: 0.3, buyMatMul: 3, buyMadeMul: 1.5, lv: { basket: 1, rod: 1, ironaxe: 2, ironpick: 2 } };
  D.makeFee = function(cost, lv){ var c = {}, k; for(k in cost){ if(cost.hasOwnProperty(k) && k !== '_coin') c[k] = cost[k]; } return Math.max(1, Math.round(D.MAKE_FEE.per * Math.max(1, lv || 1) + D.matValue(c) * D.MAKE_FEE.rate)); };
  D.makeTotal = function(cost, lv){ return D.matValue(cost) + D.makeFee(cost, lv); };   /* 自己做的總成本 */
  (function(){
    var S = D.SHOP, M = D.MAKE_FEE, R = {}, i, b, it, n, g, _dp = D.decoPrice;
    function kinds(c){ var k, x = 0; for(k in c){ if(c.hasOwnProperty(k)) x++; } return x; }
    for(i = 0; i < D.RECIPES.length; i++) R[D.RECIPES[i].id] = D.RECIPES[i];
    for(i = 0; i < S.buy.length; i++){
      b = S.buy[i]; if(!b.give || !b.give.item || !b.price || !b.price.shell) continue;
      it = b.give.item; n = b.give.n || 1;
      if(R[it]) b.price.shell = Math.ceil(D.makeTotal(R[it].need, Math.max(1, kinds(R[it].need))) * M.buyMadeMul) * n;
      else b.price.shell = Math.max(1, Math.round(((S.sell[it] != null) ? S.sell[it] : 1) * M.buyMatMul * n));
    }
    D.decoPrice = function(id){
      var p = _dp(id), d = null, j;
      for(j = 0; j < D.DECOS.length; j++){ if(D.DECOS[j].id === id){ d = D.DECOS[j]; break; } }
      if(d && d.cost && kinds(d.cost)) p = Math.max(p, Math.ceil(D.makeTotal(d.cost, 1 + Math.floor(Math.max(0, (d.comfort || 1) - 1) / 3)) * M.buyMadeMul));
      return p;
    };
    for(i = 0; i < D.PET_GEAR.length; i++){
      g = D.PET_GEAR[i]; if(!g.cost) continue;
      g.price = Math.max(g.price || 0, Math.ceil(D.makeTotal(g.cost, g.tier || 1) * M.buyMadeMul));
      D.PET_GEAR_PRICE[g.id] = g.price;
      g.sell = Math.max(1, Math.min(Math.floor(g.price / 2), D.matValue(g.cost)));
    }
  })();
  D.LOG.unshift({ v: 'v1.336.0', d: '2026-09-25', items: [
    '🐚 現在製作東西都要花一點貝幣:工具、武器(含升級)、防具、夥伴裝備、裝飾家具、料理、蓋設施和升級設施。等級越高、用的材料越好,花的貝幣越多;按鈕上會寫要多少。',
    '🏪 阿獺雜貨鋪重新定價:買材料比自己採集貴(採集最划算),買現成的料理、裝飾、夥伴裝備也一定比自己做貴——自己動手做最省!',
    '☁ 存檔更穩:雲端太忙的時候,進度會先存在這台平板,過一會兒自動補存上去,不會再一直跳「沒有存成功」。'
  ] });
  D.LOG.unshift({ v: 'v1.337.0', d: '2026-09-25', items: [
    '🎒 iPad 物品包、選取存入的格子變精巧了,一次看得到更多東西;換造型的選項小圖也縮小,不再擠成一團。',
    '🍳 iPad 烹飪選單的料理圖和字放大了,材料看得更清楚。',
    '🏪 雜貨鋪「戰鬥效果」改成黑色字,更好閱讀;打開選單不會再多一聲嚇人的音效;營火點著時的 🔥 移到營火正上方。',
    '🔨 敲釘子的釘板改成橫 6 × 直 5,iPad 也看得到最下面那排亮起的釘子。'
  ] });
  D.LOG.unshift({ v: 'v1.338.0', d: '2026-09-25', items: [
    '🧩 島上的解謎點:題目字變大、更好讀;選項和「先不解」按鈕變精巧,畫面更清爽。'
  ] });
  ...
  D.LOG.unshift({ v: 'v1.349.0', d: '2026-09-26', items: [
    '📱 手機橫放時,戰鬥畫面不再被切掉或疊在一起:血條排成一橫排,指令鈕全部看得到。',
    '📱 手機上的天賦星域、營地選單、採集小遊戲與結算畫面也重新排版,按鈕不會再被擋住。'
  ] });
  D.LOG.unshift({ v: 'v1.350.0', d: '2026-09-26', items: [
    '👆 營地長按設施或裝飾,讀條滿了就直接打開選單,主角不用先走過去。',
    '🗺 「前往大地圖」出口移到營地最上方邊緣,主角沿著中間的小路往上走就能出發。'
  ] });
  D.LOG.unshift({ v: 'v1.351.0', d: '2026-09-26', items: [
    '⚔ 戰鬥時海浪聲、鳥叫蟲鳴等環境音會暫停,只聽得到戰鬥音樂和音效;打完自動恢復。'
  ] });
  /* ★ v1.352.0 老師「蜂蜜太難取得,讓伐木、打倒蜜蜂都可以機率得到蜂蜜」—
     伐木每次完成有這個機率多拿 1 罐蜂蜜(品質 = 這次伐木的星數;樹洞裡常有野蜂築巢);打倒虎頭蜂兵的掉落率在 MON_BT 內改 0.5。 */
  D.HONEY_CHOP_P = 0.25;
  D.LOG.unshift({ v: 'v1.352.0', d: '2026-09-26', items: [
    '🍯 蜂蜜變好拿了:伐木有機會在樹洞裡找到蜂蜜,打倒虎頭蜂兵掉蜂蜜的機率也提高到一半。'
  ] });
})();
