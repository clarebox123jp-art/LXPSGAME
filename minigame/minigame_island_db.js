...
window.ISL_DB = (function(){
  ...
  D.LAYER_ADJ = {
    ...
    hair_boy_h1:   { sx:0.933, sy:0.933, dx:0, dy:-3.9 },   /* ⚠ v1.128.0 少年 h1~h3 改為 刺蝟短髮/西瓜皮/捲毛蓬鬆,老師重新生成同名覆蓋後,這三組值要用造型工房重調(現值是舊「雙馬尾/長髮/高馬尾」圖量出來的) */
    hair_boy_h2:   { sx:0.963, sy:0.963, dx:0, dy:-2.1 },
    hair_boy_h3:   { sx:0.948, sy:0.948, dx:0, dy:-3.0 },
