...
window.ISL_DB = (function(){
  ...
  var D = {};
  D.VER = 'v1.334.0';   /* ★ v1.334.0(2026-09-25)— 本檔實質異動:D.BOARD_PHRASES(20 句小語)/BOARD_PICK_MAX/MAIL_GIFT_MATS/MAIL_GIFT_MAT_MAX/MAIL_GIFT_ONE_MAX + D.LOG。對應 minigame_index.html v1.334.0。 */
...
;   /* ★ v1.314.0(2026-09-22・老師在「🎨 造型工房(GM)」再調一次後貼回聊天室的「📋 複製設定值」輸出)——
  ...
  D.SK_NODES = [
    ...
    { id:'SK_CORE_HP',   g:'core', n:'強健', e:'💪', req:[], pr:300, pa:22.5,   d:'最大體力 +10%;每日 ⚡AP +1;夜襲營火血量 +1', eff:{ hpMaxP:10, apAdd:1, defHpAdd:1 } },
    ...
    { id:'SK_CORE_SPD',  g:'core', n:'敏捷', e:'💨', req:[], pr:300, pa:-112.5, d:'行動速度 +5%;島上走路速度 +12%;探索度增加 +10%', eff:{ spdP:5, moveP:12, exploreP:10 } },
    ...
    { id:'SK_LIFE_2', g:'life', n:'慢活節奏', e:'🐢', req:['SK_LIFE_L2'], u:640, v:-124, d:'所有 QTE 指針變慢 12%;夜襲魔物爬行再慢 15%', eff:{ qteSlowP:12, defSlowP:15 } },
    ...
    { id:'SK_MED_BND_1',   g:'med', sub:'bnd', dep:1, n:'止血',     e:'🩹', req:['SK_MED_BND_L1'],     u:460, v:-180, d:'戰鬥中可止血:去除自己身上的流血/蜂螫；島上活動失誤受傷 −25%;夜襲被咬扣血再 −25%', eff:{ bleedCure:1, hurtCutP:25, defBiteCutP:25 } },
