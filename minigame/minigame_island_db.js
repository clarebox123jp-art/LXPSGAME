...
;   /* ★ v1.314.0(2026-09-22・老師在「🎨 造型工房(GM)」再調一次後貼回聊天室的「📋 複製設定值」輸出)——
  ...
  D.BOSSES = [
    ...
    { zone:'lake', k:'batqueen', n:'霧湖蝠后', e:'🦇', lv:24, hp:400, atk:34, def:4, spd:9, crit:12, tool:'gong', weakWp:['bow','spear'], core:'boss_batfeather',
    ...
    { zone:'cave', k:'abyssshadow', n:'深淵影魔', e:'👤', lv:28, hp:400, atk:36, def:4, spd:8, crit:15, tool:'torch', weakWp:['boomerang','bow'], core:'boss_shadowgem',
