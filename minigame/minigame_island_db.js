...
window.ISL_DB = (function(){
  ...
  var D = {};
  D.VER = 'v1.335.0';   /* ★ v1.335.0(2026-09-25)— 本檔實質異動:①天賦 4 節點補閃避/防禦效果(敏捷 dodgeMs、慢活節奏 dodgeGoodMs、強健 guardCutP、止血 guardHealP)②檔尾 D.COMFORT_RULE(舒適度上限 100、同種裝飾遞減)+ D.COMFORT_TIERS 覆寫 ③檔尾 D.BOSS_RULE.grd + D.BOSS_GRD(10 頭目大絕招・重壓技,HP 50%/20% 固定施放)④D.WIT_HINT(智取提示小視窗)⑤D.LOG。對應 minigame_index.html v1.335.0。 */
