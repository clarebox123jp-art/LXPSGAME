...
const BURST_DB = {
 ...
 '陰陽師':   {n:'四聖降臨',    d:'召喚玄武&白虎(陰陽師HP×150%,5回合)，若朱雀/青龍不存在則補召喚，所有式神HP回滿，特技40%全體攻擊4次，附加2回合減療/緩速/受傷+50%',fd:'召喚玄武&白虎(陰陽師HP×150%/5回合),若朱雀/青龍不存在則補召喚,所有式神HP回滿,特技40%全體×4次,敵全體減療/緩速/受傷+50% 2回合。'},
  ...
  '武器精靈':{n:'銀齒迴力鏢旋風', d:'(攻+特+速)×800%全體分攤傷害(必中無視有利);單體分2段;施放後回3能量',fd:'(攻+特+速)×800%全體分攤必中無視有利(敵人越多每人受越少);單體時分2段;施放後回3能量。'},
...
Object.assign(BURST_DB, {
  ...
  '埃及豔后': {n:'尼羅河的詛咒', d:'特技200%全體水屬性大傷+使對手減6能量+強力查封物品2回合',fd:'喚醒尼羅河千年詛咒淹沒戰場,以特技值200%對全體存活對手造成水屬性巨大傷害,使對手隊伍減少6能量,並使其全體陷入「強力查封物品」狀態2回合(期間無法使用任何道具)。'},
});
