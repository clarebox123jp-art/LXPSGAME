...
const AVATARS = {
  ...
  '幼兒園小孩':'👶','電腦繪圖師':'🎨','程式設計師':'💻','弦樂團員':'🎻','小劇團員':'🎭','巫女':'⛩','雙星姊妹':'🌟','暗魔將·血':'🩸','死靈法師':'👻','布奶鳥獸':'🦜','炸彈客':'💣','紅色玩家':'🟥','地府酋長':'⚖️','救醫馬':'🐎','水狐':'🐉','米鈴':'🐱','學霸(轉學生)':'🤓','天神宙斯':'⚡','維京海盜船長':'🏴‍☠️','武器精靈':'⚔','神槍手':'🎯','火柴人':'🔥','青炎龍王':'🐲','鳳凰':'🐦‍🔥','操偶師':'🎭','九尾空貓怪':'🐱','綠竹筍小妖':'🎋','茶葉精靈':'🍃','杏花妖':'🌸','偷摘花的頑皮妖精':'🌸','偷鳥蛋的鳥人哈維':'🦅','偷竹筍的哥布林':'🪓','偷喝茶的史萊姆':'🫧','寶箱怪':'📦','小惡魔':'😈','黑暗球‧希望型態':'🌑','菇女':'🍄','小丑':'🤡','美人魚‧角角':'🧜‍♀️','火爆女':'🤖','幽幽':'👻','網路駭客':'🤖','死神':'💀','地獄將軍':'⚔️',
