...
const AVATARS = {
  ...
  '幼兒園小孩':'👶','電腦繪圖師':'🎨','程式設計師':'💻','弦樂團員':'🎻','小劇團員':'🎭','巫女':'⛩','雙星姊妹':'🌟','暗魔將·血':'🩸','死靈法師':'👻','布奶鳥獸':'🦜','炸彈客':'💣','紅色玩家':'🟥','地府酋長':'⚖️','救醫馬':'🐎','水狐':'🐉','米鈴':'🐱','學霸(轉學生)':'🤓','天神宙斯':'⚡','維京海盜船長':'🏴‍☠️','武器精靈':'⚔','神槍手':'🎯','火柴人':'🔥','青炎龍王':'🐲','鳳凰':'🐦‍🔥','操偶師':'🎭','九尾空貓怪':'🐱','綠竹筍小妖':'🎋','茶葉精靈':'🍃','杏花妖':'🌸','偷摘花的頑皮妖精':'🌸','偷鳥蛋的鳥人哈維':'🦅','偷竹筍的哥布林':'🪓','偷喝茶的史萊姆':'🫧','寶箱怪':'📦','小惡魔':'😈','黑暗球‧希望型態':'🌑','菇女':'🍄','小丑':'🤡','美人魚‧角角':'🧜‍♀️','火爆女':'🤖','幽幽':'👻','網路駭客':'🤖','風術士':'🍃','死神':'💀','地獄將軍':'⚔️',
...
const HERO_TRAIT = {
  ...
  '救醫馬':{ name:'救馬本能', icon:'🐎', desc:'新回合開始自動用特技 50% 治療所有 HP 低於 50% 的友方(可復活)',fd:'戰場上看到夥伴受傷,馬醫生立刻衝過去救援!只要救醫馬存活,每個新回合開始就會自動用特技的 50% 治療隊上所有 HP 低於 50% 的友方(連倒下的夥伴也能救起來)。天賦每升 1 級,治療的 HP 門檻提高 5%(Lv5 達 75%)。' },
...
const _TRAIT_LV_INFO = {
  ...
  '救醫馬':  { base:'門檻 50%', bonus:'+5%/天賦級', max:'門檻 75%(Lv5)', effect:'新回合開始,救醫馬存活時自動用特技 50% 治療隊上所有 HP 低於門檻的友方(可復活倒下者);天賦每升 1 級門檻 +5%' },
  // ★ v1.0.20260515.6890 — 學生設計英雄系列(6 年 2 班林同學「水狐」)
