...
const HERO_DB = {
  ...
  '風術士':{hp:62,atk:10,sp:16,spd:12,
    s1:{n:'風恆之星',c:3,d:'全體友方獲得「持續恢復」3回合(每回合回特技60%),並立即治療血量最低的友方(特技100%)',fd:'風術士凝聚恆星之風,為全體友方附加「持續恢復」3 回合(每回合回復特技 60% 的 HP),並立即為血量最低的友方回復特技 100% 的 HP。升級每級 +5% 持續回血與立即治療量。'},
    s2:{n:'蝴蝶效應',c:3,d:'全體友方所有有利狀態延長1回合,並獲得「疾風步」2回合(迴避+30%)',fd:'風術士掀起蝴蝶之風,使全體友方身上所有「有利狀態」延長 1 回合(獨特效果),並附加「疾風步」2 回合(迴避率 +30%)。升級 Lv5 起延長改為 +2 回合,且每級疾風步迴避 +3%。'}
  },
