...
const HERO_DB = {
  ...
  '機關王雙人組':{hp:65,atk:10,sp:7,spd:18,
    ...
    s2:{n:'重力加速攻擊',c:3,d:'用(最大HP+速度)×150%對1名對手造成傷害,必中且無視有利狀態',fd:'雙人組架起重力加速軌道,讓鋼球一路加速猛烈撞向敵人!以(自身最大 HP+速度)的 150% 對 1 名對手造成傷害——此傷害必中,且無視目標的有利狀態(無敵/護盾/減傷全部失效)。'}
  },
  ...
  '雅典娜':{hp:62,atk:14,sp:14,spd:10,
    s1:{n:'進攻號令',c:4,d:'集合友方存活英雄各自「攻擊或特技取較高者」的總和,攻擊1名目標,必中且無視有利狀態',fd:'雅典娜高舉長槍下達進攻號令!集合全體存活友方各自「攻擊力或特技值取較高者」相加的總和,對 1 名對手造成傷害——此傷害必中,且無視目標的有利狀態(無敵/護盾/減傷全部失效)。'},
    s2:{n:'新生的誕生',c:5,d:'使1名友方HP回滿(可復活),附加其最大HP 100%的護盾值,並獲得增強術(攻擊、特技、速度+50%)2回合',fd:'雅典娜降下女神的恩典,使 1 名友方 HP 完全回滿(倒下的友方也能復活);同時為其附加等同最大 HP 100% 的護盾值,並獲得「增強術」(攻擊、特技、速度全部提升 50%)持續 2 回合。'}
  },
...
const BURST_DB = {
 ...
 '陰陽師':   {n:'四聖降臨',    d:'召喚玄武&白虎(陰陽師HP×150%,5回合)，若朱雀/青龍不存在則補召喚，所有式神HP回滿，特技40%全體攻擊4次，附加2回合減療/緩速/受傷+50%',fd:'召喚玄武&白虎(陰陽師HP×150%/5回合),若朱雀/青龍不存在則補召喚,所有式神HP回滿,特技40%全體×4次,敵全體減療/緩速/受傷+50% 2回合。'},
  ...
  '機關王雙人組':{n:'霸王投石機', d:'用最大HP×200%對隨機目標造成4次傷害,必中且無視有利狀態;同時全體友方獲得「強力連結」2回合(不會被消除、奪取或交換)', fd:'雙人組推出壓箱寶——巨型霸王投石機!以自身最大 HP 的 200% 對隨機對手造成 4 次傷害,必中且無視有利狀態(無敵/護盾/減傷全部失效);同時使全體友方獲得「強力連結」2 回合(效果同「連結」:受傷減少 10% 後由全隊平分,且不會被消除、奪取或交換)。'},
