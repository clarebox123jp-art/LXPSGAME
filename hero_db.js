// ★ v3.15.36(2026-06-18)— 埃及雙王互相復活天賦說明 fd/desc 25%→12.5%(與 BOSS 程式碼實際一致;爆發 fd 的 25% 保留=招募版 Lv1 基底)。｜v3.15.33(2026-06-18)— 修正動物學家天賦升級視窗:_TRAIT_LV_INFO 移除重複的「動物學家」定義(舊「寵物效果」殘留,JS 同 key 後者覆蓋前者),改由 v3.15.9「驅除機率 50→90%」正確版生效。｜v3.15.29 新增埃及雙王 BOSS 答題反應對白常數(BOSS_REACT_*_PHARAOH / *_CLEOPATRA)。
