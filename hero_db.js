...
const BURST_DB = {
 ...
 '陰陽師':   {n:'四聖降臨',    d:'召喚玄武&白虎(陰陽師HP×150%,5回合)，若朱雀/青龍不存在則補召喚，所有式神HP回滿，特技40%全體攻擊4次，附加2回合減療/緩速/受傷+50%',fd:'召喚玄武&白虎(陰陽師HP×150%/5回合),若朱雀/青龍不存在則補召喚,所有式神HP回滿,特技40%全體×4次,敵全體減療/緩速/受傷+50% 2回合。'},
  ...
  '阿蘇火山龍王':{n:'超光速衝擊波', d:'連段砲擊:每段消耗自己最大HP的10%,以(失去的HP×20+特技100%)轟擊1名目標,打到自己HP低於15%為止;目標倒下自動轉移到HP最高的對手。必中且無視有利,每段獨立機率暴擊', fd:'龍王將自身的生命化為超光速彈藥,展開連段砲擊!每一段消耗自己最大 HP 的 10%,並以(該段失去的 HP × 20 + 特技值 100%)對 1 名目標造成傷害;接著持續用同樣方式消耗 HP 轟擊同一目標,直到自己的 HP 低於 15% 為止。目標若倒下,傷害會自動轉移到下一個 HP 最高的對手。此傷害必中且無視有利狀態,每一段都有獨立機率觸發暴擊。'},
