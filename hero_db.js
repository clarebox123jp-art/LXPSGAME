...
const HERO_DB = {
  ...
  '藝天使．克雷爾':{hp:91,atk:9,sp:24,spd:17,
    s1:{n:'七彩天使神光',c:5,d:'用特技的200%治療HP最低的友方(可復活),溢出轉護盾,並使其獲得「強力再生」「強力減傷½」2回合',fd:'克雷爾揮動畫筆灑下七彩天使神光,為 HP 最低的 1 名友方恢復特技 200% 的 HP(可復活倒下的友方);超出最大 HP 的治療量會轉化為護盾值。接著賦予該友方「強力再生」(每回合依特技恢復大量 HP)與「強力減傷½」(受到傷害減半)各 2 回合。升級每級治療量 +5%。'},
    s2:{n:'聖潔彩繪',c:6,d:'用特技的100%恢復友方全體HP,溢出轉護盾,解除所有不利狀態(含強力),並附加「預防不利狀態」2回合',fd:'克雷爾以聖潔的色彩描繪守護結界,為全體存活友方恢復特技 100% 的 HP,超出最大 HP 的治療量會轉化為護盾值;同時解除全隊所有不利狀態(包含強力版),並附加「預防不利狀態」2 回合(期間所有不利狀態無效)。升級每級治療量 +5%,技能 MAX 時預防回合 +1。'}
  },
...
const AVATARS = {
  ...
  '幼兒園小孩':'👶','電腦繪圖師':'🎨','程式設計師':'💻','弦樂團員':'🎻','小劇團員':'🎭','巫女':'⛩','雙星姊妹':'🌟','暗魔將·血':'🩸','死靈法師':'👻','布奶鳥獸':'🦜','炸彈客':'💣','紅色玩家':'🟥','地府酋長':'⚖️','救醫馬':'🐎','水狐':'🐉','米鈴':'🐱','學霸(轉學生)':'🤓','天神宙斯':'⚡','維京海盜船長':'🏴‍☠️','武器精靈':'⚔','神槍手':'🎯','火柴人':'🔥','青炎龍王':'🐲','鳳凰':'🐦‍🔥','操偶師':'🎭','九尾空貓怪':'🐱','綠竹筍小妖':'🎋','茶葉精靈':'🍃','杏花妖':'🌸','偷摘花的頑皮妖精':'🌸','偷鳥蛋的鳥人哈維':'🦅','偷竹筍的哥布林':'🪓','偷喝茶的史萊姆':'🫧','寶箱怪':'📦','小惡魔':'😈','黑暗球‧希望型態':'🌑','菇女':'🍄','小丑':'🤡','美人魚‧角角':'🧜‍♀️','火爆女':'🤖','幽幽':'👻','網路駭客':'🤖','風術士':'🍃','藝天使．克雷爾':'🎨','死神':'💀','地獄將軍':'⚔️','藝天使．克雷爾':'👼',
