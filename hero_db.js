...
const HERO_DB = {
  ...
  '雙星姊妹':{hp:75,atk:5,sp:24,spd:13,
    ...
    s2:{n:'流星降雨',c:5,d:'特技250%單體傷害+追擊3回合(每回合受特技50%額外傷害)',fd:'用特技的 250% 對 1 名對手造成傷害,並使其陷入「追擊」狀態 3 回合(每回合開始時額外受到特技 50% 傷害)。'}
  },
  ...
  '火爆女':{hp:55,atk:18,sp:16,spd:11,
    ...
    s2:{n:'超級射線',c:5,d:'特技400%對全體存活對手平均分攤,必中且無視有利',fd:'特技×400%對全體存活對手平均分攤水屬性傷害(必中、無視有利狀態)。'}
  },
  ...
  //     ・40% 機率反彈傷害的 50% 給來源(+10%/級,Lv6 達上限 100%)
...
const HERO_LORE = {
  ...
  // ★ v3.12.10 — 地獄將軍(5 年 4 班 陳同學設計,73 號英雄)
  '地獄將軍': '5 年 4 班陳同學設計的捨命之將。生前是英勇善戰的大將軍,因不願再奪命而留在地獄管理亡命之徒。天賦「將軍意志」每回合自動回 HP,S1/S2 以命為祭發動,爆發「死亡怒火」更是燃盡自身性命為夥伴開路——以命換戰,守護未竟。',
  // ── BOSS ──
...
const _TRAIT_LV_INFO = {
  ...
  // ★ v3.12.10 — 學生設計英雄系列(5 年 4 班 陳同學「地獄將軍」)
  '地獄將軍':  { base:'回合開始恢復最大 HP 10%', bonus:'+3%/天賦級', max:'恢復 22%(Lv4)', effect:'(被動)每回合開始時自動恢復自身最大 HP 的 10%。即使陷入麻痺、暈眩等不能行動的狀態也照常觸發;升級增加回血量,搭配 S1/S2 的自損機制可達淨賺循環。' },
};
