...
const HERO_DB = {
  ...
  //     - 爆發 連段自損砲擊:每段自損最大HP10%,傷害=(自損×20+特技100%),打到自身HP<15% 為止(滿血約 10 段)
...
const BURST_DB = {
 ...
 '陰陽師':   {n:'四聖降臨',    d:'召喚玄武&白虎(陰陽師HP×150%,5回合)，若朱雀/青龍不存在則補召喚，所有式神HP回滿，特技40%全體攻擊4次，附加2回合減療/緩速/受傷+50%',fd:'召喚玄武&白虎(陰陽師HP×150%/5回合),若朱雀/青龍不存在則補召喚,所有式神HP回滿,特技40%全體×4次,敵全體減療/緩速/受傷+50% 2回合。'},
  ...
  '阿蘇火山龍王':{n:'超光速衝擊波', d:'連段砲擊:每段消耗自己最大HP的10%,以(失去的HP×10+特技50%)轟擊1名目標,打到自己HP低於15%為止;目標倒下自動轉移到HP最高的對手。必中且無視有利,每段獨立機率暴擊', fd:'龍王將自身的生命化為超光速彈藥,展開連段砲擊!每一段消耗自己最大 HP 的 10%,並以(該段失去的 HP × 10 + 特技值 50%)對 1 名目標造成傷害;接著持續用同樣方式消耗 HP 轟擊同一目標,直到自己的 HP 低於 15% 為止。目標若倒下,傷害會自動轉移到下一個 HP 最高的對手。此傷害必中且無視有利狀態,每一段都有獨立機率觸發暴擊。'},
...
Object.assign(BURST_DB, {
  '法老王':   {n:'太陽神的審判', d:'特技900%光屬性「群體分攤」大傷+我方全體恢復HP(恢復量隨爆發升級提升)',fd:'召喚拉神的烈日洪流自天而降,以特技值900%對全體存活對手造成「群體分攤」光屬性巨大傷害(總威力由存活敵人均分,人越多每人受越少),施放後使我方全體恢復最大HP的25%(爆發每強化1級恢復量+5%,Lv4達45%)。'},
