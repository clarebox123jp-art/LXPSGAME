...
Object.assign(HERO_DB, {
  ...
  '聖甲蟲':{hp:280,atk:23,sp:33,spd:80,exp:0,
    ...
    s2:{n:'黃金護甲',c:3,d:'為友方全體附加30護盾+「狀態免疫」1回合',fd:'展開太陽神的黃金護甲,為友方全體附加可抵擋30傷害的護盾,並附加「狀態免疫」1回合。'}
  },
...
const EGYPT_BOSS_HERO_STATS = {
  '法老王':   { hp:48, atk:30, sp:14, spd:8 },   // 和=100;HP 實戰再×1.3≈62
  '埃及豔后': { hp:38, atk:12, sp:34, spd:16 },  // 和=100;HP 實戰再×1.3≈49
};
...
Object.assign(BURST_DB, {
  '法老王':   {n:'太陽神的審判', d:'特技900%光屬性「群體分攤」大傷+我方全體恢復25%HP',fd:'召喚拉神的烈日洪流自天而降,以特技值900%對全體存活對手造成「群體分攤」光屬性巨大傷害(總威力由存活敵人均分,人越多每人受越少),施放後使我方全體恢復最大HP的25%。'},
  '埃及豔后': {n:'尼羅河的詛咒', d:'特技200%全體暗屬性大傷+50%機率強力查封物品2回合',fd:'喚醒尼羅河千年詛咒淹沒戰場,以特技值200%對全體存活對手造成暗屬性巨大傷害,並各有50%機率使其陷入「查封物品」狀態2回合(期間無法使用任何道具)。'},
});
// 雙 BOSS 天賦(HERO_TRAIT;威儀疊層/互相復活的hook由index.html批二手寫)
Object.assign(HERO_TRAIT, {
  '法老王':   { name:'法老威儀', icon:'👑', desc:'回合開始累積「威儀」(傷害+10%/層,最多10層),受傷50%減1層;豔后倒下時耗自身10%生命復活她至25%HP',fd:'自己回合開始時獲得1層「威儀」,每層使造成的傷害+10%(最多累積10層);每次受到傷害時有50%機率減少1層威儀。當埃及豔后倒下時,法老王會立即耗費自身10%生命,將埃及豔后以最大HP的25%復活(不限次數)──唯有同一時間「同時擊殺」雙王,才能阻止彼此復活。' },
  '埃及豔后': { name:'蛇瞳魅影', icon:'🐍', desc:'受傷時50%使攻擊者強力魅惑1回合;法老王倒下時耗自身10%生命復活他至25%HP',fd:'受到傷害時有50%機率使攻擊者陷入「強力魅惑」1回合。當法老王倒下時,埃及豔后會立即耗費自身10%生命,將法老王以最大HP的25%復活(不限次數)──唯有同一時間「同時擊殺」雙王,才能阻止彼此復活。' },
});
// ★★★ 埃及關英雄資料 END ★★★
