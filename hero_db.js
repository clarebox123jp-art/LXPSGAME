...
const HERO_BIO = {
  ...
  '熔岩巨人':{ role:'沉睡火山的化身', trait:'沉默寡言,愛好和平、樂於助人', hobby:'守護山林、靜觀岩漿緩緩流動', quote:'「……(低沉的轟隆聲)」' },
  '拘留者':{ role:'穿梭時空的時空執法者', trait:'冷靜寡言、鐵面無私,只依時序執法', hobby:'校準時間軸、記錄各時空的罪與罰', quote:'「時間到了……該為你的行為負責。」' },
